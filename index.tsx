...
const App = () => {
  ...
  const pageMetadata: { [key: string]: { title: string; description: string } } = {
    ...
    'programs': {
      ...
      description: 'Comprehensive pilot recognition-based programs and development pathways including accredited initial experience for newly graduated pilots, Foundation Program, Transition Program, and AIRBUS Aligned EBT CBTA Programs for career advancement in the aviation industry.'
    },
  ...
  return (
    <>
      ...
      <div className={`page-transition-wrapper ${isBlurring ? 'page-blur-active' : ''} ${loading ? 'page-blur-active' : ''}`}
        ...
        {currentPage === 'cadet-pathways' && (
          <CadetProgramsPathwaysPage
            onBack={() => navigateTo('home')}
            onNavigate={navigateTo}
            onLogin={navigateToPortal}
          />
    ...
    <AuthProvider>
      <ToastProvider>
        <Routes>
          ...
          <Route path="/type-rating-search" element={<TypeRatingSearchPage onNavigate={(page) => safeRedirect(`${page}`)} onBack={() => safeRedirect('/pathways-modern')} />} />
          ...
          <Route path="/airline-expectations" element={<AirlineExpectationsPage onBack={() => safeRedirect('/')} onNavigate={(page) => safeRedirect(`${page}`)} onLogin={() => {}} />} />
          <Route path="/discover-pathways" element={<PathwaysPage onBack={() => safeRedirect('/')} onNavigate={(page) => safeRedirect(`${page}`)} onLogin={() => {}} />} />
          <Route path="/what-is-the-pilot-gap" element={<PilotGapAboutPage onBack={() => safeRedirect('/about')} onNavigate={(page) => safeRedirect(`${page}`)} onLogin={() => {}} />} />
          <Route path="/programs" element={<ProgramsPathwaysPage onBack={() => safeRedirect('/')} onNavigate={(page) => safeRedirect(`${page}`)} onLogin={() => {}} />} />
          <Route path="/benefits" element={<ProgramBenefitsPage onBack={() => safeRedirect('/')} onNavigate={(page) => safeRedirect(`${page}`)} onLogin={() => {}} />} />
          <Route path="/news-updates" element={<NewsUpdatesPage onBack={() => safeRedirect('/')} onNavigate={(page) => safeRedirect(`${page}`)} onLogin={() => {}} />} />
          <Route path="/foundational-program" element={<FoundationalProgramPage onBack={() => safeRedirect('/')} onNavigate={(page) => safeRedirect(`${page}`)} onLogin={() => {}} />} />
          <Route path="/transition-program" element={<TransitionProgramPage onBack={() => safeRedirect('/')} onNavigate={(page) => safeRedirect(`${page}`)} onLogin={() => {}} />} />
          <Route path="/airbus-aligned-ebt-cbta-programs" element={<EBTCBTAPage onBack={() => safeRedirect('/')} onNavigate={(page) => safeRedirect(`${page}`)} onLogin={() => {}} />} />
          <Route path="/become-member" element={<BecomeMemberPage onBack={() => safeRedirect('/')} onNavigate={(page) => safeRedirect(`${page}`)} onLogin={() => {}} />} />
          {/* Pathways Pages */}
          <Route path="/emirates-atpl" element={<EmiratesAtplPage onBack={() => safeRedirect('/')} onNavigate={(page) => safeRedirect(`${page}`)} onLogin={() => {}} />} />
          <Route path="/emerging-air-taxi" element={<EmergingAirTaxiPage onBack={() => safeRedirect('/')} onNavigate={(page) => safeRedirect(`${page}`)} onLogin={() => {}} />} />
          <Route path="/piloted-drones" element={<PilotedDronesPage onBack={() => safeRedirect('/')} onNavigate={(page) => safeRedirect(`${page}`)} onLogin={() => {}} />} />
          <Route path="/air-taxi-pathways" element={<AirTaxiPathwaysPage onBack={() => safeRedirect('/')} onNavigate={(page) => safeRedirect(`${page}`)} onLogin={() => {}} />} />
          <Route path="/cadet-pathways" element={<CadetProgramsPathwaysPage onBack={() => safeRedirect('/')} onNavigate={(page) => safeRedirect(`${page}`)} onLogin={() => {}} />} />
          <Route path="/private-charter-pathways" element={<PrivateCharterPathwaysPage onBack={() => safeRedirect('/')} onNavigate={(page) => safeRedirect(`${page}`)} onLogin={() => {}} />} />
          <Route path="/cargo-transportation" element={<CargoTransportationPage onBack={() => safeRedirect('/')} onNavigate={(page) => safeRedirect(`${page}`)} onLogin={() => {}} />} />
          {/* Pilot Recognition Pages */}
          <Route path="/pilot-recognition-profile" element={<PilotRecognitionProfilePage onBack={() => safeRedirect('/')} onNavigate={(page) => safeRedirect(`${page}`)} />} />
          <Route path="/recognition-career-matches" element={<RecognitionCareerMatchesPage onBack={() => safeRedirect('/')} onNavigate={(page) => safeRedirect(`${page}`)} onLogin={() => {}} />} />
          <Route path="/atlas-cv" element={<ATLASCVPage onBack={() => safeRedirect('/')} onNavigate={(page) => safeRedirect(`${page}`)} onLogin={() => {}} />} />
          {/* Program Application Pages */}
          <Route path="/foundational-application" element={<FoundationalProgramApplicationPage onBack={() => safeRedirect('/')} onNavigate={(page) => safeRedirect(`${page}`)} onLogin={() => {}} />} />
          <Route path="/transition-application" element={<TransitionProgramApplicationPage onBack={() => safeRedirect('/')} onNavigate={(page) => safeRedirect(`${page}`)} onLogin={() => {}} />} />
          {/* About/Company Pages */}
          <Route path="/about" element={<AboutPage onBack={() => safeRedirect('/')} onNavigate={(page) => safeRedirect(`${page}`)} onLogin={() => {}} />} />
          <Route path="/faq" element={<FAQPage onBack={() => safeRedirect('/')} onNavigate={(page) => safeRedirect(`${page}`)} onLogin={() => {}} />} />
          <Route path="/board" element={<BoardPage onBack={() => safeRedirect('/')} onNavigate={(page) => safeRedirect(`${page}`)} onLogin={() => {}} />} />
          <Route path="/governance" element={<GovernancePage onBack={() => safeRedirect('/')} onNavigate={(page) => safeRedirect(`${page}`)} onLogin={() => {}} />} />
          <Route path="/committees" element={<CommitteesPage onBack={() => safeRedirect('/')} onNavigate={(page) => safeRedirect(`${page}`)} onLogin={() => {}} />} />
          <Route path="/mission-vision" element={<MissionVisionPage onBack={() => safeRedirect('/')} onNavigate={(page) => safeRedirect(`${page}`)} onLogin={() => {}} />} />
          <Route path="/core-values" element={<CoreValuesPage onBack={() => safeRedirect('/')} onNavigate={(page) => safeRedirect(`${page}`)} onLogin={() => {}} />} />
          <Route path="/industry-stewardship" element={<IndustryStewardshipPage onBack={() => safeRedirect('/')} onNavigate={(page) => safeRedirect(`${page}`)} onLogin={() => {}} />} />
          {/* Directory Pages */}
          <Route path="/insights" element={<AviationInsightsDirectoryPage onBack={() => safeRedirect('/')} onNavigate={(page) => safeRedirect(`${page}`)} onLogin={() => {}} />} />
          <Route path="/applications-systems" element={<ApplicationsSystemsDirectoryPage onBack={() => safeRedirect('/')} onNavigate={(page) => safeRedirect(`${page}`)} onLogin={() => {}} />} />
          <Route path="/membership" element={<MembershipDirectoryPage onBack={() => safeRedirect('/')} onNavigate={(page) => safeRedirect(`${page}`)} onLogin={() => {}} />} />
          <Route path="/hinfact" element={<HinfactPage onBack={() => safeRedirect('/')} onNavigate={(page) => safeRedirect(`${page}`)} onLogin={() => {}} />} />
          <Route path="/w1000-suite" element={<W1000SuitePage onBack={() => safeRedirect('/')} onNavigate={(page) => safeRedirect(`${page}`)} onLogin={() => {}} />} />
          <Route path="/membership-benefits" element={<MembershipBenefitsPage onBack={() => safeRedirect('/')} onNavigate={(page) => safeRedirect(`${page}`)} onLogin={() => {}} />} />
          {/* Other Pages */}
          ...
          <Route path="/accreditation" element={<AccreditationPage onBack={() => safeRedirect('/')} onNavigate={(page) => safeRedirect(`${page}`)} onLogin={() => {}} />} />
          <Route path="/contact-support" element={<ContactSupportPage onBack={() => safeRedirect('/')} onNavigate={(page) => safeRedirect(`${page}`)} onLogin={() => {}} />} />
          <Route path="/download" element={<DownloadPage onBack={() => safeRedirect('/')} onNavigate={(page) => safeRedirect(`${page}`)} onLogin={() => {}} />} />
          <Route path="/examination-results" element={<ExaminationResultsDirectoryPage onBack={() => safeRedirect('/')} onNavigate={(page) => safeRedirect(`${page}`)} onLogin={() => {}} />} />
          <Route path="/examination-results-directory" element={<ExaminationResultsDirectoryPage onBack={() => safeRedirect('/')} onNavigate={(page) => safeRedirect(`${page}`)} onLogin={() => {}} />} />
          <Route path="/digital-logbook-directory" element={<DigitalLogbookDirectoryPage onBack={() => safeRedirect('/')} onNavigate={(page) => safeRedirect(`${page}`)} onLogin={() => {}} />} />
          <Route path="/pilot-gap-about" element={<PilotGapAboutPage onBack={() => safeRedirect('/about')} onNavigate={(page) => safeRedirect(`${page}`)} onLogin={() => {}} />} />
          <Route path="/settings" element={<SettingsDirectoryPage onBack={() => safeRedirect('/')} onNavigate={(page) => safeRedirect(`${page}`)} onLogin={() => {}} />} />
          <Route path="/*" element={
            <>
              <App />
              <CookieConsent />
