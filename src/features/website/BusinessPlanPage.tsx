        ...
        <div style={{ maxWidth: '900px', margin: '0 auto' }}>
            ...
            <div style={{ display: 'grid', gap: 80 }}>
                ...
                <div style={{ textAlign: 'center', padding: '60px 0' }}>
                    ...
                    <button style={{ padding: '16px 48px', fontSize: '1.1rem', fontWeight: 700, background: '#1a1a1a', color: 'white', borderRadius: 100, border: 'none', cursor: 'pointer', transition: 'transform 0.2s' }} onClick={() => safeRedirect('mailto:contact@pilotrecognition.com')}>
                        Contact Founders
                    </button>
                </div>
