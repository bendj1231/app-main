                ...
                <div className="space-y-8 text-slate-700">
                    ...
                    <section>
                        ...
                        <div className="bg-slate-50 border border-slate-200 rounded-xl px-5 py-3 mb-4">
                            ...
                            <p className="text-slate-600 text-xs leading-relaxed">The Platform Operator does not hold custody of User funds at any point in the payment lifecycle. All payments are processed exclusively through third-party payment gateways (Helio / MoonPay Commerce) and distributed via smart-contract automation upon clearance. The Platform Operator is not a licensed financial institution, money transmitter, or payment services provider under the Payment Services Act 2019 of Singapore (as amended), and does not require a licence thereunder for the facilitation of these transactions.</p>
                        </div>
                    ...
                    <section>
                            ...
                            <table className="w-full text-sm border-collapse">
                                <tbody>
                                    {[
                                        ...
                                        ['Permanent Account Blacklisting', 'Accounts confirmed to have submitted fraudulent logbook data, spoofed credential tokens, or manipulated verification payloads are subject to automatic, permanent infrastructure-level blacklisting triggered by objective algorithmic anomaly detection or an external verification partner\'s adverse finding. Reporting to the applicable civil aviation authority or regional verification partner is initiated automatically upon confirmation of a verifiable data integrity breach — this process is not subject to discretionary operator judgment and cannot be delayed or suppressed by any party.'],
                                    ].map(([label, desc], i) => (
                                        <tr key={String(label)} className={i % 2 === 0 ? 'bg-white' : 'bg-slate-50'}>
                                            <td className="px-4 py-3 border border-slate-200 font-semibold text-slate-700 w-52 text-xs whitespace-nowrap align-top">{label}</td>
                                            <td className="px-4 py-3 border border-slate-200 text-slate-600 text-xs">{desc}</td>
                        ...
                        <div className="bg-red-50 border border-red-300 rounded-xl px-5 py-3 mb-3">
                            <p className="text-red-700 text-xs font-black uppercase tracking-wide mb-1">⛔ Permanent Infrastructure-Level Blacklisting</p>
                            <p className="text-red-800 text-xs leading-relaxed">Confirmed submission of fraudulent logbook data, spoofed credential tokens, or manipulated verification payloads results in <strong>permanent, irrevocable blacklisting</strong> at the infrastructure layer. This action cannot be appealed through the Platform. The User is hereby placed on notice that this consequence applies regardless of the scale of falsification.</p>
                        </div>
