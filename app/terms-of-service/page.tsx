            ...
            <div className="pt-32 pb-12 px-6 max-w-4xl mx-auto">
                ...
                <div className="space-y-8 text-slate-700">
                    ...
                    <section>
                        ...
                        <p className="mb-4 text-sm">In accordance with the Electronic Transactions Act (Cap. 88), clicking the "I Agree" checkbox during account creation constitutes an unalterable electronic signature. At the moment of creation the Platform records a system timestamp (e.g., <code className="text-xs bg-slate-100 px-1 rounded">2026-05-21T03:11:56Z</code>) mapped to the anonymous Auth0 token. This constitutes a non-discretionary regulatory audit trail, not a registry of Sensitive Personal Information (SPI). The User acknowledges that this electronic assent satisfies all requirements for a binding legal agreement under the Electronic Transactions Act (Cap. 88) of Singapore, and that the resulting audit trail is sufficient for the purposes of regulatory reporting and enforcement proceedings.</p>
                    </section>
                                                ...
                                                <div className="text-xs text-slate-600">
                                                    ...
                                                    <div className="space-y-1.5">
                                                        <div className="bg-white border border-amber-200 rounded-lg px-3 py-2">
                                                            ...
                                                            <p className="text-slate-600 text-[10px]">Validates active licences, medicals, and credentials directly against live data streams maintained by applicable civil aviation authorities and sovereign registries.</p>
                                                        </div>
                                                        <div className="bg-white border border-amber-200 rounded-lg px-3 py-2">
                            ...
                            <table className="w-full text-sm border-collapse">
                                <tbody>
                                    {[
                                        ...
                                        ['Sovereign Exportability & Deletion', 'Because Receipt of Validation and Verified Presentation (VP) tokens are stored directly within the pilot\'s non-custodial decentralized container, the User maintains absolute ownership over the asset. The User preserves the unbound right to download, export, or migrate their complete container wallet to alternative third-party systems, or delete their profile state from the platform entirely, erasing all network data trails outside their localised device.'],
                                    ].map(([label, desc], i) => (
                                        <tr key={String(label)} className={i % 2 === 0 ? 'bg-white' : 'bg-slate-50'}>
                                            <td className="px-4 py-3 border border-slate-200 font-semibold text-slate-700 w-52 text-xs whitespace-nowrap align-top">{label}</td>
                                            <td className="px-4 py-3 border border-slate-200 text-slate-600 text-xs">{desc}</td>
                    ...
                    <section>
                        ...
                        <p className="mb-4 text-sm"><strong>No Agency Clause:</strong> The Platform Operator, its officers, and its agents expressly disclaim any authority to act on behalf of, represent, or bind any Civil Aviation Authority (CAA). Any reliance on the Platform by a User or third party to satisfy regulatory compliance requirements is at the sole risk and responsibility of the User.</p>
                        <p className="mb-4 text-sm"><strong>Conflict of Law &amp; Exclusive Jurisdiction:</strong> To the extent permitted by applicable law, this Agreement shall be governed by the laws of the Republic of Singapore, without regard to its conflict of law provisions. Any dispute arising out of or in connection with this Agreement shall be subject to the exclusive jurisdiction of the courts of Singapore.</p>
                        <p className="mb-4 text-sm"><strong>Aviation Authority ({jurisdiction.aviationAuthority}):</strong> For users in {jurisdiction.country}, the sole regulatory authority for aviation licensing is the {jurisdiction.aviationAuthority}. Pilot Recognition maintains no formal relationship with this authority. Verification results are for informational purposes only.</p>
                        <p className="text-sm"><strong>Informational Snapshot Shield:</strong> Verification outputs generated by the Platform are strictly non-binding, represent only a snapshot of data at the time of query, and do not replace the formal documentation or legal licensing issued directly by the governing Civil Aviation Authority. No verification output produced by this Platform constitutes legal proof of airworthiness, medical fitness, or regulatory compliance for the purposes of any civil aviation regulatory requirement.</p>
                    </section>
                    ...
                    <section>
                        ...
                        <div className="overflow-x-auto mb-4">
                            <table className="w-full text-sm border-collapse">
                                <tbody>
                                    {[
                                        ['Stale Token Invalidation Threshold', 'A verified cryptographic stamp issued into the client-side decentralized container features an algorithmic TTL (Time-To-Live) window of 365 days. Upon expiry, the Terminal 3 access grant is automatically revoked pending a new verification cycle.'],
                                        ['Database Drift Gating', 'If the delta between current unverified staging metrics and the last cryptographically signed presentation hash stored in the client-side container history exceeds twenty percent (20%), the Platform infrastructure will programmatically flag the associated Terminal 3 status as "Out of Sync" and execute a mandatory Sync Gating event. The profile\'s verified pathway registries will remain locked to external operators until a localised container synchronisation occurs and a supplementary audit token is issued by the independent verification partner.'],
                                        ['Drift Liability Attribution — User Sync Duty', 'Maintaining synchronisation between the Platform\'s distributed database caching layer and the User\'s decentralized client-side container is the sole operational duty of the User. Any processing friction, access delays, or pathway lockouts resulting from database drift exceeding the 20% threshold are the exclusive liability of the User. Consistent with the Platform\'s status as a neutral intermediary (Section 17.2), any drift-triggered access lockout is a protective feature for the relying party, not a service failure. Consequently, the Platform Operator excludes all liability for any consequential losses, including lost flight training time or missed employment opportunities, arising from such protective gating.'],
                                    ].map(([label, desc], i) => (
                                        <tr key={String(label)} className={i % 2 === 0 ? 'bg-white' : 'bg-slate-50'}>
                                            <td className="px-4 py-3 border border-slate-200 font-semibold text-slate-700 w-52 text-xs whitespace-nowrap align-top">{label}</td>
                                            <td className="px-4 py-3 border border-slate-200 text-slate-600 text-xs">{desc}</td>
                        ...
                        <div className="border-l-4 border-amber-500 bg-amber-50 rounded-r-xl px-5 py-3 mb-2">
                            ...
                            <p className="text-amber-900 text-xs leading-relaxed">The Platform actively monitors the delta between unverified staging data and the last cryptographically signed presentation hash in the pilot\'s decentralized container. Exceeding the 20% variance threshold is treated as a User-side compliance event, not a platform technical error. Pilots are strongly advised to maintain synchronisation between their database staging layer and their client-side container to avoid automatic Terminal 3 lockout. The Platform Operator bears no liability for any consequences arising from the User\'s failure to maintain this synchronisation.</p>
                        </div>
                    </section>
                    ...
                    <section>
                        ...
                        <p className="mb-3 text-sm">Because the designated decentralized client-side cryptographic container executes directly within the user's client-side browser runtime, the integrity of the cryptographic environment relies fundamentally on the hygiene of the user's localised operating container.</p>
                        <div className="overflow-x-auto mb-4">
                            <table className="w-full text-sm border-collapse">
                                <tbody>
                                    {[
                                        ['Malicious Script & Extension Redaction', 'The Platform Operator deploys an aggressive Content Security Policy (CSP) designed to neutralise Cross-Site Scripting (XSS) vectors and unverified browser extension injections. The User acknowledges that running custom scripts, unauthorised developer tools, or malicious ad-blocking layers that alter the browser\'s runtime environment may break the trust-anchor handshake between the primary database engine and the client-side cryptographic container. If a client-side injection is detected or a CSP violation occurs, the cryptographic handshake is designed to fail closed — a deliberate security fail-safe intended to prevent the potential exposure of unblinded claims to an untrusted environment.'],
                    ...
                    <section>
                        ...
                        <p className="mb-3 text-sm">The Platform's architectural configuration relies on zero-knowledge execution. The private cryptographic keys generated to sign W3C Verifiable Credentials inside the designated client-side decentralized container are structurally isolated within the User's hardware-backed operating environment via native device authenticator infrastructure.</p>
                        <div className="overflow-x-auto mb-4">
                            <table className="w-full text-sm border-collapse">
                                <tbody>
                                    {[
                                        ...
                                        ['The Structural Reset Remedy', 'In the event of catastrophic key loss, the User\'s sole remedy is to request an account termination sequence. The account is suspended immediately upon request. The multi-engine distributed infrastructure will then execute a destructive wipe of the public-key mapping table within 30 business days to allow for database backup rotation cycle completion — a period consistent with the PDPC\'s Reasonable Data Retention guidelines. The User must then execute an entirely new onboarding sequence, re-instantiate a blank decentralized container, and process an entirely new verification lifecycle — including settlement of re-initiation costs of external verification services charged directly by the applicable independent verification partner.'],
                                    ].map(([label, desc], i) => (
                                        <tr key={String(label)} className={i % 2 === 0 ? 'bg-white' : 'bg-slate-50'}>
                                            <td className="px-4 py-3 border border-slate-200 font-semibold text-slate-700 w-52 text-xs whitespace-nowrap align-top">{label}</td>
                                            <td className="px-4 py-3 border border-slate-200 text-slate-600 text-xs">{desc}</td>
                        ...
                        <p className="mb-3 text-sm">If an Independent Third-Party Verification Integration or an applicable sovereign civil aviation authority issues a cryptographic revocation signal regarding a pilot's active licence, rating, or medical certificate, the Platform's multi-engine infrastructure will execute an automated response sequence:</p>
                        <div className="overflow-x-auto mb-4">
                            <table className="w-full text-sm border-collapse">
                                <tbody>
                                    {[
                                        ['Instantaneous Terminal 3 Egress', 'Upon receipt of a live API revocation or failed trust-anchor handshake callback, the infrastructure layer instantly updates the credential status to "Revoked" across all synchronised database engine layers. The corresponding Terminal 3 Access Token is cryptographically invalidated via immediate TTL zero-out, dropping the profile back to Terminal 1 (Baseline) functions within 60 seconds of the network callback event.'],
                                        ['Anti-Spoofing Isolation & Terminal 1 Containment', 'To prevent malicious injection attacks or spoofed civil registry callbacks, any revocation or validation signal must match the signed, public cryptographic signature of the designated authoritative verification issuer. Unsigned or invalidly signed metadata streams trigger an immediate, automated containment protocol: the associated account is isolated to Terminal 1 baseline functions indefinitely, with all Terminal 3 access revoked, pending resolution with the issuing verification partner.'],
                                    ].map(([label, desc], i) => (
