                ...
                <div className="space-y-8 text-slate-700">
                    ...
                    <section>
                        <div className="bg-slate-900 text-white rounded-xl p-5 mb-6">
                            ...
                            <p className="font-bold text-base mb-1">Data Controller · SaaS Infrastructure Provider · Verifiable Credential Issuer</p>
                            <p className="text-slate-300 text-xs leading-relaxed mb-2">Aviation Pathways Ltd operates the platform infrastructure, manages user accounts, and issues cryptographically signed W3C Verifiable Credentials (VCs) as digital access tickets. User profiles, credential metadata, and signed VC records are stored in encrypted database environments (AES-256-GCM at rest). Raw documents uploaded for verification are forwarded to third-party verifiers and not retained.</p>
                            <p className="text-slate-400 text-xs"><span className="text-slate-300 font-semibold">DATA FLOW:</span> The Platform receives minimal structured verification outcomes (status, check ID, timestamp) from independent third-party verifiers and issues signed VCs. Detailed verification receipts containing full credential data are sent directly to the User's email by the verifier and are never transmitted to, viewed by, or stored on the Platform.</p>
                        </div>
                    ...
                    <section>
                        ...
                        <p className="mb-3 text-sm">Upon onboarding, the User acknowledges that Aviation Pathways Ltd is the <strong>Data Controller</strong> for all personal data processed through the Platform infrastructure. The User retains ownership of their identity credentials and controls what data to share, with whom, and when. The Platform Operator manages the infrastructure, stores encrypted profile data and signed Verifiable Credentials, and routes verification requests to third-party providers.</p>
                        <div className="bg-blue-50 border border-blue-200 rounded-xl px-4 py-3 mb-4">
                            <p className="text-blue-800 text-xs font-bold uppercase tracking-wide mb-1">Verifiable Credential Wallet & Server-Side Records</p>
                            <p className="text-blue-900 text-xs leading-relaxed mb-2">The platform issues cryptographically signed <strong>W3C Verifiable Credentials (VCs)</strong> under <code>did:web:pilotrecognition.com</code> based on minimal structured verification outcomes received from third-party verifiers. These VCs are delivered to the User’s personal Pilot Wallet and retained server-side as signed records for pathway gating and revocation. The User can export their VCs to any W3C-compliant wallet framework.</p>
                            <p className="text-blue-800 text-xs font-bold uppercase tracking-wide mb-1 mt-2">External DID Wallet Syncing</p>
                            <p className="text-blue-900 text-xs leading-relaxed mb-3">The User may synchronise a pre-existing, W3C-compliant external DID wallet. During an external sync, the Platform infrastructure reads only the public DID descriptor string — private keys remain under the User’s control. Any historical credential claims from an externally synced wallet are flagged as <strong>“Pending Verification”</strong> until processed through the platform’s independent verification ecosystem.</p>
