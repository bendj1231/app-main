                ...
                <div className="space-y-8 text-slate-700">
                    ...
                    <section>
                        <div className="bg-slate-900 text-white rounded-xl p-5 mb-6">
                            ...
                            <p className="text-slate-300 text-xs leading-relaxed mb-2">Controls the processing environment and access permission matrices. Does not control or own data content (credentials, verification outcomes, logbook records). Verified Credential Tokens are issued into the pilot’s client-side decentralized container — not stored on platform servers.</p>
                            <p className="text-slate-400 text-xs"><span className="text-slate-300 font-semibold">Legal Summary of Processing:</span> The Platform Operator controls the processing environment and access permission matrices only. It does not control or own data content (credentials, verification outcomes, logbook records). Verified Credential Tokens are issued into the pilot’s sovereign client-side container — structurally inaccessible to the Platform Operator at the server layer.</p>
                        </div>
                        ...
                        <p className="mb-3 text-sm"><strong>Neutrality Guarantee:</strong> The Platform Operator does not adjudicate, verify, or validate the content of the data presented by the User; it merely provides the secure cryptographic infrastructure through which independent third-party verification partners verify and issue credentials. All verification outcomes are the exclusive product of the independent verification partner, not of the Platform Operator.</p>
                        <p className="mb-3 text-sm"><strong>Infrastructure Definition:</strong> For the purposes of this Agreement, “Infrastructure” includes all software conduits, multi-engine distributed database synchronisation layers, and API gateways facilitating the flow of tokenized metadata between the User and independent third-party verification providers. The Platform Operator’s obligations are limited to the availability and integrity of this Infrastructure layer only.</p>
                    ...
                    <section>
                        ...
                        <h3 className="font-semibold text-slate-800 mb-2">9.2 Stale Token Invalidation &amp; The 20% Data Drift Gate</h3>
