...
const LEARN_CATEGORIES = [
  {
    ...
    solution:
      'Pilot Recognition is a digital ecosystem where pilots build live profiles, access career pathways, and get discovered by airlines through a pulling system rather than traditional applications. Your profile becomes your career passport.',
    benefits: [
  ...
  },
  {
    ...
    solution:
      'The Recognition Score (0-100) is a comprehensive metric representing your professional standing, experience, recency, and verified achievements. It becomes your career currency that airlines trust.',
    benefits: [
  ...
  },
  {
    ...
    solution:
      'The pulling system inverts the hiring model. Airlines use our platform to search, filter, and pull pilot profiles based on specific requirements. Your live, verified profile does the work for you.',
    benefits: [
  ...
  },
  {
    ...
    solution:
      'Pilot Recognition replaces outdated methods with verified, dynamic systems. Live profiles instead of PDFs, pulling instead of applying, and verified data instead of unverified claims.',
    benefits: [
  ...
  },
  {
    ...
    solution:
      'Live digital profiles replace dead CVs with dynamic, verified data that updates automatically. Your flight hours sync from your logbook, new type ratings appear instantly upon verification, and examination results populate automatically — creating a real-time career passport that airlines can trust without manual verification.',
    benefits: [
  ...
  },
  {
    ...
    solution:
      'Our platform provides airlines with verified pilot profiles containing authenticated flight hours, confirmed type ratings, and validated exam scores — all pre-screened and ranked by Recognition Score.',
    benefits: [
        ...
        <div className="max-w-6xl mx-auto px-6 pt-16 pb-12">
          <div className="max-w-3xl">
            ...
            <p className="text-slate-600 text-lg md:text-xl leading-relaxed mb-6 max-w-2xl">
              Discover how Pilot Recognition transforms aviation careers through verified profiles,
              the pulling system, and your Recognition Score.
            </p>
      ...
      <section className="py-16 px-6 border-b border-slate-200 bg-white">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-slate-600 text-lg max-w-2xl mb-10">
            Learn how Pilot Recognition works and why it matters for your aviation career.
          </p>
      ...
      <section className="py-16 px-6 bg-slate-900 text-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-slate-300 text-lg mb-8 max-w-2xl mx-auto">
            Create your free profile and join thousands of pilots using Pilot Recognition to advance
            their careers.
          </p>
