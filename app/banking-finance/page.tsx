...
const FINANCE_CATEGORIES = [
  {
    ...
    solution:
      'Career-trajectory-aware pilot lending. PilotRecognition provides a verified employment-readiness score, hours trajectory, type rating progression, and pathway match probability — letting lenders price loans on actual aviation career risk rather than generic credit metrics.',
    benefits: [
  ...
  },
  {
    ...
    solution:
      'Aviation-specialized mortgage products that understand pilot career patterns. We verify employment status, projected career earnings, and connect pilots with lenders who offer airline staff rates and understand the aviation industry.',
    benefits: [
  ...
  },
  {
    ...
    solution:
      'Curated credit card recommendations for pilots including airline co-branded cards, air miles maximizers, and cards with aviation lifestyle benefits like lounge access, travel insurance, and training expense rewards.',
    benefits: [
  ...
  },
  {
    ...
    solution:
      'Aviation-specialized wealth management including retirement planning for mandatory retirement ages, tax optimization for international pilots, currency hedging, and investment strategies tailored to pilot career trajectories.',
    benefits: [
        ...
        <div className="max-w-6xl mx-auto px-6 pt-16 pb-12">
          <div className="max-w-3xl">
            ...
            <p className="text-slate-600 text-lg md:text-xl leading-relaxed mb-6 max-w-2xl">
              Specialized financial solutions designed for aviation professionals. From training
              loans to retirement planning, we connect pilots with lenders and advisors who
      ...
      <section className="py-16 px-6 border-b border-slate-200 bg-white">
        <div className="max-w-6xl mx-auto">
          ...
          <h2 className="text-3xl md:text-4xl font-bold mb-4 text-slate-900">
            Everything Pilots Need.
          </h2>
          <p className="text-slate-600 text-lg max-w-2xl mb-10">
            From your first type rating loan to retirement planning — financial products designed
      ...
      <section className="py-16 px-6 bg-slate-900 text-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-slate-300 text-lg mb-8 max-w-2xl mx-auto">
            Create your free Pilot Recognition profile and unlock career-based lending rates,
            aviation-specialized mortgages, and wealth management designed for pilots.
          </p>
