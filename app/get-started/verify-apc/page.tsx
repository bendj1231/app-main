          ...
          <div className="rounded-xl p-3 mb-3" style={{ background: 'rgba(245,158,11,0.04)', border: '1px solid rgba(245,158,11,0.12)' }}>
            <label className="flex items-start gap-2 cursor-pointer">
              ...
              <span className="text-[10px] text-gray-700 leading-snug">
                The pilot authorizes <span className="font-bold text-gray-800">Aviation Pathways Consultancy (APC)</span> to use the pilot's license, type ratings, medical certificate, and related documents for verification with the designated Civil Aviation Authority (CAA). The pilot confirms these documents are authentic and the pilot is the legitimate holder. The pilot understands that falsified documents may result in profile revocation and legal consequences. The pilot acknowledges that if discrepancies are found — particularly in logbook credibility based on ATO response or CFI signature issues — the pilot's account will be flagged for review for 30 days to fix necessary issues, and a <span className="font-bold text-gray-800">$50 reverification fee</span> applies for manual re-review. While under review the pilot may still submit to pathways, but the pilot's profile will carry a verification flag visible to ATOs, operators, and airlines for safety and compliance. After 30 days, unresolved issues may restrict pathway submissions. To fully clear the pilot's account of all flags and restrictions, the pilot is required to pay the full verification fee again for a complete clean re-verification; upon re-uploading corrected documents and declaring all issues resolved, the pilot's account will be cleared, subject to successful verification.
              </span>
            </label>
          </div>
        ...
        <motion.div className="mb-5 text-left" variants={fadeUp} custom={4}>
          ...
          <div className="rounded-xl p-3 mb-3 mt-3" style={{ background: 'rgba(245,158,11,0.04)', border: '1px solid rgba(245,158,11,0.12)' }}>
            <label className="flex items-start gap-2 cursor-pointer">
              ...
              <span className="text-[10px] text-gray-700 leading-snug">
                The pilot authorizes <span className="font-bold text-gray-800">Aviation Pathways Consultancy (APC)</span> to audit the pilot's flight logbook and submit it to the designated ATO and CAA for verification of flight hours, training records, and endorsements. The pilot confirms the logbook entries are authentic and accurate. The pilot understands that falsified logbook entries may result in profile revocation and legal consequences. The pilot acknowledges that if discrepancies are found — including mismatched hours, missing CFI signatures, or conflicting entries — the pilot's account will be flagged for review for 30 days, and a <span className="font-bold text-gray-800">$50 reverification fee</span> applies for manual re-review. While under review the pilot may still submit to pathways, but the pilot's profile will carry a verification flag visible to ATOs, operators, and airlines. To fully clear the pilot's account of all flags, the pilot is required to pay the full verification fee again for a complete clean re-verification; upon re-uploading corrected documents and declaring all issues resolved, the pilot's account will be cleared, subject to successful verification.
              </span>
            </label>
          </div>
