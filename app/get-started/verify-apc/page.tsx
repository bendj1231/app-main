          ...
          <div className="rounded-xl p-3 mb-3" style={{ background: 'rgba(245,158,11,0.04)', border: '1px solid rgba(245,158,11,0.12)' }}>
            <label className="flex items-start gap-2 cursor-pointer">
              ...
              <span className="text-[10px] text-gray-700 leading-snug">
                The pilot authorizes <span className="font-bold text-gray-800">Aviation Pathways Consultancy (APC)</span> to use the pilot's license, type ratings, medical certificate, and related documents for verification with the designated Civil Aviation Authority (CAA). The pilot confirms these documents are authentic and the pilot is the legitimate holder. The pilot understands that submitting falsified, fraudulent, expired, blacklisted, missing, stolen, or tampered documents is a criminal offense and will result in immediate revocation of the pilot's PilotRecognition profile and wallet credentials, and may be reported to regulatory and law enforcement authorities by APC, the governing CAA, ATO, CFI, <span className="font-bold text-gray-800">operators</span>, <span className="font-bold text-gray-800">flight operations departments</span>, <span className="font-bold text-gray-800">manufacturers' flight operations</span>, <span className="font-bold text-gray-800">type rating center chief pilots</span>, <span className="font-bold text-gray-800">charter operators</span>, or <span className="font-bold text-gray-800">general aviation corporations</span>. The pilot acknowledges that if discrepancies are found — including documents identified as falsified, expired, blacklisted, missing, stolen, or tampered by the CAA, ATO, CFI, <span className="font-bold text-gray-800">operators</span>, <span className="font-bold text-gray-800">flight operations departments</span>, <span className="font-bold text-gray-800">manufacturers' flight operations</span>, <span className="font-bold text-gray-800">type rating center chief pilots</span>, <span className="font-bold text-gray-800">charter operators</span>, or <span className="font-bold text-gray-800">general aviation corporations</span> — the pilot's account will be flagged for review for 30 days to fix necessary issues, and a <span className="font-bold text-gray-800">$50 reverification fee</span> applies for manual re-review. While under review the pilot may still submit to pathways, but the pilot's profile will carry a verification flag visible to ATOs, <span className="font-bold text-gray-800">operators</span>, and airlines for safety and compliance. After 30 days, unresolved issues may restrict pathway submissions. To fully clear the pilot's account of all flags and restrictions, the pilot is required to pay the full verification fee again for a complete clean re-verification; upon re-uploading corrected documents and declaring all issues resolved, the pilot's account will be cleared, subject to successful verification. The <span className="font-bold text-gray-800">Authorized Training Organization (ATO)</span>, authorized representative (e.g., Chief Flight Instructor), <span className="font-bold text-gray-800">operators</span>, <span className="font-bold text-gray-800">flight operations departments</span>, <span className="font-bold text-gray-800">manufacturers' flight operations</span>, <span className="font-bold text-gray-800">type rating center chief pilots</span>, <span className="font-bold text-gray-800">charter operators</span>, or <span className="font-bold text-gray-800">general aviation corporations</span> responsible for conducting or reviewing the verification will receive a <span className="font-bold text-gray-800">10% incentive on verification fees</span> when the pilot achieves full verification compliance across all submitted documents, as a reward for clean, accurate verification outcomes.
              </span>
            </label>
          </div>
