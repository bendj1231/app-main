          ...
          <div className="rounded-xl p-3 mb-3" style={{ background: 'rgba(245,158,11,0.04)', border: '1px solid rgba(245,158,11,0.12)' }}>
            <label className="flex items-start gap-2 cursor-pointer">
              ...
              <span className="text-[10px] text-gray-700 leading-snug">
                I authorize <span className="font-bold text-gray-800">Aviation Pathways Consultancy (APC)</span> to use my pilot license, type ratings, medical certificate, and related documents for verification with the designated Civil Aviation Authority (CAA). I confirm these documents are authentic and I am the legitimate holder. I understand that falsified documents may result in profile revocation and legal consequences. I acknowledge that if discrepancies are found — particularly in logbook credibility based on ATO response or CFI signature issues — my account will be flagged for review for 30 days to fix necessary issues, and a <span className="font-bold text-gray-800">$50 reverification fee</span> applies for manual re-review. While under review I may still submit to pathways, but my profile will carry a verification flag visible to ATOs, operators, and airlines for safety and compliance. After 30 days, unresolved issues may restrict pathway submissions. To fully clear my account of all flags and restrictions, I must pay the full verification fee again for a complete clean re-verification; upon re-uploading corrected documents and declaring all issues resolved, my account will be cleared, subject to successful verification.
              </span>
            </label>
          </div>
