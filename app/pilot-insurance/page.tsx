...
const INSURANCE_CATEGORIES = [
  {
    ...
    solution:
      'Comprehensive loss of license coverage designed for aviation professionals. Our partner policies cover full and partial medical certificate loss, including mental health conditions, with faster payouts and career transition support built in.',
    benefits: [
  ...
  },
  {
    ...
    solution:
      'Life insurance from providers who understand aviation. We connect pilots with underwriters who use actual flight data, Recognition Scores, and verified health metrics to offer fair premiums based on real risk, not stereotypes.',
    benefits: [
  ...
  },
  {
    ...
    solution:
      'Disability insurance that understands the link between general health and aviation medical certification. Coverage bridges the gap between general disability and loss of license, protecting income during any health-related career interruption.',
    benefits: [
  ...
  },
  {
    ...
    solution:
      'Professional liability coverage designed for pilots including legal defense for regulatory actions, incident investigations, and professional negligence claims. Protection extends to both employed and freelance/contract pilots.',
    benefits: [
  ...
  },
  {
    ...
    solution:
      "We've partnered with leading aviation insurance specialists worldwide who understand the unique needs of pilots. Our curated network includes providers offering tailored coverage for loss of license, life, disability, and professional liability with competitive rates.",
    benefits: [
  ...
  },
  {
    ...
    solution:
      'Comprehensive personal accident coverage that pays lump sums for injuries, disabilities, or death resulting from accidents. Covers medical expenses, rehabilitation, and provides financial support during recovery regardless of whether the accident is aviation-related.',
    benefits: [
  ...
  },
  {
    ...
    solution:
      'Critical illness insurance pays a tax-free lump sum upon diagnosis of covered conditions like cancer, heart attack, stroke, and other serious illnesses. Use the funds for anything — medical costs, mortgage payments, experimental treatments, or time off to recover.',
    benefits: [
  ...
  },
  {
    ...
    solution:
      'Travel insurance designed for aviation professionals that covers personal trips, positioning flights, and commuting. Includes medical evacuation, trip cancellation, and baggage protection with no aviation exclusions for personal travel.',
    benefits: [
        ...
        <div className="max-w-6xl mx-auto px-6 pt-16 pb-12">
          <div className="max-w-3xl">
            ...
            <p className="text-slate-600 text-lg md:text-xl leading-relaxed mb-6 max-w-2xl">
              Specialized insurance solutions designed for aviation professionals. Protect your
              career, your income, and your family with coverage that understands the unique risks
              pilots face.
            </p>
      ...
      <section className="py-16 px-6 border-b border-slate-200 bg-white">
        <div className="max-w-6xl mx-auto">
          ...
          <h2 className="text-3xl md:text-4xl font-bold mb-4 text-slate-900">
            Complete Protection for Pilots.
          </h2>
          <p className="text-slate-600 text-lg max-w-2xl mb-10">
            From career-ending medical issues to family protection — insurance designed for the
            unique risks aviation professionals face.
          </p>
      ...
      <section className="py-16 px-6 bg-slate-900 text-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-slate-300 text-lg mb-8 max-w-2xl mx-auto">
            Create your free Pilot Recognition profile and access insurance products designed for
            pilots — with verified data for faster claims and better rates.
          </p>
