...
const GENERAL_CATEGORIES = [
  {
    ...
    solution:
      'Pilot Recognition offers a genuinely free tier with core features that remain free forever. Create your profile, access the public registry, explore pathways, and get discovered by airlines — all without paying a cent. No trials, no hidden fees, no credit card required.',
    benefits: [
  ...
  },
  {
    ...
    solution:
      'Our transparent ranking system shows exactly how profiles are ordered in airline searches. Recognition Score, recency, and relevance determine placement. Recognition+ members receive priority placement and highlighted badges that make them stand out.',
    benefits: [
  ...
  },
  {
    ...
    solution:
      'Three verification tiers that progressively build trust. Basic profiles show self-reported data. Recognition+ adds extended AI and unlimited access. Recognition+ Verified includes background checks, document screening, and top placement — giving airlines complete confidence.',
    benefits: [
  ...
  },
  {
    ...
    solution:
      'Our centralized pathway system aggregates career opportunities from airlines, cargo operators, charter companies, and flight schools. Browse all options in one place, express interest with one click, and let our AI match you to suitable roles automatically.',
    benefits: [
  ...
  },
  {
    ...
    solution:
      'Pilot Recognition offers transparent, flexible membership with no tricks. The free tier is truly free forever. Paid subscriptions can be upgraded, downgraded, or cancelled anytime with no penalties. Your data is always preserved and you keep free access even after cancelling.',
    benefits: [
        ...
        <div className="max-w-6xl mx-auto px-6 pt-16 pb-12">
          <div className="max-w-3xl">
            ...
            <p className="text-slate-600 text-lg md:text-xl leading-relaxed mb-6 max-w-2xl">
              Core features available to all pilots: free tier access, verification levels, pathway
              exploration, and membership benefits.
            </p>
      ...
      <section className="py-16 px-6 border-b border-slate-200 bg-white">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-slate-600 text-lg max-w-2xl mb-10">
            Core features that power your pilot career journey — from free tier basics to premium
            capabilities.
          </p>
