...
const PROFILE_CATEGORIES = [
  {
    ...
    color: 'blue',
    tagline:
      'Modern flight logging that automatically verifies hours and connects to your Recognition Profile.',
    ...
    solution:
      'Our digital logbook automatically imports flight data from airline systems, training providers, and major electronic logbook apps. Hours are instantly calculated, categorized by aircraft type, and verified through our authentication network — giving airlines confidence in your experience claims.',
    benefits: [
  ...
  },
  {
    ...
    color: 'teal',
    tagline:
      'Independent third-party verification of flight hours that airlines can trust instantly.',
  ...
  },
  {
    ...
    solution:
      'All your examination results in one authenticated repository. Tests from aviation authorities, training providers, and internal assessments are automatically verified and displayed with issuing authority confirmation — creating an instant trust signal for employers.',
    benefits: [
  ...
  },
  {
    ...
    color: 'emerald',
    tagline:
      'Your digital identity in aviation. A live, verified profile that replaces traditional CVs.',
    ...
    solution:
      'Your Recognition Profile is a living document that combines logbook data, exam results, ratings, and professional background into one unified digital identity. Always current, automatically updated, and instantly verifiable by any airline worldwide.',
    benefits: [
  ...
  },
  {
    ...
    solution:
      'Comprehensive type rating tracking with expiration alerts and renewal reminders. Every rating is verified with training providers, linked to your logbook hours on that type, and visible to airlines searching for specific aircraft experience.',
    benefits: [
  ...
  },
  {
    ...
    solution:
      'Centralized repository for all training records with automatic import from partner schools and training providers. From private pilot license through ATP, every course, check ride, and recurrent training is documented and verified.',
    benefits: [
  ...
  },
  {
    ...
    color: 'cyan',
    tagline:
      'Visual journey of your aviation career with milestones, achievements, and progression.',
    ...
    solution:
      'Beautiful visual timeline showing your entire aviation journey. From first solo to airline command, every milestone is captured with dates, verification, and context — ready to share with employers or reflect on your progress.',
    benefits: [
  ...
  },
  {
    ...
    solution:
      'Military-grade encrypted storage for all aviation documents with intelligent categorization and instant retrieval. Medical certificates, licenses, insurance policies, and employment contracts organized and accessible from any device.',
    benefits: [
  ...
  },
  {
    ...
    solution:
      'Granular skills tracking with self-assessment, instructor validation, and automated detection from logbook data. Build a comprehensive competency profile that shows employers exactly what you can do beyond just hours flown.',
    benefits: [
...
export default function ProfessionalProfilePage() {
  ...
  return (
    <div className="min-h-screen bg-white text-slate-900">
      ...
      {/* Mobile nav — full-screen card-style sidebar */}
      <AnimatePresence>
        {mobileNav && (
          <>
            {/* Backdrop */}
            ...
            {/* Sidebar */}
            <motion.aside
              className="fixed top-0 left-0 bottom-0 z-[310] w-full max-w-full shadow-2xl"
              style={{
        ...
        <div className="max-w-6xl mx-auto px-6 pt-16 pb-12">
          <div className="max-w-3xl">
            ...
            <p className="text-slate-600 text-lg md:text-xl leading-relaxed mb-6 max-w-2xl">
              Build your comprehensive digital pilot identity with verified credentials, digital
              logbook, examination results, type ratings, training records, and much more — all in
              one unified profile that airlines trust.
            </p>
      ...
      <section className="py-16 px-6 border-b border-slate-200 bg-white">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-slate-600 text-lg max-w-2xl mb-10">
            Eight comprehensive components that create your complete professional pilot identity —
            from logbook to skills, all verified and always current.
          </p>
      ...
      <section className="py-16 px-6 bg-slate-900 text-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-slate-300 text-lg mb-8 max-w-2xl mx-auto">
            Create your comprehensive professional profile and start building your verified pilot
            identity that airlines worldwide can discover and trust.
          </p>
      ...
      <footer className="bg-white border-t border-slate-200 py-8 px-6">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <p className="text-slate-500 text-sm">
            &copy; 2024 PilotRecognition. All rights reserved.
          </p>
        </div>
      </footer>
    </div>
