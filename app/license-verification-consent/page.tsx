        ...
        <div className="space-y-8">
          ...
          <section>
            ...
            <ul className="text-xs text-gray-600 space-y-1.5 list-disc list-inside mb-3">
              ...
              <li>The governing <span className="font-semibold text-gray-800">Approved Aviation Body</span> may identify documents that are falsified, expired, blacklisted, missing, stolen, or tampered with during the verification process.</li>
