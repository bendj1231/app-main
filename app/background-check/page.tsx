...
const VERIFICATION_CATEGORIES = [
  {
    ...
    color: 'slate',
    tagline:
      'Comprehensive verification of employment history, criminal records, and professional references.',
    ...
    solution:
      'Our integrated background verification system provides instant access to authenticated pilot credentials through partnerships with Veremark and global aviation authorities. Airlines receive pre-verified candidate data with confirmed employment history, validated flight hours, and authenticated certificates.',
    benefits: [
  ...
  },
  {
    ...
    color: 'blue',
    tagline:
      'Travel document verification ensuring you can operate internationally without restrictions.',
    ...
    solution:
      'Automated tracking and verification of all travel documents with predictive expiration alerts. The system monitors passport validity, work visa status, and required permits across all operating jurisdictions, alerting pilots and employers 90 days before expiration.',
    benefits: [
  ...
  },
  {
    ...
    solution:
      'Centralized security clearance management that coordinates applications, tracks status across multiple facilities, and maintains current credentials. Integration with airport authorities streamlines renewal processes and provides real-time clearance status.',
    benefits: [
  ...
  },
  {
    ...
    solution:
      'Permanent, tamper-proof record of all drug and alcohol testing with instant verification for employers. Integration with testing facilities and aviation medical examiners ensures complete compliance history is always accessible and up-to-date.',
    benefits: [
  ...
  },
  {
    ...
    solution:
      'Comprehensive medical certificate tracking with predictive expiration alerts and integrated AME booking. The system monitors Class 1, 2, and 3 medicals across all jurisdictions, finds available examiners, and books appointments automatically.',
    benefits: [
  ...
  },
  {
    ...
    solution:
      'Comprehensive health and wellness ecosystem designed specifically for aviation professionals. Confidential mental health resources, fitness programs tailored to pilot schedules, and preventive care tracking help maintain medical certification and career longevity.',
    benefits: [
  ...
  },
  {
    ...
    color: 'indigo',
    tagline:
      'Specialized legal support for insurance disputes, employment issues, and regulatory defense.',
        ...
        <div className="max-w-6xl mx-auto px-6 pt-16 pb-12">
          <div className="max-w-3xl">
            ...
            <p className="text-slate-600 text-lg md:text-xl leading-relaxed mb-6 max-w-2xl">
              Verified credentials, medical certifications, and compliance documentation that
              airlines require for hiring decisions. Build trust with authenticated data.
            </p>
      ...
      <section className="py-16 px-6 border-b border-slate-200 bg-white">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-slate-600 text-lg max-w-2xl mb-10">
            Six essential verification categories that airlines require for confident hiring
            decisions.
          </p>
      ...
      <section className="py-16 px-6 bg-slate-900 text-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-slate-300 text-lg mb-8 max-w-2xl mx-auto">
            Join Pilot Recognition and build your verified compliance profile that airlines trust.
            Start with a free profile and upgrade for full verification.
          </p>
