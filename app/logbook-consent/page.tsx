        ...
        <div className="space-y-8">
          ...
          <section>
            ...
            <ul className="text-xs text-gray-600 space-y-1.5 list-disc list-inside mb-3">
              ...
              <li>The governing <span className="font-semibold text-gray-800">Approved Aviation Body</span> may identify logbook entries or documents that are falsified, expired, blacklisted, missing, stolen, or tampered with during the verification process.</li>
              <li>APC, the verifying <span className="font-semibold text-gray-800">Approved Aviation Body</span>, may report suspected fraudulent, expired, blacklisted, missing, stolen, or tampered documentation to the appropriate regulatory and law enforcement authorities.</li>
          ...
          <section>
            ...
            <ul className="text-xs text-gray-600 space-y-1.5 list-disc list-inside mb-3">
              ...
              <li>While the pilot's account is under review, the pilot may still browse pathways and submit applications; however, the pilot's profile will display a <span className="font-semibold text-gray-800">verification flag</span> visible to <span className="font-semibold text-gray-800">Approved Aviation Bodies</span> and airlines for transparency and pilot safety.</li>
              <li>Verification flags are shared with <span className="font-semibold text-gray-800">Approved Aviation Bodies</span> to ensure compliance and safety standards are maintained across all submissions.</li>
