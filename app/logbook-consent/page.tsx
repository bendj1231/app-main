        ...
        <div className="space-y-8">
          ...
          <section>
            ...
            <ul className="text-xs text-gray-600 space-y-1.5 list-disc list-inside mb-3">
              ...
              <li>The governing Civil Aviation Authority (CAA), Authorized Training Organization (ATO), Chief Flight Instructor (CFI), operators, or general aviation corporations may identify logbook entries or documents that are falsified, expired, blacklisted, missing, stolen, or tampered with during the verification process.</li>
              <li>APC, the verifying CAA, ATO, CFI, operators, or general aviation corporations may report suspected fraudulent, expired, blacklisted, missing, stolen, or tampered documentation to the appropriate regulatory and law enforcement authorities.</li>
