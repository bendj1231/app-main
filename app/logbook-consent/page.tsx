        ...
        <div className="space-y-8">
          ...
          <section>
            ...
            <p className="text-xs text-gray-600 leading-relaxed mb-3">
              I hereby authorize <span className="font-semibold text-gray-800">Aviation Pathways Consultancy (APC)</span> to audit my flight logbook and submit my uploaded documents to the designated Authorized Training Organization (ATO) and Civil Aviation Authority (CAA) for verification of flight hours, training records, and endorsements. I understand that:
            </p>
            <ul className="text-xs text-gray-600 space-y-1.5 list-disc list-inside mb-3">
              <li>APC will send my logbook (scanned or CSV) and related documents to the ATO for independent verification of flight hours and training endorsements.</li>
              <li>The ATO will verify my logbook against their training records, simulator sessions, and instructor sign-offs.</li>
              <li>APC will receive verification results (verified / discrepancies found / pending) but will not store my raw logbook files beyond the 30-day retention period.</li>
              <li>The ATO may retain copies of my logbook pages during the verification process as per their standard procedures.</li>
          ...
          <section>
            ...
            <p className="text-xs text-gray-600 leading-relaxed mb-3">
              I confirm that I am the legitimate holder of the logbook and flight hours submitted above. I understand that:
            </p>
            <ul className="text-xs text-gray-600 space-y-1.5 list-disc list-inside mb-3">
              ...
              <li>My PilotRecognition profile and any associated wallet credentials may be revoked if logbook entries are found to be fraudulent or inflated.</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="text-xs text-gray-600 space-y-1.5 list-disc list-inside mb-3">
              ...
              <li>If the ATO or CFI indicates that a logbook requires review or re-upload (e.g., illegible signature, incorrect date format, missing page, unsigned entry), I must resolve the issue within the 30-day window.</li>
