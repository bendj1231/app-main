            ...
            <section id="pillars" className="py-20 px-6 border-b border-slate-200 bg-slate-900">
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="mt-12 pt-8 border-t border-white/10 flex flex-wrap gap-4">
                        ...
                        <a href="https://enterprise.pilotrecognition.com/framework/full" className="inline-flex items-center gap-2 bg-white/10 hover:bg-white/20 text-white border border-white/30 font-semibold px-6 py-3 rounded-lg transition-colors">
                            Access Full Framework (90+ pages) →
                        </a>
                    </div>
                </div>
            </section>
