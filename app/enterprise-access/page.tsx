...
const SECTORS: Sector[] = [
    {
        ...
        pain: 'The aviation industry suffers from a fundamental recognition problem. Pilots lack visibility into airline expectations, and airlines drown in applications from candidates who never understood the requirements. 80% of applications to general aviation airlines are not applications at all — they are inquiries about expectations, requirements, and pathway details. Airlines simply do not have time to respond to every single inquiry about what they are looking for. Meanwhile, pilots submit blind applications, hoping their profile matches, with no clear guidance on how to align their experience with specific airline needs. Traditional job boards list openings but hide the critical context: what competencies you actually value, what your pathway looks like, and how candidates should position themselves.',
        solution: 'PilotRecognition solves this by giving airlines a platform to publish clear, structured pathways and expectations upfront. Instead of filtering through confused inquiries and mismatched applications, you define exactly what you are looking for — hours, type ratings, competencies, behavioral profiles — and pilots align their profiles to match before they ever reach you. You get a pipeline of pilots who already understand your needs and have positioned themselves accordingly. No more answering the same requirement questions hundreds of times. No more mismatched applications. Just pilots who recognize what you need and have prepared accordingly.',
        benefits: [
            'Pathway Cards — publish detailed expectations, requirements, and competencies publicly',
        ...
        pilots: [
            'See exact airline expectations before investing time in applications',
            'Align your profile toward specific airline needs with clear guidance',
