...
const SECTORS: Sector[] = [
    {
        ...
        pain: 'The aviation industry suffers from a fundamental recognition problem. Pilots lack visibility into operator expectations — whether airlines, charter companies, private jet fleets, or corporate flight departments. Operators of all sizes drown in applications from candidates who never understood the requirements. 80% of applications to general aviation and charter operators are not applications at all — they are inquiries about expectations, requirements, and pathway details. Operators simply do not have time to respond to every single inquiry about what they are looking for. A charter operator with a specific aircraft type needs rated pilots immediately, not a pile of unqualified CVs. Meanwhile, pilots submit blind applications, hoping their profile matches, with no clear guidance on how to align their experience with specific operator needs. Traditional job boards list openings but hide the critical context: what competencies you actually value, what your pathway looks like, and how candidates should position themselves.',
