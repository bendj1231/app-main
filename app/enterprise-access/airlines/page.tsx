...
const AirlinesOperatorsPage = () => {
  ...
  const NAV_GROUPS = [
    {
      ...
      items: [
        { id: 'airlines', label: 'Airlines & Operators', href: '/enterprise-access/airlines' },
        {
          ...
          href: '/enterprise-access#flightschools',
        },
        ...
        { id: 'military', label: 'Military & Defence', href: '/enterprise-access#military' },
        {
          ...
          href: '/enterprise-access#manufacturers',
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          href: '/enterprise-access#recruitment',
        },
  ...
  const airlinesSector = {
    ...
    tagline:
      'Close the <span class="text-red-600">recognition gap</span>.<br>Surface your <span class="text-red-600">expectations</span>. Pull <span class="text-red-600">aligned pilots</span>.',
      ...
      <div className="min-h-screen bg-white text-slate-900">
          ...
          <div className="max-w-7xl mx-auto px-4 lg:px-6">
            <div className="flex items-center justify-between h-16">
                ...
                {NAV_GROUPS.map((group) => (
                  ...
                  >
                    <button className="px-4 py-2 text-sm text-slate-600 hover:text-slate-900 transition-colors flex items-center gap-1">
                      {group.label}
                      <svg
                        className={`w-3 h-3 transition-transform ${openMenu === group.label ? 'rotate-180' : ''}`}
                        fill="none"
                        stroke="currentColor"
                        viewBox="0 0 24 24"
                      >
              ...
              <div className="flex items-center gap-3">
                ...
                <button
                  onClick={() =>
                    window.open('https://pilotrecognition.com', '_blank', 'noopener,noreferrer')
                  }
              ...
              <div className="lg:hidden border-t border-slate-200 py-4 max-h-[80vh] overflow-y-auto bg-white">
                {NAV_GROUPS.map((group) => (
                  <div key={group.label} className="mb-4">
                    <p className="text-[10px] uppercase tracking-widest text-slate-500 font-bold px-2 mb-1.5">
                      {group.label}
                    </p>
                    {group.items.map((item) =>
                      item.href ? (
        ...
        <section className="py-16 px-6 border-b border-slate-200 bg-gradient-to-b from-slate-50 to-white">
          <div className="max-w-4xl mx-auto text-center">
            <p className="text-[10px] uppercase tracking-[0.3em] text-red-600 font-semibold mb-4">
              {airlinesSector.label}
            </p>
            <h1 className="text-3xl md:text-4xl font-bold leading-tight mb-6 text-slate-900">
              ...
              Surface your <span className="text-red-600">expectations</span>. Pull{' '}
              <span className="text-red-600">aligned pilots</span>.
            </h1>
            <p className="text-slate-600 text-base max-w-2xl mx-auto mb-8">
              Stop drowning in mismatched applications. Build a pipeline of pilots who already
              understand your needs and have positioned themselves accordingly.
            </p>
            <div className="flex flex-wrap justify-center gap-4">
              <button
                onClick={() => scrollTo('problem')}
                className="bg-red-600 hover:bg-red-500 text-white font-semibold px-6 py-3 rounded-xl transition-colors text-sm"
              >
                See the Problem →
              </button>
              <button
                onClick={() => scrollTo('contact')}
                className="bg-white border border-slate-300 hover:bg-slate-50 text-slate-700 font-semibold px-6 py-3 rounded-xl transition-colors text-sm"
              >
                Request Access
              </button>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
              <div>
                ...
                <p className="text-slate-400 text-xs mt-1">
                  of applications are just inquiries about expectations
                </p>
              </div>
              <div>
                <p className="text-3xl font-bold text-red-400">$50K</p>
                <p className="text-slate-400 text-xs mt-1">
                  average pilot training investment sitting unused
                </p>
              </div>
              <div>
                <p className="text-3xl font-bold text-red-400">2-3yr</p>
                <p className="text-slate-400 text-xs mt-1">
                  instructor position backup — Batch of 2015 still waiting
                </p>
              </div>
              <div>
                <p className="text-3xl font-bold text-red-400">90%</p>
                <p className="text-slate-400 text-xs mt-1">
                  cost reduction with pre-aligned pilot pipeline
                </p>
              </div>
            </div>
          </div>
        ...
        <section id="pricing" className="py-16 px-6 border-b border-slate-200 bg-slate-50">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-8">
              <p className="text-[10px] uppercase tracking-[0.3em] text-red-600 font-semibold mb-3">
                Enterprise Access
              </p>
              <h2 className="text-2xl md:text-3xl font-bold mb-4 text-slate-900">
                Post Pathways. Gain Interest Insights. Pull{' '}
                <span className="text-red-600">PilotRecognition</span>
                <span className="text-red-600">+</span> Profiles.
              </h2>
              <p className="text-slate-600 text-base max-w-2xl mx-auto mb-8">
                Transform how you recruit. Publish your expectations once. Receive aligned,
                pre-qualified pilot interest continuously.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-12 max-w-4xl mx-auto">
              <div className="bg-white border border-slate-200 rounded-xl p-5 text-center">
                ...
                <p className="text-slate-600 text-xs">
                  Publish detailed expectations, requirements, and competencies for pilots to
                  self-align
                </p>
              </div>
              <div className="bg-white border border-slate-200 rounded-xl p-5 text-center">
                ...
                <p className="text-slate-600 text-xs">
                  See which pilots have expressed interest, their Recognition Score, and alignment
                  metrics
                </p>
              </div>
              <div className="bg-white border border-slate-200 rounded-xl p-5 text-center">
                ...
                <p className="text-slate-600 text-xs">
                  Access <span className="text-red-600 font-semibold">PilotRecognition</span>
                  <span className="text-red-600 font-semibold">+</span> users with background
            ...
            <div className="mt-8 bg-emerald-50 border border-emerald-200 rounded-xl p-6 max-w-4xl mx-auto">
              <p className="text-slate-800 text-sm text-center">
                <span className="font-semibold text-emerald-700">Cost Comparison:</span> Traditional
                agency placement for a G650 Captain averages{' '}
                <span className="font-semibold">$50,000</span>. With PilotRecognition Enterprise,
                your annual cost is just <span className="font-semibold text-red-600">$1,000</span>
                —a massive saving in search and networking costs.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-slate-600 text-base max-w-2xl mx-auto">
                Pilots with thousands of hours stand unrecognized outside, while operators inside
            ...
            <div className="mb-10">
              ...
              <p className="text-slate-500 text-xs text-center mt-3">
                The paradox of modern aviation recruitment costs the industry millions in lost
                talent and misplaced opportunities.
              </p>
            </div>

            <div className="grid md:grid-cols-3 gap-6">
              <div className="bg-red-50 border border-red-200 rounded-xl p-5">
                <p className="text-red-700 text-[10px] uppercase tracking-widest font-bold mb-2">
                  The Pilot Paradox
                </p>
                <p className="text-slate-700 text-xs leading-relaxed">
                  Job boards list "500 hours" but hide the real competencies you need: type ratings,
                  turbine experience, CRM skills. Pilots apply blind, operators get mismatched
                  candidates.
                </p>
              </div>
              <div className="bg-orange-50 border border-orange-200 rounded-xl p-5">
                <p className="text-orange-700 text-[10px] uppercase tracking-widest font-bold mb-2">
                  The Time Drain
                </p>
                <p className="text-slate-700 text-xs leading-relaxed">
                  80% of applications to charter operators aren't applications at all—they're
                  questions about requirements. Part 135 operators need pilots yesterday, not time
                  to mentor.
                </p>
              </div>
              <div className="bg-amber-50 border border-amber-200 rounded-xl p-5">
                <p className="text-amber-700 text-[10px] uppercase tracking-widest font-bold mb-2">
                  The Hidden Cost
                </p>
                <p className="text-slate-700 text-xs leading-relaxed">
                  Traditional agencies charge 15-25% of annual salary ($50K+ for a G650 Captain).
                  You pay premium prices for a reactive, manual process that repeats every hire.
                </p>
              </div>
            </div>
          </div>
        ...
        <section id="comparison" className="py-16 px-6 border-b border-slate-200 bg-slate-50">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <h2 className="text-2xl md:text-3xl font-bold mb-4 text-slate-900">
                Three Approaches to Pilot Recruitment
              </h2>
              <p className="text-slate-600 text-base max-w-2xl mx-auto">
                Understanding how traditional methods, current job boards, and PilotRecognition
                differ in approach and outcomes.
              </p>
            </div>
            ...
            <div className="grid lg:grid-cols-3 gap-6">
              ...
              <div className="bg-white border border-slate-200 rounded-2xl p-6">
                <div className="flex items-center gap-2 mb-4">
                  <div className="w-8 h-8 bg-slate-200 rounded-lg flex items-center justify-center text-slate-600 font-bold text-sm">
                    1
                  </div>
              ...
              <div className="bg-white border border-slate-200 rounded-2xl p-6">
                ...
                <div className="bg-orange-50 rounded-lg p-3">
                  <p className="text-orange-700 text-xs font-semibold">
                    Result: Time wasted on mismatches
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white border-2 border-red-200 rounded-2xl p-6 relative">
                ...
                <div className="bg-emerald-50 rounded-lg p-3">
                  <p className="text-emerald-700 text-xs font-semibold">
                    Cost: 90% reduction per placement
                  </p>
                </div>
              </div>
            </div>
        ...
        <section id="approach" className="py-16 px-6 border-b border-slate-200 bg-white">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              <p className="text-[10px] uppercase tracking-[0.3em] text-red-600 font-semibold mb-3">
                03. The Modern Approach
              </p>
              <h2 className="text-2xl md:text-3xl font-bold mb-4 text-slate-900">How It Works</h2>
              <p className="text-slate-600 text-base max-w-2xl mx-auto">
                A neutral infrastructure that serves both sides of the aviation market—operators and
                pilots—with transparency and alignment.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8 mb-12">
              <div className="text-center">
                ...
                <p className="text-slate-600 text-xs">
                  Publish clear, structured expectations—hours, type ratings, competencies,
                  behavioral profiles. No more hidden requirements.
                </p>
              </div>
              <div className="text-center">
                <div className="w-16 h-16 bg-red-100 rounded-2xl flex items-center justify-center mx-auto mb-4">
                ...
                <p className="text-slate-600 text-xs">
                  Pilots see exactly what you need and position their profiles to match before they
                  ever reach you. Self-selection reduces noise.
                </p>
              </div>
              <div className="text-center">
                <div className="w-16 h-16 bg-red-100 rounded-2xl flex items-center justify-center mx-auto mb-4">
                ...
                <p className="text-slate-600 text-xs">
                  Access pre-qualified interest from pilots who already understand your needs.
                  Ranked by Recognition Score—objective readiness metrics.
                </p>
              </div>
            </div>
            ...
            <div className="bg-slate-50 border border-slate-200 rounded-2xl p-8">
              <h3 className="text-xl font-bold text-slate-900 mb-6 text-center">
                Example: Gulfstream G650 Pathway Card
              </h3>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-start gap-2">
                      ...
                      <p className="text-slate-700 text-sm">
                        UHNW Service: Polished, high-discretion communication
                      </p>
                    </div>
                    <div className="flex items-start gap-2">
                      <span className="text-red-500 text-xs mt-1">●</span>
                      <p className="text-slate-700 text-sm">
                        Global Reach: Oceanic crossings, ETOPS routing
                      </p>
                    </div>
                    <div className="flex items-start gap-2">
                      <span className="text-red-500 text-xs mt-1">●</span>
                      <p className="text-slate-700 text-sm">
                        Charter Agility: Ad-hoc, short-notice readiness
                      </p>
                    </div>
                    <div className="flex items-start gap-2">
                      <span className="text-red-500 text-xs mt-1">●</span>
                      <p className="text-slate-700 text-sm">
                        Immediate Availability: Ready to fly today
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div className="bg-gradient-to-br from-slate-900 via-blue-950 to-slate-900 border border-blue-900/30 rounded-2xl p-8 mt-8 shadow-2xl">
              <h3 className="text-xl font-bold text-white mb-6 text-center">
                Example: Airline X Cadet Program <span className="text-red-500">Pathway Card</span>
              </h3>
              ...
              <div className="flex flex-col md:flex-row gap-6 mb-8">
                ...
                <div className="w-full md:w-2/3">
                  <div className="flex items-center gap-3 mb-3">
                    <span className="bg-blue-500/20 border border-blue-400/30 text-blue-300 px-3 py-1 rounded-full text-xs font-semibold">
                      92% Match
                    </span>
                    <span className="bg-white/10 border border-white/20 text-white px-3 py-1 rounded-full text-xs font-semibold backdrop-blur-sm">
                      PR Score: 78/100
                    </span>
                  </div>
                  <h4 className="text-2xl font-bold text-white mb-2">
                    Airline X <span className="text-blue-400">Cadet Program</span>
                  </h4>
                  <p className="text-slate-300 text-sm mb-4">
                    Structured cadet pathway from zero experience to First Officer.{' '}
                    <span className="text-red-400 font-medium">Sponsored type rating training</span>
                    , guaranteed interview upon completion, and direct employment track to the
                    flight deck.
                  </p>
                  <div className="flex flex-wrap gap-2">
                    <span className="bg-white/5 border border-white/10 text-slate-300 px-3 py-1 rounded-full text-xs backdrop-blur-sm">
                      0-250 Hours
                    </span>
                    <span className="bg-white/5 border border-white/10 text-slate-300 px-3 py-1 rounded-full text-xs backdrop-blur-sm">
                      PPL Accepted
                    </span>
                    <span className="bg-red-500/20 border border-red-400/30 text-red-400 px-3 py-1 rounded-full text-xs font-medium backdrop-blur-sm">
                      Sponsored TR
                    </span>
                  </div>
                </div>
              ...
              <div className="mt-6 bg-blue-950/80 border border-blue-800/30 rounded-xl p-6 backdrop-blur-lg">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <p className="text-[10px] uppercase tracking-widest text-blue-300 font-bold">
                    How to Align Your Profile — What Airline X is Looking For
                  </p>
                </div>

                <p className="text-slate-300 text-sm mb-6 bg-slate-900/60 border border-slate-700 rounded-lg p-3 backdrop-blur-sm">
                  <strong className="text-white">Pilots:</strong> Use this section to understand
                  exactly what Airline X requires and how to position your profile for success. Meet
                  these requirements to maximize your Recognition Score and application priority.
                </p>

                {/* Step 1: Meet Hard Requirements */}
                <div className="bg-white border border-slate-200 rounded-lg p-5 mb-4 shadow-lg">
                  <div className="flex items-center gap-2 mb-4">
                    <span className="w-6 h-6 bg-slate-900 text-white rounded-full text-xs font-bold flex items-center justify-center">
                      1
                    </span>
                    <p className="text-sm font-bold text-slate-900">
                      Meet These Hard Requirements First
                    </p>
                  </div>
                  <p className="text-xs text-slate-500 mb-4">
                    These are non-negotiable minimums. Your application will be automatically
                    filtered if you don't meet these.
                  </p>
                ...
                <div className="bg-white border border-slate-200 rounded-lg p-5 mb-4 shadow-lg">
                  <div className="flex items-center gap-2 mb-4">
                    ...
                    <p className="text-sm font-bold text-slate-900">
                      Build These Hard Competencies to Boost Your Score
                    </p>
                  </div>
                  <p className="text-xs text-slate-500 mb-4">
                    Each competency you add increases your Recognition Score. Log these in your
                    profile to stand out.
                  </p>
                  <div className="grid md:grid-cols-3 gap-3">
                    <div className="bg-slate-50 rounded-lg p-3 border border-slate-200">
                      <p className="text-xs font-bold text-slate-900 mb-1">
                        High Value (+5-8 Points)
                      </p>
                ...
                <div className="bg-white border border-slate-200 rounded-lg p-5 mb-4 shadow-lg">
                  <div className="flex items-center gap-2 mb-4">
                    ...
                    <p className="text-sm font-bold text-slate-900">
                      Demonstrate These Soft Competencies
                    </p>
                  </div>
                  <p className="text-xs text-slate-500 mb-4">
                    These appear in your EBT video interview and mentor evaluations. Develop these
                    traits to score higher.
                  </p>
                    ...
                    <div className="flex items-start gap-2">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-slate-500">
                          Show rapid absorption of complex systems during training
                        </p>
                      </div>
                    </div>
                    <div className="flex items-start gap-2">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-slate-500">
                          Collaborative communication, receptive to feedback
                        </p>
                      </div>
                    </div>
                    <div className="flex items-start gap-2">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-slate-500">
                          Handle setbacks constructively during intensive phases
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="bg-white border border-slate-200 rounded-lg p-5 mb-4 shadow-lg">
                  <div className="flex items-center gap-2 mb-4">
                    ...
                    <p className="text-sm font-bold text-slate-900">
                      Hit These Profile Requirements to Get Interviewed
                    </p>
                  </div>
                  <p className="text-xs text-slate-500 mb-4">
                    Your Recognition Profile must meet these thresholds to advance. Here's what to
                    aim for:
                  </p>
                  <div className="grid md:grid-cols-3 gap-4">
                    ...
                    <div className="bg-slate-50 border-2 border-red-300 rounded-lg p-4 text-center">
                      ...
                      <p className="text-xs text-slate-600 font-semibold">
                        78% of successful cadets
                      </p>
                    </div>
                  </div>
                  <div className="mt-4 bg-slate-50 border border-slate-200 rounded-lg p-4">
                    <p className="text-xs font-bold text-slate-900 mb-3">
                      How Your Profile Score Determines Your Queue:
                    </p>
                    <div className="space-y-2 text-sm">
                      <div className="flex items-start gap-2">
                        ...
                        <div>
                          <p className="text-slate-900 font-semibold">
                            Recognition+ Users with PR Score 75+
                          </p>
                          <p className="text-xs text-slate-500">
                            <strong className="text-slate-900">
                              Immediate interview scheduling.
                            </strong>{' '}
                            Background verified via Veremark. No additional screening. 60% faster
                            onboarding.
                          </p>
                        </div>
                      </div>
                      <div className="flex items-start gap-2">
                        ...
                        <div>
                          <p className="text-slate-900 font-semibold">
                            Free Members with PR Score 72-74
                          </p>
                          <p className="text-xs text-slate-500">
                            <strong className="text-slate-700">Standard queue.</strong> Background
                            check required before interview. 2-3 week additional processing.
                          </p>
                        </div>
                      </div>
                      <div className="flex items-start gap-2">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-slate-500">
                            <strong className="text-slate-400">Waitlisted.</strong> Re-apply after
                            profile improvement or upgrade to Recognition+.
                          </p>
                        </div>
                      </div>
                    </div>
                ...
                <div className="bg-slate-100 border border-slate-200 rounded-lg p-5">
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <p className="text-sm font-bold text-slate-900">
                      Understand The Airline's Mindset
                    </p>
                  </div>
                  <p className="text-slate-700 text-sm leading-relaxed">
                    Airline X seeks cadets who demonstrate{' '}
                    <strong className="text-slate-900">
                      unwavering commitment to professional aviation standards
                    </strong>
                    . Show exceptional discipline, adaptability to high-tempo operations, and a
                    collaborative mindset. Demonstrate consistent flight progression, strong
                    academic aptitude, and resilience. If you embody these traits — and your profile
                    reflects them — you'll transition directly to First Officer on modern
                    narrow-body aircraft.
                  </p>
                  <div className="mt-4 flex flex-wrap gap-2">
                    <span className="bg-white border border-slate-200 text-slate-700 px-3 py-1 rounded-full text-xs font-semibold shadow-sm">
                      Show discipline in logbook consistency
                    </span>
                    <span className="bg-white border border-slate-200 text-slate-700 px-3 py-1 rounded-full text-xs font-semibold shadow-sm">
                      Demonstrate progression month-over-month
                    </span>
                    <span className="bg-red-50 border border-red-200 text-red-700 px-3 py-1 rounded-full text-xs font-semibold">
                      Complete profile verification (Recognition+)
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-6 bg-blue-950/80 border border-blue-800/30 rounded-xl p-6 backdrop-blur-lg">
                <div className="flex items-center gap-2 mb-6">
                  ...
                  <p className="text-[10px] uppercase tracking-widest text-blue-300 font-bold">
                    Pilot Expectations — What You Want to Know
                  </p>
                </div>
                    ...
                    <div className="space-y-3">
                      <div className="flex items-start gap-2">
                        ...
                        <p className="text-slate-600 text-sm">
                          <strong className="text-slate-900">Trajectory:</strong> Cadet → First
                          Officer → Captain (6-8 year track)
                        </p>
                      </div>
                      <div className="flex items-start gap-2">
                        <span className="text-slate-900 text-xs mt-1">●</span>
                        <p className="text-slate-600 text-sm">
                          <strong className="text-slate-900">Captain Upgrade:</strong> Command at
                          4,000+ hours with airline
                        </p>
                      </div>
                      <div className="flex items-start gap-2">
                        <span className="text-slate-900 text-xs mt-1">●</span>
                        <p className="text-slate-600 text-sm">
                          <strong className="text-slate-900">Employment Rate:</strong> 90% hired
                          upon TR completion
                        </p>
                      </div>
                      <div className="flex items-start gap-2">
                        <span className="text-slate-900 text-xs mt-1">●</span>
                        <p className="text-slate-600 text-sm">
                          <strong className="text-slate-900">Airline Type:</strong> Narrow-body
                          fleet (A320/B737)
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="bg-white border border-slate-200 rounded-lg p-5 shadow-lg">
                    ...
                    <div className="space-y-2">
                      <div className="flex items-start gap-2">
                        <span className="text-green-600 mt-0.5">✓</span>
                        <p className="text-slate-600 text-sm">
                          <strong className="text-slate-900">Sponsored Type Rating</strong> ($35K
                          value)
                        </p>
                      </div>
                      <div className="flex items-start gap-2">
                ...
                <div className="mt-4 bg-white border border-slate-200 rounded-lg p-5 shadow-lg">
                  <p className="text-xs font-bold text-slate-900 mb-4 uppercase tracking-wide">
                    Your Recognition Score — Where Do You Stand?
                  </p>
                  <div className="space-y-3">
                    <div className="flex items-center justify-between py-2 border-b border-slate-100">
                      <div className="flex items-center gap-3">
                      ...
                      <span className="bg-slate-100 border border-slate-200 text-slate-600 px-2 py-1 rounded text-xs font-semibold">
                        PR Score: 70-75
                      </span>
                    </div>
                    <div className="flex items-center justify-between py-2 border-b border-slate-100">
                    ...
                    <div className="flex items-center justify-between py-2 border-b border-slate-100 bg-slate-50 rounded px-2 -mx-2">
                      <div className="flex items-center gap-3">
                        ...
                        <span className="text-sm text-slate-900 font-medium">
                          200-250 Hours (CPL Ready) ← Target Zone
                        </span>
                      </div>
                      <span className="bg-blue-50 border border-blue-200 text-blue-700 px-2 py-1 rounded text-xs font-semibold">
                        PR Score: 78-82
                      </span>
                    </div>
                    <div className="flex items-center justify-between py-2 border-b border-slate-100">
                    ...
                    <div className="flex items-center justify-between py-2">
                      ...
                      <span className="bg-green-50 border border-green-200 text-green-700 px-2 py-1 rounded text-xs font-semibold">
                        PR Score: 85-92
                      </span>
                    </div>
                  </div>
                ...
                <div className="mt-4 bg-white border border-slate-200 rounded-lg p-5 shadow-lg">
                  <p className="text-xs font-bold text-slate-900 mb-3 uppercase tracking-wide">
                    Common Pilot Questions — Answered
                  </p>
                  <div className="grid md:grid-cols-2 gap-4 text-sm">
                    <div>
                      <p className="font-semibold text-slate-700 text-xs mb-1">
                        Q: Is the type rating sponsored or bonded?
                      </p>
                      <p className="text-slate-500">
                        A: Fully sponsored. 3-year service commitment after line assignment.
                      </p>
                    </div>
                    <div>
                      <p className="font-semibold text-slate-700 text-xs mb-1">
                      ...
                      <p className="text-slate-500">
                        A: Bases assigned by operational need. Preferences considered.
                      </p>
                    </div>
                    <div>
                      <p className="font-semibold text-slate-700 text-xs mb-1">
                        Q: What if I fail a training phase?
                      </p>
                      <p className="text-slate-500">
                        A: One remediation allowed per phase. 94% completion rate.
                      </p>
                    </div>
                    <div>
                      <p className="font-semibold text-slate-700 text-xs mb-1">
                        Q: Is salary during training?
                      </p>
                      <p className="text-slate-500">
                        A: Training stipend $2,500/month. Full FO salary upon completion.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="mt-8 pt-8 border-t border-slate-700">
                <p className="text-[10px] uppercase tracking-widest text-slate-400 font-bold mb-4 text-center">
              ...
              <div className="mt-8 text-center">
                <p className="text-slate-400 text-sm mb-4">
                  Pilots see this complete breakdown before expressing interest.{' '}
                  <span className="text-white font-semibold">
                    No more "what do you require?" inquiries.
                  </span>
                </p>
        ...
        <section
          id="mission"
          className="py-16 px-6 border-b border-slate-200 bg-gradient-to-b from-slate-50 to-white"
        >
          <div className="max-w-4xl mx-auto text-center">
            <p className="text-[10px] uppercase tracking-[0.3em] text-red-600 font-semibold mb-3">
              04. Our Mission
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="bg-white border border-slate-200 rounded-xl p-5 text-center">
                ...
                <p className="text-slate-600 text-xs">
                  Eliminate the recognition gap between pilots and flight departments through
                  transparency.
                </p>
              </div>
              <div className="bg-white border border-slate-200 rounded-xl p-5 text-center">
                ...
                <p className="text-slate-600 text-xs">
                  Force transparency with Pathway Cards that show exactly what operators value.
                </p>
              </div>
              <div className="bg-white border border-slate-200 rounded-xl p-5 text-center">
                <div className="w-12 h-12 bg-red-100 rounded-full flex items-center justify-center mx-auto mb-3">
                ...
                <p className="text-slate-600 text-xs">
                  Shift from blind applications to pre-qualified, aligned pilot interest.
                </p>
              </div>
            </div>
          </div>
        ...
        <section id="metrics" className="py-16 px-6 border-b border-slate-200 bg-white">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <h2 className="text-2xl md:text-3xl font-bold mb-4 text-slate-900">
                From "Gut Feeling" to Data-Driven Recruitment
              </h2>
              <p className="text-slate-600 text-base max-w-2xl mx-auto">
                Modern aviation recruitment demands metrics, not intuition. Our infrastructure
            ...
            <div className="grid md:grid-cols-3 gap-8 mb-12">
              ...
              <div className="bg-slate-900 text-white rounded-2xl p-8 text-center">
                ...
                <p className="text-slate-400 text-xs">
                  of "what do you require?" questions eliminated
                </p>
                <div className="mt-4 pt-4 border-t border-slate-700">
            ...
            <div className="bg-emerald-50 border border-emerald-200 rounded-xl p-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-slate-700 text-sm leading-relaxed">
                    Traditional recruitment is reactive: post a job, wait for applications, filter
                    through hundreds of unqualified candidates. Our infrastructure is proactive:
                    pilots see your Pathway Card, self-align their profiles, and express interest
                    only when qualified. The result?{' '}
                    <span className="font-semibold text-emerald-700">
                      Pre-qualified candidates who meet your exact specifications before they ever
                      contact you.
                    </span>
                  </p>
                </div>
            ...
            <div className="mt-8 bg-slate-900 rounded-2xl p-8">
              <h3 className="text-lg font-bold text-white mb-6 text-center">
                Time-to-Flight: The Speed Advantage
              </h3>
              <div className="grid md:grid-cols-2 gap-8">
                <div className="border border-slate-700 rounded-xl p-6">
                  ...
                  <div className="mt-4 pt-4 border-t border-slate-700">
                    <p className="text-slate-400 text-sm text-center">
                      Total: <span className="text-slate-300 font-bold">60-90 days</span>
                    </p>
                  </div>
                </div>
                ...
                <div className="border-2 border-red-600 rounded-xl p-6 bg-slate-800/50">
                  ...
                  <div className="mt-4 pt-4 border-t border-red-600">
                    <p className="text-white text-sm text-center">
                      Total: <span className="text-red-400 font-bold">&lt;14 days</span>
                    </p>
                  </div>
                </div>
              </div>
              <p className="text-slate-400 text-xs text-center mt-6">
                The difference?{' '}
                <span className="text-red-400 font-semibold">PilotRecognition+ users</span> are
                pre-verified and pre-aligned. You skip the 60-day vetting phase entirely.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="compliance" className="py-16 px-6 border-b border-slate-200 bg-slate-50">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <h2 className="text-2xl md:text-3xl font-bold mb-4 text-slate-900">
                De-Risking Your Hiring Process
              </h2>
              <p className="text-slate-600 text-base max-w-2xl mx-auto">
                Safety and compliance are non-negotiable. We verify what matters before pilots reach
                your inbox.
              </p>
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-8 mb-12">
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-slate-600 text-xs">
                        Secure Flight and Known Crewmember status verification
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-slate-600 text-xs">
                        Current Class 1 or 2 medical validation with expiration alerts
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-slate-600 text-xs">
                        DOT-compliant testing records and random program enrollment
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="font-semibold text-slate-900 text-sm">
                        License & Rating Verification
                      </p>
                      <p className="text-slate-600 text-xs">
                        Direct integration with FAA Airmen Database for real-time validation
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-white border border-slate-200 rounded-2xl p-8">
                ...
                <div className="bg-gradient-to-br from-emerald-50 to-emerald-100 border border-emerald-200 rounded-xl p-6 mb-6">
                  ...
                  <p className="text-slate-700 text-sm leading-relaxed">
                    When you see this badge, the pilot has completed background verification,
                    medical certification validation, and document authentication.{' '}
                    <span className="font-semibold text-emerald-700">
                      You can bypass the risky initial vetting stage and move directly to technical
                      evaluation.
                    </span>
                  </p>
                </div>
        ...
        <section id="integrations" className="py-16 px-6 border-b border-slate-200 bg-white">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-slate-600 text-base max-w-2xl mx-auto">
                No data silos. No manual exports. Connect PilotRecognition to your current ATS and
                HR infrastructure.
              </p>
            </div>
            ...
            <div className="bg-slate-900 text-white rounded-2xl p-8">
              <div className="grid md:grid-cols-3 gap-8">
                <div className="text-center">
                  ...
                  <p className="text-slate-400 text-xs">
                    Sync qualified candidates directly into your ATS candidate pool
                  </p>
                </div>
                <div className="text-center">
                  <div className="w-12 h-12 bg-red-600 rounded-full flex items-center justify-center mx-auto mb-3">
                  ...
                  <p className="text-slate-400 text-xs">
                    Real-time notifications when qualified pilots express interest
                  </p>
                </div>
                <div className="text-center">
                  <div className="w-12 h-12 bg-red-600 rounded-full flex items-center justify-center mx-auto mb-3">
                  ...
                  <p className="text-slate-400 text-xs">
                    All pilot data, documents, and verification status in one connected system
                  </p>
                </div>
              </div>
            </div>
        ...
        <section id="dataflow" className="py-16 px-6 border-b border-slate-200 bg-slate-50">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <h2 className="text-2xl md:text-3xl font-bold mb-4 text-slate-900">
                Verified Data Flows Directly to Your HR Systems
              </h2>
              <p className="text-slate-600 text-base max-w-2xl mx-auto">
                In 2026, digital identity and touchless credentials are the standard.
                PilotRecognition data integrates seamlessly with your existing infrastructure—no
                manual exports, no data re-entry, no compliance gaps.
              </p>
            </div>

            <div className="bg-white border border-slate-200 rounded-2xl p-8 mb-8">
              <h3 className="text-lg font-bold text-slate-900 mb-8 text-center">
                Two Tiers, Your Choice: Free Members vs.{' '}
                <span className="text-red-600">PilotRecognition</span>
                <span className="text-red-600">+</span> Users
              </h3>
                ...
                <div className="border border-slate-200 rounded-xl p-6">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-start gap-3">
                      ...
                      <p className="text-slate-600 text-xs">
                        Pilot creates profile with self-reported hours, ratings, and experience
                      </p>
                    </div>
                    <div className="flex items-start gap-3">
                      <span className="text-slate-400 font-bold text-xs">2</span>
                      <p className="text-slate-600 text-xs">
                        Expresses interest in your Pathway Card based on visible requirements
                      </p>
                    </div>
                    <div className="flex items-start gap-3">
                      <span className="text-slate-400 font-bold text-xs">3</span>
                      <p className="text-slate-600 text-xs">
                        You receive interest notification with profile data (hours, ratings,
                        recency)
                      </p>
                    </div>
                    <div className="flex items-start gap-3">
                      ...
                      <p className="text-slate-600 text-xs">
                        Your team conducts background checks and verification (you control the
                        process)
                      </p>
                    </div>
                  </div>
                  <div className="mt-4 pt-4 border-t border-slate-200">
                    <p className="text-slate-500 text-xs italic">
                      Best for: Operators with existing vetting infrastructure who want broader
                      candidate reach
                    </p>
                  </div>
                </div>
                ...
                <div className="border-2 border-red-600 bg-slate-900 rounded-xl p-6">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <div>
                      <h4 className="font-bold text-white">
                        <span className="text-red-500">PilotRecognition</span>
                        <span className="text-red-500">+</span> User Path
                      </h4>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-start gap-3">
                      ...
                      <p className="text-white text-xs">
                        Pilot completes background verification via screening partner network
                        (5-year employment, identity, criminal checks)
                      </p>
                    </div>
                    <div className="flex items-start gap-3">
                      <span className="text-red-500 font-bold text-xs">2</span>
                      <p className="text-white text-xs">
                        Digital credentials created: FAA medical, type ratings, TSA status converted
                        to touchless-ready format
                      </p>
                    </div>
                    <div className="flex items-start gap-3">
                      <span className="text-red-500 font-bold text-xs">3</span>
                      <p className="text-white text-xs">
                        Verified data packet auto-syncs to your ATS (Workday, iCIMS, Greenhouse) via
                        API
                      </p>
                    </div>
                    <div className="flex items-start gap-3">
                      ...
                      <p className="text-white text-xs">
                        HR receives pre-validated candidate—bypass initial vetting entirely, proceed
                  ...
                  <div className="mt-4 pt-4 border-t border-red-600">
                    <p className="text-red-400 text-xs italic">
                      Best for: Operators who want to eliminate vetting overhead and accelerate
                      time-to-fill
                    </p>
                  </div>
                </div>
              ...
              <div className="mt-8 pt-8 border-t border-slate-200">
                <div className="bg-slate-100 rounded-xl p-4">
                  <p className="text-slate-700 text-sm text-center">
                    <span className="font-semibold">You decide:</span> Access both tiers or filter
                    to <span className="text-red-600">PilotRecognition</span>
                    <span className="text-red-600">+</span> only. Set your own risk tolerance—see
                    all candidates or only pre-verified professionals.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-slate-900 text-white rounded-2xl p-8">
                <h3 className="text-lg font-bold mb-4">
                  The <span className="text-red-400">PilotRecognition</span>
                  <span className="text-red-400">+</span> Advantage
                </h3>
                <p className="text-slate-300 text-sm mb-6">
                  <span className="text-red-400">PilotRecognition</span>
                  <span className="text-red-400">+</span> users have completed the full verification
                  stack before entering your funnel. For 2026's touchless airport environments, this
                  means:
                </p>
                ...
                <div className="mt-6 pt-6 border-t border-slate-700">
                  <p className="text-slate-400 text-xs">
                    <span className="text-slate-400">Free tier:</span> Pilots with live profiles but
                    unverified backgrounds. You conduct your own checks.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white border border-slate-200 rounded-2xl p-8">
                ...
                <p className="text-slate-600 text-sm mb-6">
                  As airlines adopt touchless identity and digital credentials, PilotRecognition
                  ensures your recruitment infrastructure stays ahead:
                </p>
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="font-semibold text-slate-900 text-sm">
                        Biometric-Ready Profiles
                      </p>
                      <p className="text-slate-600 text-xs">
                        Pilot data formatted for touchless ID systems and biometric access control
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-slate-600 text-xs">
                        Medical expiry, recency, and rating changes update automatically in your HR
                        system
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-slate-600 text-xs">
                        Native integrations with Workday, iCIMS, SAP—no middleware required
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-white border border-slate-200 rounded-2xl p-8">
                ...
                <p className="text-slate-600 text-sm mb-4">
                  Technical competency verification and CRM assessment
                </p>
              ...
              <div className="bg-white border border-slate-200 rounded-2xl p-8">
                ...
                <p className="text-slate-600 text-sm mb-4">
                  Efficiency, compliance, and reduced administrative burden
                </p>
                <ul className="space-y-2 text-xs text-slate-700">
                  <li className="flex items-start gap-2">
                    <span className="text-emerald-500">●</span>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-gradient-to-br from-slate-50 to-slate-100 border border-slate-200 rounded-2xl p-8">
                ...
                <p className="text-slate-700 text-sm leading-relaxed">
                  "Pathway Cards eliminated the 'what do you need?' phone calls. Pilots arrive
                  pre-qualified and already understand our operation. First-year attrition dropped
                  from 22% to 4%."
                </p>
              </div>
              ...
              <div className="bg-gradient-to-br from-slate-50 to-slate-100 border border-slate-200 rounded-2xl p-8">
                ...
                <p className="text-slate-700 text-sm leading-relaxed">
                  "The Recognition Score filtering is game-changing. Every candidate we've hired
                  through the platform already had the type rating and 500+ hours in type. Zero
                  training delays."
                </p>
              </div>
            </div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
              <div className="bg-slate-50 border border-slate-200 rounded-xl p-5">
                <p className="text-red-600 text-[10px] uppercase tracking-widest font-bold mb-3">
                  Matching
                </p>
              ...
              <div className="bg-slate-50 border border-slate-200 rounded-xl p-5">
                ...
                <ul className="space-y-2">
                  <li className="flex items-start gap-2 text-xs text-slate-700">
                    <span className="text-emerald-500">✓</span>
                    You decide free vs <span className="text-red-600">PilotRecognition</span>
            ...
            <div className="bg-red-50 border border-red-200 rounded-2xl p-8">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <p className="text-slate-700 text-xs leading-relaxed">
                    When pilots know exactly what you need, they either align themselves to match—or
                    self-select out. Either way, you waste less time on mismatches. The pilots who
                    do reach out are already qualified, interested, and ready.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-10">
              ...
              <p className="text-slate-600 text-base max-w-xl mx-auto">
                Join the operators moving from "Push" to "Pull" recruitment. Build your Pathway Card
                today.
              </p>
            </div>
              ...
              >
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      placeholder="Your airline or operator name"
                    />
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-slate-700 mb-2">
                    ...
                    <input
                      type="text"
                      className="w-full px-4 py-3 rounded-lg border border-slate-300 focus:border-red-500 focus:ring-2 focus:ring-red-200 outline-none transition-all"
                      placeholder="e.g., A320, G650, Challenger 350"
                    />
                  </div>
                </div>
                <div className="grid md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <textarea
                    rows={4}
                    className="w-full px-4 py-3 rounded-lg border border-slate-300 focus:border-red-500 focus:ring-2 focus:ring-red-200 outline-none transition-all"
                    placeholder="Tell us about your recruitment challenges or questions..."
                  ></textarea>
                </div>
                <button
                  type="submit"
                  className="w-full bg-red-600 hover:bg-red-500 text-white font-semibold py-4 rounded-xl transition-colors text-base"
                >
                  Submit Request →
                </button>
                <p className="text-slate-500 text-xs text-center">
                  Our team will respond within 24 hours. Syncs with your existing ATS and
        ...
        <footer className="bg-slate-900 text-white py-12 px-6">
          <div className="max-w-7xl mx-auto">
            <div className="grid md:grid-cols-4 gap-8 mb-8">
              <div>
                <p className="text-[11px] uppercase tracking-[0.3em] text-red-400 font-semibold mb-4">
                  Enterprise
                </p>
                <ul className="space-y-2">
                  <li>
                    <a
                      href="/enterprise-access#solutions"
                  ...
                  <li>
                    <a
                      href="/enterprise-access#partners"
                      className="text-slate-400 hover:text-white text-sm transition-colors"
                    >
                      Partnership Tiers
                    </a>
              ...
              <div>
                ...
                <ul className="space-y-2">
                  <li>
                    <a
                      href="/enterprise-access/airlines"
                      className="text-slate-400 hover:text-white text-sm transition-colors"
                    >
                      Airlines & Operators
                    </a>
                  ...
                  <li>
                    <a
                      href="/enterprise-access#privatejet"
                      className="text-slate-400 hover:text-white text-sm transition-colors"
                    >
                      Private Jet & Charter
                    </a>
              ...
              <div>
                ...
                <ul className="space-y-2">
                  ...
                  <li>
                    <a
                      href="/enterprise-access/learn-more"
                      className="text-slate-400 hover:text-white text-sm transition-colors"
                    >
                      Learn More
                    </a>
              ...
              <div>
                ...
                <p className="text-slate-400 text-sm mb-4">
                  Connecting Pilots to the Industry. Enterprise solutions for aviation recruitment
            ...
            <div className="border-t border-slate-800 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
              <div className="flex items-center gap-3">
                ...
                <span className="text-[10px] uppercase tracking-widest border border-slate-600 px-1.5 py-0.5 rounded text-slate-400">
                  Enterprise
                </span>
              </div>
              <p className="text-slate-400 text-sm">
                © 2026 PilotRecognition. All rights reserved.
              </p>
              <a
                href="https://pilotrecognition.com"
