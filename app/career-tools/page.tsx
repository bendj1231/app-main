...
const CAREER_CATEGORIES = [
    {
        ...
        solution: 'Our AI analyzes your complete profile — flight hours, type ratings, Recognition Score, location preferences, and career goals — to identify perfect matches. Get ranked compatibility scores and understand exactly where you stand for each opportunity.',
        benefits: [
    ...
    },
    {
        ...
        solution: 'The ATLAS CV Builder creates perfectly formatted, ATS-optimized resumes that pass automated screening. Built-in aviation keyword optimization, standardized formatting, and airline-specific templates ensure your CV reaches hiring managers.',
        benefits: [
    ...
    },
    {
        ...
        solution: 'Comprehensive interview preparation including airline-specific question banks, video interview practice with AI feedback, technical quiz assessments, and simulator session prep. Know exactly what to expect before you walk in.',
        benefits: [
    ...
    },
    {
        ...
        solution: 'Interactive career roadmap showing exactly what you need at each stage. From student pilot → CPL → instructor → regional → major airline → command, with specific hour requirements, rating recommendations, and timeline estimates.',
        benefits: [
    ...
    },
    {
        ...
        solution: 'Data-driven type rating recommendations based on live market demand, airline hiring patterns, and your career goals. ROI calculator shows payback timelines, training provider comparisons, and job opportunity forecasts by aircraft type.',
        benefits: [
    ...
    },
    {
        ...
        solution: 'Complete airline intelligence hub with verified data on fleet composition, base locations, pay scales by seniority, work rules, benefits, hiring status, and anonymous pilot reviews. Compare airlines side-by-side with objective data.',
        benefits: [
    ...
    },
    {
        ...
        solution: 'Curated mentorship matching connecting you with experienced pilots who\'ve walked your path. From captain upgrades and airline transitions to training advice and career coaching, get guidance from those who\'ve succeeded before you.',
        benefits: [
    ...
    },
    {
        ...
        solution: 'Centralized application management system tracking every submission, interview stage, required document, and follow-up date. Automated reminders ensure nothing falls through the cracks during your job search.',
        benefits: [
    ...
    },
    {
        ...
        solution: 'Comprehensive directory of verified training providers with reviews, pass rates, pricing, instructor credentials, and airline partnerships. Filter by location, aircraft type, cost, and training format to find your perfect match.',
        benefits: [
    ...
    },
    {
        ...
        solution: 'Automated analysis comparing your logbook against any airline\'s requirements. Instantly see where you meet, exceed, or fall short of requirements. Get specific guidance on what experience to build before applying.',
        benefits: [
        ...
        <div className="min-h-screen bg-white text-slate-900">
                    ...
                    <div className="flex items-center justify-between h-16">
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <button onClick={() => navigate('/')} className="flex items-center gap-3 group">
                                ...
                                <span className="text-sm font-semibold text-slate-900 tracking-wide">Career Tools</span>
                            </button>
                        </div>
            ...
            <section className="relative bg-slate-50 border-b border-slate-200">
                <div className="max-w-6xl mx-auto px-6 pt-16 pb-12">
                    <div className="max-w-3xl">
                        ...
                        <p className="text-[11px] uppercase tracking-[0.3em] text-red-600 font-semibold mb-3">Professional Development</p>
                        ...
                        <p className="text-slate-600 text-lg md:text-xl leading-relaxed mb-6 max-w-2xl">
                            AI-powered career matching, interview preparation, pathway planning, and professional tools to advance your aviation career strategically.
                        </p>
            ...
            <section className="py-16 px-6 border-b border-slate-200 bg-white">
                <div className="max-w-6xl mx-auto">
                    <p className="text-[11px] uppercase tracking-[0.3em] text-red-600 font-semibold mb-3">Career Development</p>
                    <h2 className="text-3xl md:text-4xl font-bold mb-4 text-slate-900">Complete Career Toolkit.</h2>
                    <p className="text-slate-600 text-lg max-w-2xl mb-10">Ten comprehensive tools to plan, prepare, apply, and advance your aviation career with confidence.</p>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
                        {CAREER_CATEGORIES.map(cat => (
                            ...
                            >
                                ...
                                <h3 className="text-slate-900 font-semibold text-sm mb-1 group-hover:text-red-600 transition-colors">{cat.label}</h3>
                                <p className="text-slate-600 text-xs leading-relaxed">{cat.tagline.substring(0, 50)}...</p>
                            </button>
                        ))}
                    </div>
                </div>
            ...
            <section className="py-16 px-6 bg-slate-900 text-white">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <p className="text-slate-300 text-lg mb-8 max-w-2xl mx-auto">
                        Join Pilot Recognition and access the complete career toolkit that helps you plan, prepare, and succeed in your aviation career.
                    </p>
