    ...
    return (
        <div className="min-h-screen bg-white text-slate-900 font-sans">
            ...
            <div className="py-12 px-6 max-w-6xl mx-auto space-y-16">
                ...
                {/* Section 2: The PilotRecognition Solution */}
                <div className="flex flex-col md:flex-row-reverse items-center gap-10 md:gap-16">
                    <div className="md:w-1/2 text-center md:text-left">
                        ...
                        <p className="text-base text-slate-700 leading-relaxed mb-4">
                            PilotRecognition doesn't just acknowledge the gap; we bridge it. By providing access to professional-grade applications, structured mentorship, and a verified database, we turn "empty hours" into "verifiable operational experience."
                        </p>
                    </div>
                    <div className="md:w-1/2">
                        <div className="relative w-full max-w-md mx-auto">
