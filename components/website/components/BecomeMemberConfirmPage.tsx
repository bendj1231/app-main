        ...
        <div className="w-full max-w-2xl rounded-[32px] border border-white/10 bg-slate-900/90 p-8 shadow-2xl shadow-slate-950/40 backdrop-blur-xl">
          <div className="mb-6 rounded-[28px] bg-slate-800/80 p-6 border border-slate-700/70">
            <h1 className="text-3xl font-semibold text-white">
              ATC calling... <span className="text-red-300">Identify</span> yourself, <span className="text-red-300">Pilot</span>
            </h1>
            <p className="mt-3 text-slate-300 leading-7">
              We found your login, but you still need to finish creating your Pilot Recognition account.
              Accept the terms and confirm you are over 16 before continuing to the setup page.
            </p>
          </div>
          ...
          <div className="space-y-5">
            <label className="flex items-start gap-3 rounded-2xl border border-slate-700/80 bg-slate-800/80 p-4">
              ...
              <span className="text-slate-200 leading-7">
                I accept the <a href="/terms-of-service" className="font-semibold text-sky-400 hover:text-sky-300">Terms &amp; Conditions</a>.
              </span>
            </label>
