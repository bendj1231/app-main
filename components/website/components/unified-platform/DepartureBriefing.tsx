...
const PHASES: Phase[] = [
  {
    ...
    titleHighlight: 'OS',
    body: 'Your pilot career runs on three connected domains: pilotcareerpathways.com for matched opportunities, pilotrecognition.com for your verified profile, and pilotshortage.org for industry advocacy and resources.',
    button: 'Next',
    icon: Plane,
  ...
  },
  {
    ...
    body: 'This is your pilot record in one place: hours, licenses, medical, and ratings. Complete it to unlock accurate pathway matching and become visible to verified operators.',
    button: 'Next Step',
    icon: Plane,
    placement: 'left',
    navigateTab: 'profile',
  ...
  },
  {
    ...
    body: 'Explore matched opportunities across airlines, cargo, charter, corporate, eVTOL, and cadet programs. Compare each pathway against your profile to see what fits and which gaps to close.',
    button: 'Next',
    icon: Map,
    placement: 'above',
    ...
    showcaseSubtitle: 'Matched opportunities across aviation sectors.',
  ...
  },
  {
    ...
    body: 'pilotshortage.org is the advocacy and research layer. It tracks industry data, regional labor trends, and our direct partnerships with ATOs, airlines, and manufacturers working to solve the pilot shortage. You can become a free associate of pilotshortage.org to support the advocacy network and, with verification support from pilotrecognition.com, earn a verified badge that proves you are a legitimate pilot.',
    button: 'Next',
    icon: ShieldCheck,
    placement: 'above',
    ...
    showcaseSubtitle: 'Research and advocacy that connects to your career tools.',
  ...
  },
  {
    ...
    body: 'Your recognition account is where your verified pilot credentials live. Upload your licenses, medical, flight hours, and ratings to build a trusted profile. Opt for Recognition+ membership to unlock internship opportunities with pilotrecognition.com and exclusive pathways to charter, eVTOL, airline, and cargo roles.',
    ...
    showcaseSubtitle: 'Your verified logbook, licenses, and ratings in one record.',
