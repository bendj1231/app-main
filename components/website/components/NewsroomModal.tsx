                        ...
                        <div className="text-white space-y-2 md:space-y-4 flex flex-col min-h-0">
                            ...
                            <ul className="space-y-1 md:space-y-1.5">
                                {activeNewsItem.bullets.map((bullet: string, index: number) => (
                                    <li key={`${activeNewsItem.id}-bullet-${index}`} className="flex items-start gap-2 text-xs md:text-sm text-slate-100/90">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                                {activeNewsItem.metrics.map((metric: { label: string; value: string }) => (
                                    <div key={`${activeNewsItem.id}-${metric.label}`} className="border border-white/25 bg-white/5 px-2 py-1.5 md:px-3 md:py-2 shadow-lg shadow-black/30">
                            ...
                            <div className="flex flex-col items-center gap-2 pt-1">
                                ...
                                >
                                    <HomeIcon className="w-3.5 h-3.5 md:w-4 md:h-4" /> Home
                                </button>
                                <button
                                    onClick={() => {
