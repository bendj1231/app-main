...
export const airlines: Airline[] = [
  {
    ...
    fleet:
      'Boeing 777, 787, Airbus A350, A380 - One of the youngest fleets globally with an average age of just 5 years',
  },
  {
    id: 'singapore',
    ...
    description:
      'Singapore Airlines maintains one of the highest service standards globally, offering comprehensive benefits and a strategic Asian hub location. The airline provides excellent training and career development opportunities.',
    fleet:
      'Airbus A350, A380, Boeing 777, 787 - Operating one of the worlds most modern fleets with cutting-edge cabin technology',
  },
  {
    id: 'cathay',
    name: 'Cathay Pacific',
    ...
    description:
      'Cathay Pacific offers a dynamic work environment with extensive Asian network coverage and strong career progression pathways. The airline is known for its professional development programs.',
    fleet:
      'Airbus A350, A330, Boeing 777 - Modern wide-body fleet focused on long-haul Asian and trans-Pacific routes',
  },
  {
    id: 'emirates',
    name: 'Emirates',
    ...
    fleet:
      'Airbus A380, Boeing 777 - Worlds largest operator of both A380 and 777 aircraft with 250+ wide-bodies',
  },
  {
    id: 'etihad',
    name: 'Etihad Airways',
    ...
    fleet:
      'Boeing 787, 777, Airbus A350, A380 - Modern fuel-efficient fleet with state-of-the-art cabins and sustainable aviation focus',
  },
  {
    id: 'lufthansa',
    name: 'Lufthansa',
    ...
    description:
      'Lufthansa is Europes largest airline and a founding member of Star Alliance. It offers excellent career stability, comprehensive benefits, and opportunities to fly to over 200 destinations worldwide.',
    fleet:
      'Airbus A350, A330, Boeing 747-8, 777 - Mixed fleet with both modern twins and iconic 747 operations',
  },
  {
    id: 'british',
    ...
    description:
      'British Airways operates from its hub at London Heathrow, offering pilots access to a vast global network. The airline provides competitive European salaries and excellent training programs.',
    fleet:
      'Boeing 777, 787, Airbus A350, A380 - Flag carrier with diverse long-haul fleet and A380 operations',
  },
  {
    id: 'airfrance',
    name: 'Air France',
    ...
    description:
      'Air France is the French flag carrier with a rich history dating back to 1933. Pilots enjoy working in a multicultural environment with excellent French employment benefits and protections.',
    fleet:
      'Boeing 777, 787, Airbus A350, A330 - Modern wide-body fleet serving global destinations from Paris',
  },
  {
    id: 'klm',
    name: 'KLM',
    ...
    description:
      'KLM Royal Dutch Airlines is the oldest airline still operating under its original name. Known for efficient operations and excellent pilot relations, it offers a stable European career path.',
    fleet:
      'Boeing 777, 787, Airbus A330 - Efficient mixed fleet with strong focus on sustainability and biofuel initiatives',
  },
  {
    id: 'swiss',
    ...
    description:
      'Swiss International Air Lines combines traditional Swiss quality with modern aviation standards. Pilots benefit from excellent working conditions and the prestigious Swiss aviation heritage.',
    fleet:
      'Airbus A320 family, A330, A340 - Premium narrow and wide-body fleet serving European and intercontinental routes',
  },
  {
    id: 'turkish',
    ...
    description:
      'Turkish Airlines flies to more countries than any other airline. With its modern Istanbul Airport hub, it offers pilots exposure to diverse international routes and rapid fleet expansion.',
    fleet:
      'Boeing 737, 777, 787, Airbus A320, A330, A350 - One of the largest fleets globally with 400+ aircraft serving 120+ countries',
  },
  {
    id: 'ana',
    name: 'ANA All Nippon',
    ...
    description:
      'ANA is Japans largest airline and a 5-star carrier renowned for exceptional service. Pilots benefit from Japanese precision, excellent training, and access to key Asian markets.',
    fleet:
      'Boeing 777, 787, Airbus A380, A320 - Japans largest fleet with extensive Dreamliner operations and unique A380 configurations',
  },
  {
    id: 'jal',
    name: 'Japan Airlines',
    ...
    description:
      'Japan Airlines represents the finest in Japanese hospitality combined with aviation excellence. The airline offers pilots diverse flying between extensive domestic and international networks.',
    fleet:
      'Boeing 737, 767, 777, 787, Airbus A350 - Diverse fleet offering pilots experience across multiple aircraft types',
  },
  {
    id: 'korean',
    name: 'Korean Air',
    ...
    description:
      'Korean Air is South Koreas flagship carrier with a strong presence on trans-Pacific routes. Pilots enjoy competitive Asian compensation and a modern, expanding aircraft fleet.',
  },
  {
    id: 'asiana',
  ...
  },
  {
    ...
    description:
      'Garuda Indonesia serves the worlds largest archipelago nation. Pilots benefit from rapid fleet modernization and the opportunity to fly across one of Earths most diverse geographic areas.',
  },
  {
    id: 'philippine',
    ...
    description:
      'Philippine Airlines is Asias oldest commercial airline. It offers pilots a unique base in the Philippines with growing international connections to North America and Asia.',
  },
  {
    id: 'vietnam',
    ...
    description:
      'Vietnam Airlines represents one of Asias fastest-growing economies. The airline is rapidly modernizing its fleet and expanding international routes, offering pilots excellent growth opportunities.',
  },
  {
    id: 'china',
    name: 'Air China',
    ...
    description:
      'Air China is the flag carrier of the Peoples Republic of China and the worlds largest aviation market. Pilots have access to an unmatched domestic network and growing international presence.',
  },
  {
    id: 'chinaeastern',
    name: 'China Eastern',
    ...
    description:
      'China Eastern Airlines operates from Shanghai, connecting China with the world. The airline offers pilots opportunities in one of the fastest-growing aviation markets globally.',
  },
  {
    id: 'chinasouthern',
    name: 'China Southern',
    ...
    description:
      'China Southern operates Chinas largest fleet with extensive Asian coverage. Pilots benefit from modern aircraft and the opportunity to fly within the dynamic Chinese aviation sector.',
  },
  {
    id: 'delta',
    ...
    description:
      'Delta is the worlds largest airline by revenue and fleet size. It offers pilots industry-leading compensation, excellent benefits, and a vast domestic and international network from its Atlanta hub.',
    fleet:
      'Airbus A220, A320, A330, A350, Boeing 737, 757, 767, 777 - Industry-leading fleet diversity with modern Airbus A350 operations',
  },
  {
    id: 'american',
    ...
    description:
      'American Airlines is the worlds largest airline by fleet size and passengers carried. Pilots enjoy extensive route options and competitive US major airline compensation packages.',
    fleet:
      'Airbus A320, A321, Boeing 737, 777, 787 - Largest fleet in the world with 900+ aircraft including flagship 787 Dreamliners',
  },
  {
    id: 'united',
    ...
    description:
      'United Airlines offers one of the most comprehensive global networks. With hubs across the US and Star Alliance membership, pilots have unmatched international flying opportunities.',
    fleet:
      'Airbus A319, A320, Boeing 737, 757, 767, 777, 787 - Global network carrier with extensive wide-body fleet for international routes',
  },
  {
    id: 'southwest',
    ...
    description:
      'Southwest Airlines is the worlds largest low-cost carrier. Known for excellent pilot relations and unique company culture, it offers pilots stable domestic routes and profit-sharing benefits.',
  },
  {
    id: 'alaska',
    ...
    description:
      'Alaska Airlines is consistently rated among the best US airlines. With its Seattle hub and West Coast focus, it offers pilots a unique blend of domestic and Pacific Northwest flying.',
  },
  {
    id: 'jetblue',
    ...
    description:
      'JetBlue Airways revolutionized US domestic travel with its premium economy approach. Based in New York, it offers pilots modern aircraft and transcontinental premium routes.',
  },
  {
    id: 'aircanada',
    name: 'Air Canada',
    ...
    description:
      'Air Canada is Canadas flag carrier and largest airline. Pilots enjoy flying to over 200 destinations worldwide and excellent Canadian employment benefits and protections.',
  },
  {
    id: 'westjet',
    name: 'WestJet',
    ...
    description:
      'WestJet is Canadas second-largest airline and growing internationally. It offers pilots a more relaxed Canadian work environment with expanding long-haul opportunities.',
  },
  {
    id: 'qantas',
    name: 'Qantas',
    ...
    description:
      'Qantas is Australias flag carrier and one of the worlds safest airlines. Known for its Sydney-London Kangaroo Route, it offers pilots iconic long-haul flying and excellent safety culture.',
  },
  {
    id: 'virginaustralia',
    ...
    description:
      'Virgin Australia brings competitive service to the Australian market. Pilots enjoy modern aircraft and a focus on customer experience within the vast Australian domestic network.',
  },
  {
    id: 'latam',
    name: 'LATAM Airlines',
    ...
    description:
      'LATAM is Latin Americas largest airline group. From Santiago, pilots access an unmatched South American network combined with growing long-haul international routes.',
  },
  {
    id: 'avianca',
    name: 'Avianca',
    ...
    description:
      'Avianca is one of the worlds oldest continuously operating airlines. Its Bogota hub provides pilots access to diverse South American and growing North American destinations.',
  },
  {
    id: 'aeromexico',
    name: 'Aeromexico',
    ...
    description:
      'Aeromexico connects Latin America with the world from Mexico City. As a Skyteam member, it offers pilots codeshare opportunities and exposure to the dynamic Mexican market.',
  },
  {
    id: 'copaair',
    name: 'Copa Airlines',
    ...
    description:
      'Copa Airlines operates the Hub of the Americas in Panama. Pilots benefit from the strategic location connecting North and South America with efficient narrowbody operations.',
  },
  {
    id: 'gol',
    name: 'GOL Linhas',
    ...
    description:
      'GOL is Brazils largest domestic airline. It offers pilots the opportunity to fly within one of the worlds most geographically diverse countries with excellent South American connections.',
  },
  {
    id: 'elal',
    name: 'El Al Israel',
    ...
    description:
      'El Al is Israels flag carrier known for exceptional security standards. Pilots benefit from unique Middle Eastern operations and diverse international routes from Tel Aviv.',
  },
  {
    id: 'royaljordanian',
  ...
  },
  {
    ...
    description:
      'Saudia is Saudi Arabias flag carrier undergoing rapid transformation. Pilots have opportunities in a rapidly modernizing fleet with growing international destinations.',
  },
  {
    id: 'omanair',
    name: 'Oman Air',
    ...
    fleet:
      'Boeing 787 Dreamliner, 737 - Modern fleet with excellent career progression in the Gulf region',
  },
  {
    id: 'egyptair',
    name: 'EgyptAir',
    ...
    description:
      'EgyptAir connects Africa with the world from historic Cairo. Pilots benefit from unique African operations and ancient history while flying modern aircraft across diverse international routes.',
  },
  {
    id: 'ethiopian',
    ...
    description:
      'Ethiopian Airlines is Africas largest and most successful airline. From Addis Ababa, pilots access the continents most extensive network with modern Boeing and Airbus aircraft.',
  },
  {
    id: 'southafrican',
    ...
    description:
      'South African Airways connects the African continent from Johannesburg. Pilots enjoy diverse flying opportunities across Africa and international routes with Star Alliance benefits.',
  },
  // Additional European Airlines
  {
    ...
    description:
      'Iberia is Spains flagship carrier with strong connections to Latin America. Pilots benefit from excellent Spanish employment benefits and extensive transatlantic operations.',
  },
  {
    id: 'alitalia',
    name: 'ITA Airways',
    ...
    description:
      'ITA Airways represents the rebirth of Italian aviation. Operating from Rome with modern Airbus fleet, offering pilots Mediterranean and intercontinental routes.',
  },
  {
    id: 'austrian',
    ...
    description:
      'Austrian Airlines serves as the gateway to Eastern Europe from Vienna. Part of Lufthansa Group with excellent European career development opportunities.',
  },
  {
    id: 'brussels',
    ...
    description:
      'Brussels Airlines is Belgiums flagship carrier with extensive African network. Part of Lufthansa Group offering pilots unique African and European routes.',
  },
  {
    id: 'sas',
  ...
  },
  {
    ...
    description:
      'Finnair offers the shortest route between Europe and Asia via Helsinki. Modern Airbus A350 fleet with excellent focus on Asian markets.',
  },
  {
    id: 'tap',
    name: 'TAP Portugal',
  ...
  },
  {
    ...
    description:
      'Aegean Airlines is Greeces largest carrier with extensive island network. Star Alliance member offering pilots unique Mediterranean flying.',
  },
  {
    id: 'lot',
    name: 'LOT Polish',
    ...
    description:
      'LOT Polish Airlines is Eastern Europes leading carrier. Growing long-haul network with Boeing 787 Dreamliners from Warsaw Chopin Airport.',
  },
  {
    id: 'czech',
    name: 'Czech Airlines',
    ...
    description:
      'Czech Airlines serves Central Europe from historic Prague. One of the worlds oldest airlines with growing European network.',
  },
  {
    id: 'norwegian',
    name: 'Norwegian',
  ...
  },
  {
    ...
    description:
      'HK Express is Hong Kongs low-cost carrier. Part of Cathay Pacific group offering pilots dynamic short-haul Asian operations.',
  },
  {
    id: 'scoot',
    name: 'Scoot',
  ...
  },
  {
    ...
    description:
      'Peach Aviation is Japans leading low-cost carrier. Based in Osaka with extensive domestic and regional Asian network.',
  },
  {
    id: 'spring',
    ...
    description:
      'Spring Airlines is Chinas largest low-cost carrier. Based in Shanghai with extensive domestic Chinese network.',
  },
  {
    id: 'indigo',
    name: 'IndiGo',
    ...
    description:
      'IndiGo is Indias largest airline by passengers. Fast-growing low-cost carrier with extensive domestic and international network.',
  },
  {
    id: 'airindia',
    name: 'Air India',
    ...
    description:
      'Air India is Indias flag carrier now part of Tata Group. Star Alliance member with extensive international network from Mumbai and Delhi.',
  },
  {
    id: 'spicejet',
    name: 'SpiceJet',
    ...
    description:
      'SpiceJet is one of Indias leading low-cost carriers. Operating Boeing 737s across extensive Indian domestic network.',
  },
  {
    id: 'aigle',
  ...
  },
  {
    ...
    description:
      'Cebu Pacific is the Philippines largest low-cost carrier. Operating from Manila with extensive domestic and growing international network across Asia.',
  },
  {
    id: 'srilankan',
...
export const AirlineExpectationsCarousel: React.FC<AirlineExpectationsCarouselProps> = ({
  ...
  const [matchScores, setMatchScores] = useState<{
    [key: string]: { matchPercentage: number; prScore: number };
  }>({});
    ...
    const fetchMatchScores = async () => {
      try {
        if (airlineIntelligence.airlineMatches?.airlineMatches) {
          ...
          airlineIntelligence.airlineMatches.airlineMatches.forEach(
            (match: { name: string; matchPct: number }) => {
  ...
  const getMatchScore = (airline: Airline) => {
    const fbMatch = airlineIntelligence.airlineMatches?.airlineMatches?.find(
      (a) => a.id === airline.id
    );
    ...
    <>
      ...
      <div className="relative w-full bg-white py-12 overflow-hidden">
        ...
        <div className="w-full px-8 mb-8 text-center">
          ...
          <span
            className="text-3xl md:text-4xl mt-1 leading-none"
            style={{ color: '#DAA520', fontFamily: 'Georgia, serif' }}
          >
        ...
        <div className="w-full px-8 py-4">
          <p className="text-center text-slate-700 text-base md:text-lg mb-4 max-w-3xl mx-auto leading-relaxed">
            We seek the answers that all pilots need to know:{' '}
            <strong>What sets your airline apart in the industry?</strong>{' '}
            <strong>What unique value does your airline offer pilots?</strong>{' '}
            <strong>What makes you different?</strong>{' '}
            <strong>What are the benefits of your pilot programs?</strong>{' '}
            <strong>What are your requirements?</strong>{' '}
            <strong>What type of pilots are you looking for?</strong>{' '}
            <strong>How can I align my recognition profile with your airline?</strong> The airlines
            we contact provide direct expectations and answers pilots need to know to align their
            professional development toward their airline.
          </p>
          <p className="text-center text-slate-600 text-sm mb-4 max-w-3xl mx-auto leading-relaxed">
            Our programs align with EBT CBTA frameworks and international training standards,
            ensuring that the airline expectations we provide align with the exacting standards
            required by leading manufacturers and operators. We recognize that pilots need to
            understand new industry standards, systems, and training methods. With thousands of
            pilots asking about requirements daily—80% lacking clear information—we bridge this
            communication gap. The industry only offers job boards. PilotRecognition provides direct
            understanding and recognition direction, helping pilots align with the new systems and
            training methods the industry now uses. Our ATS-compatible ATLAS Aviation CV formatting
            presents your credentials in the standardized format preferred by major airlines
            worldwide.
          </p>
        </div>
        ...
        <div className="w-full px-8 py-4">
          <div className="flex justify-center gap-3 flex-wrap">
            {['All', 'Asia', 'Europe', 'Americas', 'Oceania', 'Africa', 'Middle East'].map(
              (region) => (
                <button
                  key={region}
                  onClick={() => {
                ...
                return (
                  <div
                    ...
                    className={`flex-shrink-0 w-[520px] h-[300px] rounded-2xl overflow-hidden shadow-xl cursor-pointer transition-all duration-500 snap-center ${
                      isActive
                        ? 'ring-4 ring-blue-400 ring-offset-2 scale-100'
                        : 'scale-95 opacity-80'
                    }`}
                  ...
                  >
                    ...
                    <div className="relative w-full h-full bg-gradient-to-br from-slate-800 via-slate-900 to-black">
                      ...
                      <div className="absolute inset-0 p-5 flex flex-col justify-between">
                        ...
                        <div className="flex justify-between items-start">
                          ...
                          <div className="flex items-center gap-2">
                            <div className="relative group">
                              <div
                                className={`bg-blue-600 text-white px-2 py-1 rounded-lg text-xs font-bold transition-all duration-300 cursor-help ${
                              ...
                              <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 w-48 bg-slate-900 text-white text-[10px] p-2 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none z-50">
                                ...
                                <p>
                                  Profile match on 1-10 scale based on your qualifications vs
                            ...
                            <div className="relative group">
                              {(() => {
                                ...
                                return (
                                  ...
                                  >
                                    <div
                                      className={`${bgColor} text-white px-3 py-1.5 rounded-lg text-sm font-bold cursor-help`}
                                    >
                                      {matchPct}%
                                    </div>
                                    {readiness && isActive && (
                                      <span
                                        className={`text-[9px] font-semibold mt-0.5 px-1.5 py-0.5 rounded-full ${
                                          matchPct >= 75
                              ...
                              <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 w-52 bg-slate-900 text-white text-[10px] p-2 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none z-50">
                                ...
                                <p>
                                  Calculated using PilotRecognition's 5-factor formula: Programs ×
                                  Experience × Behavioral × Language × Skills
                                </p>
                                <div className="absolute top-full left-1/2 transform -translate-x-1/2 -mt-1 border-4 border-transparent border-t-slate-900"></div>
                              </div>
                            </div>
                        ...
                        {/* Middle Content */}
                        <div>
                          <h3 className="text-2xl font-serif text-white mb-1">{airline.name}</h3>
                          <p className="text-sm text-white/60 mb-2">{airline.name} Airways</p>
        ...
        <div className="max-w-4xl mx-auto px-6 mt-12 pt-8 border-t border-slate-100">
          <p className="text-base md:text-lg text-slate-700 leading-relaxed text-center">
            Swipe through to discover airline-specific requirements and compare opportunities across
            global carriers. The airlines we contact provide direct expectations and answers pilots
            need to align their professional development toward their airline.
          </p>
        </div>
