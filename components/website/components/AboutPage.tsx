...
import { ArrowLeft, Shield, Users, BookOpen, ArrowRight } from 'lucide-react';
...
export const AboutPage: React.FC<AboutPageProps> = ({ onBack, onNavigate, onLogin }) => {
  return (
    <div className="min-h-screen bg-white text-slate-900 font-sans">
      <TopNavbar onNavigate={onNavigate} onLogin={onLogin} forceScrolled={true} isLight={true} />

      {/* Hero Section */}
      <section className="relative pt-[104px] pb-20 md:pb-28 overflow-hidden bg-slate-950">
        ...
        <div
          ...
          style={{
            background: 'radial-gradient(circle at 70% 30%, rgba(59,130,246,0.3), transparent 50%)',
          }}
        />
        <div
          className="absolute bottom-0 left-0 w-1/2 h-full opacity-20"
          style={{
            background: 'radial-gradient(circle at 30% 70%, rgba(239,68,68,0.25), transparent 50%)',
          }}
        />
        <div className="relative z-10 max-w-6xl mx-auto px-6 pt-16 text-center">
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-serif text-white leading-tight mb-4">
            Pilot<span className="text-red-500">Recognition</span> Platform
          </h1>
          ...
          <p className="text-lg md:text-xl text-white/80 max-w-3xl mx-auto mb-10 leading-relaxed">
            Not a job board. Not a recruitment agency. A recognition platform where pilots get
            verified, operators see real proof, and every engagement requires your consent.
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
            <button
              onClick={() => onNavigate('discover-pathways')}
              className="group inline-flex items-center gap-2 px-8 py-3.5 bg-red-600 hover:bg-red-700 text-white font-bold rounded-full transition-all hover:scale-105 shadow-lg shadow-red-900/30"
            >
              Explore Pathways
            ...
            <button
              onClick={() => onLogin?.()}
              className="px-8 py-3.5 bg-white/5 hover:bg-white/10 border border-white/20 text-white font-bold rounded-full transition-all backdrop-blur-sm"
            >
              Get Started Free
            </button>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-4xl mx-auto">
            {[
              ...
              { label: 'Pathway Submissions', value: 'Unlimited' },
              { label: 'Placement Fees', value: 'Zero' },
            ].map((stat) => (
              <div
                key={stat.label}
      ...
      <section className="py-16 md:py-24 px-6 bg-white">
        <div className="max-w-3xl mx-auto text-base text-slate-700 leading-relaxed text-left space-y-6">
          <p>
            Aviation's first pilot-owned career platform. The industry has never given pilots the
            infrastructure to prove who they are — only the paperwork to survive audits.
            PilotRecognition fixes that. You sync your logbook, verify your license, medical, and
            credentials through international verification providers, and build a recognition
            profile that reflects what you've actually done — not just what you claim. Your
            credentials are issued as sovereign W3C Verified Credential tokens to your own
            cryptographic wallet. The platform never retains your documents after verification. We
            receive the confirmation — not the paper.
          </p>
          <p>
            It is not a job board but a professional networking platform—similar to LinkedIn for the
            aviation industry. Instead of pilots sending CVs into a void, operators post pathway
            cards showing exactly what they need: hours, ratings, nationality requirements, type
            rating preferences, experience level. You align your profile against those requirements
            and submit interest. If an operator wants to move forward, they send you a consent
            message — free. They may include a confidential offer document that self-destructs
            within 5 days of inactivity. You read it, negotiate if needed, and decide. Operators pay
            a flat annual subscription for advanced search tools; there are absolutely no success,
            connection, or placement fees for either side.
          </p>
          <p>
            The Foundation Program builds the verified competency record operators look for. It
            covers 50 hours of logged mentorship, EBT CBTA-aligned industry education, type rating
            investment risk management, and a practical mentorship interview. Free to enter.
            Certification is $49 at completion. Everything you complete is appended to your profile
            and made available to operators with your consent.
          </p>

          {/* Pricing Section */}
          <div className="mt-4">
            <p className="text-red-500 text-[0.65rem] font-black uppercase tracking-[0.3em] mb-2">
              Pricing
            </p>
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-8">
              ...
              <div className="bg-white border border-slate-200 rounded-2xl p-8 flex flex-col">
                ...
                <p className="text-5xl font-black text-slate-900 mb-1">
                  $0<span className="text-lg font-medium text-slate-400">/year</span>
                </p>
              ...
              <div className="bg-red-600 rounded-2xl p-8 flex flex-col relative">
                <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-yellow-400 text-yellow-900 text-[10px] font-black uppercase tracking-widest px-4 py-1 rounded-full">
                  Best Value
                </div>
                <p className="text-red-200 text-sm font-medium mb-1">Recognition+ Verified</p>
                <p className="text-5xl font-black text-white mb-1">
                  $100<span className="text-lg font-medium text-red-300">/year</span>
                </p>
                ...
                <button
                  onClick={() => onLogin()}
                  className="w-full py-3 rounded-xl bg-white text-red-600 font-bold text-sm hover:bg-red-50 transition-colors"
                >
                  Get Annual Plan
                </button>
              </div>
            ...
            <div className="bg-slate-900 rounded-2xl p-8">
              <p className="text-slate-400 text-[0.65rem] font-black uppercase tracking-[0.3em] mb-1">
                Full Feature Details
              </p>
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="bg-white p-8 rounded-t-2xl border border-slate-200 border-b-0 relative">
              ...
              <div className="flex items-center gap-3 mb-4">
                <div className="w-12 h-12 bg-slate-100 rounded-full flex items-center justify-center text-slate-700 font-bold text-xl">
                  0
                </div>
            ...
            <div className="bg-white p-8 border border-slate-200 border-b-0 relative">
              ...
              <div className="text-slate-700 space-y-1">
                <p>
                  5,000 hours. 15 years instructing. No formal system recognizes instructional
                  expertise as a pathway to advancement.
                </p>
            ...
            <div className="bg-white p-8 border border-slate-200 border-b-0 relative">
              ...
              <div className="text-slate-700 space-y-1">
                ...
                <p>
                  Half the line asks for outdated A330 requirements. Requirements changed 3 months
                  ago.
                </p>
            ...
            <div className="bg-white p-8 rounded-b-2xl border border-slate-200">
              ...
              <div className="text-slate-700 space-y-1">
                ...
                <p>
                  Your flight hours transfer. Your type ratings transfer. But your seniority stays
                  with the airline.
                </p>
                <p>
                  Your competencies are documented. Proof of what you can do, not just hours logged.
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="py-8 px-6 bg-blue-900 text-white">
        <div className="max-w-6xl mx-auto text-center">
          <p className="text-lg font-medium">
            Operator requirements are verified by our pilot community and operator-submitted data.
            Real pilots check every posting. Requirements are updated as operators publish changes
            and our community reports updates. Stop applying blind. Apply with verified information.
          </p>
        </div>
      </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="bg-slate-50 p-8 rounded-t-2xl border border-slate-200 border-b-0 relative">
              ...
              <div className="text-slate-700 space-y-1">
                <p>
                  Foundation Program — free to enter, $49 certification at completion. Scholarship
                  seats for verified low-income applicants.
                </p>
            ...
            <div className="bg-slate-50 p-8 border border-slate-200 border-b-0 relative">
              ...
              <div className="text-slate-700 space-y-1">
                ...
                <p>
                  Document your instructional expertise. Airlines value structured training
                  experience.
                </p>
              </div>
            </div>
            ...
            <div className="bg-slate-50 p-8 border border-slate-200 border-b-0 relative">
              ...
              <div className="text-slate-700 space-y-1">
                <p>
                  Operator requirements verified by our pilot community and operator-submitted data.
                </p>
            ...
            <div className="bg-slate-50 p-8 rounded-b-2xl border border-slate-200">
              ...
              <div className="text-slate-700 space-y-1">
                ...
                <p>
                  Your competencies are portable. Your seniority stays with the airline. But you
                  have proof.
                </p>
              </div>
            </div>
      ...
      <div className="py-12 px-6 bg-slate-50">
        <div className="max-w-6xl mx-auto text-center">
          <p className="text-sm text-slate-600 mb-4">
            For detailed program specifications, technical documentation, and operational details
          </p>
          <button
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            <div className="text-center">
              ...
              <p className="text-slate-600">
                Build your Initial Competency Profile with flight experience, certifications, and
                training history.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-slate-600">
                Build baseline competency across 9 EBT CBTA areas through structured coursework and
                50-hour mentorship.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-bold text-slate-900 mb-2">
                Access Pathways & Get Recognized
              </h3>
              <p className="text-slate-600">
                When operators join, they pull verified profiles based on competency alignment. Your
                Recognition Score makes you visible to airlines, cargo operators, and specialized
                pathways as the network grows.
              </p>
            </div>
          </div>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-10">
            ...
            <p className="text-base text-slate-700 leading-relaxed max-w-3xl mx-auto">
              We provide verified competency assessment through EBT CBTA aligned programs. Pilots
              demonstrate capabilities through 50 hours of mentorship and behavioral assessment.
              When operators join the platform, they can pull verified profiles based on competency
              scores — not just hours. Recognition improves your matching priority with operators.
            </p>
          </div>
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white rounded-2xl p-8 border border-slate-200">
              ...
              <p className="text-slate-700 text-sm leading-relaxed">
                We deliver verified competency assessment through EBT CBTA aligned programs and 50
                hours of evidence-based mentorship. Pilots demonstrate actual capabilities — not
                just credentials. Operators access a pulling system built on real proof.
              </p>
            </div>
            <div className="bg-white rounded-2xl p-8 border border-slate-200">
              <p className="text-xs font-bold text-blue-700 uppercase tracking-[0.3em] mb-3">
              ...
              <h3 className="text-2xl font-serif text-slate-900 mb-4">
                Recognition as the Industry Standard
              </h3>
              <p className="text-slate-700 text-sm leading-relaxed">
                A world where pilots own sovereign, portable proof of their competencies — and
                operators can access verified talent without wading through stale CVs. Recognition
                Score becomes the industry currency. Static resumes become obsolete.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-10">
            ...
            <p className="text-base text-slate-700 leading-relaxed max-w-2xl mx-auto">
              Recognition isn't a word. It's an infrastructure problem the industry has never
              solved.
            </p>
          </div>
          <div className="grid md:grid-cols-3 gap-6">
            {[
              {
                label: 'For Students',
                text: 'You spent $50K training. A recognition profile means operators see verified proof of what you can do before you apply — not after 6 months of silence.',
              },
              {
                label: 'For Instructors',
                text: "15 years building other pilots' careers. The platform gives you the infrastructure to document instructional expertise as a pathway asset, not just a time-filler.",
              },
              {
                label: 'For Active Pilots',
                text: 'Your credentials are sovereign. Operators request access. You consent. No one holds your career data hostage — and your Recognition Score travels with you when you change operators.',
              },
            ].map(({ label, text }) => (
              <div key={label} className="bg-slate-50 rounded-xl p-6 border border-slate-200">
                <p className="text-xs font-bold text-blue-700 uppercase tracking-[0.25em] mb-2">
                  {label}
                </p>
      ...
      <div id="stewardship" className="py-16 px-6 bg-slate-900 text-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-slate-300 text-base leading-relaxed max-w-2xl mx-auto mb-10">
            PilotRecognition is pilot-owned infrastructure. We don't sell data. We don't push
            applications. We built a consent-based system where the pilot controls every engagement.
          </p>
          <div className="grid md:grid-cols-3 gap-6 text-left">
            {[
              {
                title: 'EBT Alignment',
                body: 'Our competency framework is aligned with ICAO Evidence-Based Training standards and Airbus HINFACT methodology. Assessments are documented, not self-reported.',
              },
              {
                title: 'Pilot Advocacy',
                body: 'Pre-employment verification costs belong to the employer, not the pilot. The $500 recognition fee is paid by operators. Pilots on the free tier are never charged for checks that benefit the hiring party.',
              },
              {
                title: '2030 Vision',
                body: 'By 2030, PilotRecognition aims to be the global clearinghouse for verified pilot data — replacing static CVs with live credential chains that meet ICAO, FAA, EASA, and CAAP standards.',
              },
            ].map(({ title, body }) => (
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div>
              ...
              <p className="text-slate-400 text-sm">
                A pilot recognition platform built on verified competency data
              </p>
            </div>
            <div>
              ...
              <ul className="space-y-2 text-slate-400 text-sm">
                ...
                <li>
                  <a
                    onClick={() => onNavigate('pilot-gap-about')}
                    className="hover:text-white cursor-pointer transition-colors"
                  >
