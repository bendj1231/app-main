      ...
      <div className="pt-32 pb-12 px-6">
        <div className="max-w-6xl mx-auto text-center relative z-20">
          ...
          <p className="text-slate-900 font-black text-base md:text-lg max-w-2xl mx-auto mb-8 leading-relaxed">
            Not a job board. Not a recruitment agency. A recognition platform — pilots get verified,
            operators see real proof, and every engagement requires your consent.
          </p>
          ...
          <div className="max-w-3xl mx-auto text-base text-slate-700 leading-relaxed text-left space-y-6">
            ...
            <p>
              ...
              against those requirements and submit interest. If an operator wants to move forward,
              they send you a consent message — free. They may include a confidential offer document
              that self-destructs within 5 days of inactivity. You read it, negotiate if needed, and
              decide. Operators pay a flat annual subscription for advanced search tools; there are
              absolutely no success, connection, or placement fees for either side.
            </p>
            <p>
              ...
              Certification is $49 at completion. Everything you complete is appended to your
              profile and made available to operators with your consent.
            </p>
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-8">
                ...
                <div className="bg-white border border-slate-200 rounded-2xl p-8 flex flex-col">
                  ...
                  <ul className="space-y-2 text-sm text-slate-600 mb-8 flex-1">
                    ...
                    {['Priority matching', 'Exclusive pathways', 'Verified credentials'].map(
                      (f) => (
      ...
      <div className="bg-slate-900 text-white py-12 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="border-t border-slate-800 pt-8 text-center text-slate-400 text-sm">
            <p>
              &copy; 2026 PilotRecognition - Benjamin Bowler (pending Aviation Pathways Ltd). All
              rights reserved.
            </p>
          </div>
        </div>
