    ...
    const aboutSections = [
        {
            ...
            content: [
                ...
                {
                    title: "Evaluation",
                    description: "An evaluation based on an Airbus EBT-aligned evaluation of your pilot development and initial pilot recognition portfolio, along with a certificate of achievement. Once received initial pilot recognition, you may access pathways and compare your recognition credentials within our network consisting of jobs from pilotcareercenter.com, betterjobs.com and many more, along with direct relations with airlines expectations to review their requirements and access various pathways such as cadet programmes, cargo pathways, licensure & type rating pathways, specialized pathways and more!"
                }
            ]
        },
        {
            ...
            content: [
                ...
                },
                {
                    ...
                    description: "PilotRecognition connects operators directly to pilots through our pathway matching system. Operators can access candidates who have completed the <strong>Foundational Program</strong> with 50 hours of verifiable mentorship and are ready for the <strong>Airbus EBT CBTA aligned Transition Program</strong>. Our network includes direct relations with airline expectations, enabling operators to review requirements and access pathways such as <strong>cadet programmes</strong>, cargo pathways, licensure & type rating pathways, and specialized pathways. Future integration of <strong>HINFACT EBT CBTA Software</strong> will provide even more sophisticated competency assessment tools."
                },
                {
