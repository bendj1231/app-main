...
export const EBTCBTAPage: React.FC<EBTCBTAPageProps> = ({ onBack, onNavigate, onLogin }) => {
    const coreElements = [
        {
            ...
            desc: "Evaluation based on real-world data and operational risks rather than repetitive mechanical maneuvers.",
            icon: Plane,
            bullets: ["Data-Driven Training", "Risk Mitigation", "Operational Context"]
        },
        {
            title: "CBTA Framework",
            desc: "Assessment of 9 core competencies including decision-making, SA, and workload management.",
            icon: Brain,
            bullets: ["Competency Based", "Holistic Grading", "Behavioral Markers"]
        },
        {
            title: "Airbus Integration",
            desc: "Direct alignment with the training methodologies used by the Head of EBT/CBTA at Airbus.",
            icon: Cpu => <div className="w-14 h-14 bg-blue-50 rounded-2xl flex items-center justify-center mb-8 group-hover:bg-blue-600 group-hover:scale-110 transition-all text-blue-600 group-hover:text-white"><Plane className="w-7 h-7" /></div>,
            bullets: ["A320/A350 SOPs", "Manufacturer Standards", "Global Best Practice"]
        },
        {
            title: "Etihad Standards",
            desc: "Insights into the competency expectations of one of the world's premier cadet programs.",
            icon: Shield,
            bullets: ["Carrier Specifc", "High Performance", "Recruitment Edge"]
        }
    ];
    ...
    return (
        <div className="min-h-screen bg-white text-slate-900 font-sans text-left">
                ...
                <div className="max-w-6xl mx-auto text-center relative z-20">
                    <RevealOnScroll>
                        ...
                        <p className="max-w-3xl mx-auto text-lg md:text-xl text-slate-600 leading-relaxed font-sans">
                            ...
                            to the competency-based performance required by flagship carriers.
                        </p>
                    </RevealOnScroll>
                </div>
            </div>
            ...
            <div className="py-24 px-6 bg-[#050A30] text-white">
                <div className="max-w-7xl mx-auto">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                        <div>
                            <RevealOnScroll>
                                <p className="text-xs font-bold tracking-[0.4em] uppercase text-blue-400 mb-6">Mental Transition</p>
                                <h2 className="text-3xl md:text-5xl font-serif mb-8 leading-tight">
                                    From Cessnas to <br />Airlines: The Shift
                                </h2>
                                ...
                                <p className="text-base text-slate-400 leading-relaxed mb-8 font-sans">
                                    ...
                                    how you manage the flight deck. Through our collaboration with Airbus and Etihad museum,
                                ...
                                <div className="p-8 bg-white/5 border border-white/10 rounded-3xl">
                                    ...
                                    <p className="text-sm text-slate-400 leading-relaxed font-sans">
                                        Know what the Head of Cadet Training at Etihad museum actually evaluates during a sim check—before you ever apply.
                                    </p>
                                </div>
                            </RevealOnScroll>
                        </div>
                        <div className="relative">
                            <div className="aspect-square bg-slate-100 rounded-[3rem] overflow-hidden shadow-2xl relative">
                                <img
                                    src="https://images.unsplash.com/photo-1540339832862-4745a9805ad3?"
                                    srcSet="https://lh3.googleusercontent.com/d/1waom5qY_plA5lA_gWvhlQOx0A8_YcPpg"
            ...
            <div className="py-24 px-6 max-w-7xl mx-auto">
                <h2 className="text-3xl font-serif text-slate-900 mb-16 text-center">Foundational Competency Pipeline</h2>
