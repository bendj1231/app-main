    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          ...
          description:
            'Assessment aligned to the 9 core competencies: Situational Awareness, Decision Making, Communication, Leadership & Teamwork, Workload Management, Application of Procedures, Flight Path Management, Knowledge, and Automation Management. This demonstrates your readiness alignment for airline operations.',
        },
        {
          title: 'EBT CBTA Video Assessment',
          description:
            'EBT/CBTA-aligned competency video assessment. This produces formal assessment evidence that enhances credibility with operators.',
        },
        {
          title: 'ATLAS Aviation CV Formatting',
          description:
            'Your profile is formatted according to ATLAS Aviation CV standards, the globally recognized ATS (Applicant Tracking System) format used by airlines and operators worldwide. This ensures your profile meets industry recruitment standards.',
        },
        {
          title: 'EBT Video Assessment',
          description:
            'Recorded interview after 50-hour mentorship with behavioral markers and cognitive indicators evaluation. Operators can view your interview to assess communication skills, professional demeanor, and presentation style alongside your competency score.',
        },
        {
          title: 'Internship & Competency Verification',
          description:
            'Complete an internship with our pathway providers (airlines, operators, manufacturers, ATOs) along with PilotRecognition.com to demonstrate your competencies in real-world scenarios. Receive competency evidence packaging that supports your professional readiness with operators and enhances pathway matching.',
        },
      ],
    },
    {
      ...
      content: [
        {
          ...
          description:
            'PilotRecognition provides <strong>data-driven assessment</strong> of pilot readiness. We evaluate specific competencies that operators assess, provide measurable feedback on gaps, and offer targeted alignment pathways. Our approach is based on operator standards and industry requirements, not motivational messaging.',
        },
        {
          title: 'Direct Communication',
          description:
            'Program inquiries: <strong>contact@pilotrecognition.com</strong>. Leadership contact: <strong>contact@pilotrecognition.com</strong>. We provide direct access to program staff for questions about program structure, assessment criteria, and industry alignment.',
        },
        {
          title: 'Career Trajectory Analysis',
          description:
            'Each pilot receives an <strong>objective assessment</strong> of current professional standing and realistic career timeline based on industry data. We identify specific alignment gaps, provide recommendations, and align readiness with operator requirements and market realities.',
        },
      ],
    },
  ];
  ...
  const pilotRecognitionContent = [
    {
      ...
      description:
        'Choose the tier that fits your career goals. <strong>Free Tier:</strong> Platform access, basic competency matching (shows 2 gaps), 3 pathways per month. <strong>Recognition Plus ($99/year):</strong> Full competency comparison, unlimited pathway views, priority matching. Program participants get same priority as paid members (competency-based recognition).',
    },
    {
  ...
  return (
    <div className="min-h-screen bg-white text-slate-900 font-sans">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-12">
            <div className="flex items-center justify-center gap-3 mb-4">
              ...
              <h1 className="text-4xl md:text-5xl font-serif text-slate-900">Technical Index</h1>
            </div>
            <p className="text-lg text-slate-600 max-w-2xl mx-auto">
              Detailed program specifications, technical documentation, and operational details for
              pilots, operators, and partners.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="py-8 px-6 bg-slate-900 text-white">
        <div className="max-w-6xl mx-auto text-center">
          <p className="text-lg font-medium">
            The Foundational Program gives you the knowledge. Now see how that knowledge becomes
            verified recognition that operators trust.
          </p>
        </div>
      </div>
      ...
      <div className="py-8 px-6 bg-blue-900 text-white">
        <div className="max-w-6xl mx-auto text-center">
          <p className="text-lg font-medium">
            Operators need verified data. Your PilotRecognition Profile provides exactly that —
            every hour logged, every competency measured, every achievement verified.
          </p>
        </div>
      </div>
      ...
      <div className="py-12 px-6 max-w-6xl mx-auto space-y-16">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <h2 className="text-2xl md:text-3xl font-serif text-slate-900 mb-8">Pathways</h2>
          <div className="text-left space-y-8">
      ...
      <div className="py-8 px-6 bg-slate-900 text-white">
        <div className="max-w-6xl mx-auto text-center">
          <p className="text-lg font-medium">
            Your recognition score is your currency. Pathways are where you spend it. We bridge the
            gap between training investment and career opportunity.
          </p>
        </div>
      </div>
      ...
      <div className="py-12 px-6 max-w-6xl mx-auto space-y-16">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <h2 className="text-2xl md:text-3xl font-serif text-slate-900 mb-8">Pilot Terminal</h2>
          <div className="text-left space-y-8">
      ...
      <div className="py-12 px-6 max-w-6xl mx-auto space-y-16">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <h2 className="text-2xl md:text-3xl font-serif text-slate-900 mb-8">
            Data Architecture & Privacy Boundaries
          </h2>
          <div className="text-left space-y-8">
            <div className="space-y-2">
              <h3 className="text-lg font-bold text-slate-900">What PilotRecognition Stores</h3>
              <p className="text-base text-slate-700 leading-relaxed">
                PilotRecognition acts as a <strong>technical gateway and intermediary</strong>, not
                a traditional data controller. The platform stores only: platform preferences
                (pathway bookmarks, settings), voluntary display names and optional bios,
                verification ticket stubs (binary status: verified/pending/expired, check ID,
                timestamp — no health data), and subscription metadata (tier, expiry, transaction
                ID). We do not store your email, phone number, or password — these are held and
                encrypted by Auth0.
              </p>
            </div>
            <div className="space-y-2">
              ...
              <p className="text-base text-slate-700 leading-relaxed">
                Raw passport scans, medical certificates, and license scans are processed
                exclusively by <strong>Veremark Ltd.</strong> — they never touch our servers. Flight
                hours and logbook entries are held by your chosen <strong>Logbook Provider</strong>.
                Payment card numbers and bank details are processed by <strong>Stripe</strong>.
                Identity passwords, 2FA secrets, and session tokens are managed by{' '}
                <strong>Auth0</strong>.
              </p>
            </div>
            <div className="space-y-2">
              ...
              <p className="text-base text-slate-700 leading-relaxed">
                Aviation Pathways Ltd has applied for registration as a Data Controller with the
                Data Protection Office, Republic of Mauritius. Benjamin Bowler (Non-Executive
                Director, Sole Shareholder) serves as the registered contact person. An independent
                Data Protection Officer under GDPR Article 37 will be appointed prior to processing
                EU data subjects at scale.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="bg-slate-900 text-white py-12 px-6">
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div>
              ...
              <p className="text-slate-400 text-sm">
                Aviation Pathways Ltd — Managing Director: Marie Maureen Synthia Maya
              </p>
            </div>
            <div>
          ...
          <div className="border-t border-slate-800 pt-8 text-center text-slate-400 text-sm">
            <p>
              &copy; 2026 PilotRecognition — operated by Benjamin Bowler as Non-Executive Director /
              Sole Shareholder pending incorporation of Aviation Pathways Ltd (Managing Director:
              Marie Maureen Synthia Maya). All rights reserved.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-slate-700 leading-relaxed mb-3">
              PilotRecognition programs align with Evidence-Based Training and Competency-Based
              Training and Assessment frameworks, which are international standards in pilot
              training worldwide. Our curriculum incorporates the{' '}
              <strong>9 core competencies</strong> framework used by modern airlines.
            </p>
            <div className="bg-white rounded-lg p-4 border border-blue-100">
              <p className="text-sm text-slate-600 mb-1">
                <strong>Framework:</strong> EBT CBTA (International Standard)
              </p>
              <p className="text-sm text-slate-600 mb-1">
                <strong>Core Competencies:</strong> 9 Competency Areas
              </p>
              <p className="text-sm text-slate-600">
                <strong>Verification Contact:</strong> contact@pilotrecognition.com
              </p>
            </div>
          </div>
        </div>
