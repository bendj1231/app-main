    ...
    return (
      <div style={{ minHeight: '100vh', background: '#0f172a', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 24 }}>
        <div style={{ textAlign: 'center', maxWidth: 420 }}>
          ...
          <p style={{ fontSize: 10, fontWeight: 700, color: '#dc2626', letterSpacing: '0.2em', textTransform: 'uppercase', marginBottom: 8 }}>PilotRecognition Wallet</p>
          <h1 style={{ fontSize: 22, fontWeight: 900, color: 'white', marginBottom: 12, letterSpacing: '-0.02em' }}>No Credential Token</h1>
          <p style={{ fontSize: 13, color: 'rgba(255,255,255,0.4)', lineHeight: 1.6, marginBottom: 28 }}>
            Visit this page with a pilot token in the URL.<br/>
            e.g. <span style={{ fontFamily: 'monospace', color: '#94a3b8' }}>wallet.pilotrecognition.com/0xABC123</span>
          </p>
          <a
