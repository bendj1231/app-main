            ...
            <div className="pt-32 pb-16 px-6">
                <div className="max-w-6xl mx-auto text-center relative z-20">
                    ...
                    <p className="max-w-3xl mx-auto text-base md:text-lg text-slate-700 leading-relaxed">
                        The "Pilot Gap" refers to the treacherous period in an aviator's career between obtaining initial commercial licenses (around 250 hours) and achieving the experience levels required for major airline employment (often 1500+ hours). Through our partnership with <strong>Airbus Head of Training</strong> in EBT CBTA and <strong>Etihad Cadet Program</strong>, we ensure that our programs align with the exacting standards required to bridge this critical career transition.
                    </p>
                </div>
            </div>
