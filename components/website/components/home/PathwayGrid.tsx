...
const getViewCards = (isLoggedIn: boolean, isEnrolledInFoundation: boolean = false) => ({
    home: [
        ...
        },
        {
            ...
            loggedInImages: ['/images/w1000.png', '/images/airlinesexpectations.png', '/images/atlascv.png'],
            loggedInImage: '/images/w1000.png',
            enrolledImage: '/images/w1000.png',
            enrolledImages: ['/images/w1000.png', '/images/airlinesexpectations.png', '/images/atlascv.png'],
