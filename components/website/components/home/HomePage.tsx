        ...
        <div className="rounded-2xl p-4 md:p-6 border border-slate-200">
          <div className="mb-4 pb-3 border-b border-slate-200">
            ...
            <p className="text-[10px] text-slate-500 uppercase tracking-widest">
              Building Your Aviation Foundation
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mb-4">
            <div className="rounded-xl p-3 border border-slate-200">
              ...
              <p className="text-xs text-slate-600 leading-relaxed mb-2">
                Comprehensive mentorship program combining{' '}
                <strong>20 hours of structured supervision</strong> with{' '}
                <strong>30 hours of official mentorship</strong> from industry veterans.
              </p>
              <ul className="text-[9px] text-slate-500 space-y-1">
                <li className="flex items-start gap-2">
                  <span className="text-blue-600 mt-0.5">-</span> Certificate of Accomplishment
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-blue-600 mt-0.5">-</span> Official mentorship documentation
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-blue-600 mt-0.5">-</span> EBT/CBTA competency baseline
                </li>
              </ul>
            </div>
            ...
            <div className="rounded-xl p-3 border border-slate-200">
              ...
              <p className="text-xs text-slate-600 leading-relaxed mb-2">
                Next-generation avionics suite inspired by the G1000 system. Full simulator room
                access for comprehensive flight training scenarios.
              </p>
              <ul className="text-[9px] text-slate-500 space-y-1">
                <li className="flex items-start gap-2">
                  <span className="text-blue-600 mt-0.5">-</span> IFR simulation environments
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-blue-600 mt-0.5">-</span> VFR practice scenarios
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-blue-600 mt-0.5">-</span> Checkride preparation modules
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-blue-600 mt-0.5">-</span> EBT CBTA Airbus-aligned training
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="bg-white/20 backdrop-blur-sm rounded-xl p-3 border border-slate-200 mb-3">
            ...
            <p className="text-xs text-slate-600 leading-relaxed mb-2">
              Advanced examination platform featuring FAA and CAAP practice tests with real-time
          ...
          <div className="rounded-xl p-3 border border-slate-200">
            <h4 className="font-bold text-slate-900 mb-2 text-xs">
              Portfolio Development & Airline Oversight
            </h4>
            <p className="text-xs text-slate-600 leading-relaxed">
              All program data is systematically collected into your professional portfolio with{' '}
              <strong>Airbus representative oversight</strong>. This creates your official Pilot
              Recognition Profile — a verified credential recognized across the aviation industry.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-4">
        <div className="rounded-2xl p-4 md:p-6 border border-slate-200">
          <div className="mb-4 pb-3 border-b border-slate-200">
            ...
            <p className="text-[10px] text-slate-500 uppercase tracking-widest">
              Your Professional Aviation Identity
            </p>
          </div>

          <div className="rounded-xl p-4 border border-slate-200 mb-4">
            <p className="text-xs text-slate-700 leading-relaxed mb-3">
              The PRP is a <strong>comprehensive, living document</strong> that evolves with your
              aviation career. It presents a complete picture of who you are as a pilot — verified,
              standardized, and ready for airline recruitment systems.
            </p>
          ...
          <div className="rounded-xl p-4 border border-slate-200 mb-4">
            ...
            <p className="text-xs text-slate-600 leading-relaxed mb-2">
              PilotRecognition follows EASA, FAA, and ICAO standards for pilot competency
              verification.
            </p>
            <div className="flex flex-wrap gap-2">
              <span className="px-3 py-1 bg-white/20 rounded-full text-[9px] font-medium text-slate-600 border border-slate-200">
                EASA Compliant
              </span>
              <span className="px-3 py-1 bg-white/20 rounded-full text-[9px] font-medium text-slate-600 border border-slate-200">
                FAA Aligned
          ...
          <div className="bg-slate-100/30 backdrop-blur-sm rounded-xl p-4 border border-slate-200">
            ...
            <p className="text-xs text-slate-600 leading-relaxed mb-2">
              Your PRP automatically generates an <strong>ATS compatible</strong> CV using the
              industry-standard Atlas format.
            </p>
            <div className="flex flex-wrap gap-2">
              <span className="px-3 py-1 bg-white/20 rounded-full text-[9px] font-medium text-slate-600 border border-slate-200">
                Airline-Ready Formatting
              </span>
              <span className="px-3 py-1 bg-white/20 rounded-full text-[9px] font-medium text-slate-600 border border-slate-200">
                Keyword Optimized
              </span>
        ...
        <div className="rounded-2xl p-4 md:p-6 border border-slate-200">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mb-4">
            <div className="bg-white/20 backdrop-blur-sm rounded-xl p-4 border border-slate-200">
              <h4 className="font-bold text-slate-900 mb-2 text-xs">
                Smart Pathway Matching System
              </h4>
              <p className="text-xs text-slate-600 leading-relaxed mb-2">
                Our matching engine continuously scans the job market and cross-references
                opportunities with your Pilot Recognition Profile.
              </p>
              <div className="bg-slate-50/20 rounded-lg p-2 border border-slate-100">
                <p className="text-[9px] text-slate-600">
                  <strong>Example:</strong> Your PRP shows 800 hrs, CPL, and IFR rating. The system
                  identifies you as a match for Air Taxi positions.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white/20 backdrop-blur-sm rounded-xl p-4 border border-slate-200">
              ...
              <ul className="text-[10px] text-slate-600 space-y-1">
                <li className="flex items-start gap-1">
                  ...
                  <span>
                    <strong>Hours Analysis:</strong> Compares your logged time against pathway
                    requirements
                  </span>
                </li>
                <li className="flex items-start gap-1">
                  ...
                  <span>
                    <strong>Skills Gap:</strong> Identifies missing ratings or type certifications
                  </span>
                </li>
                <li className="flex items-start gap-1">
                  <span className="text-blue-600 font-bold">3.</span>
                  <span>
                    <strong>Recommendations:</strong> Suggests specific training modules
                  </span>
                </li>
              </ul>
            </div>
...
const newsroomHighlights = [
  {
    ...
    description:
      'CEO & Founder Benjamin Bowler breaks down how to align your profile with Airbus EBT standards. It is not about flight hours alone — airlines want cognitive skills, behavioral markers, and constructivist thinking that static CVs never capture.',
    image:
      'https://res.cloudinary.com/dridtecu6/image/upload/v1777590630/newsroom/kvos2ityyztesx5idue2.png',
    metrics: [
  ...
  },
  {
    ...
    description:
      'Stop sending static CVs into black holes. Airlines and operators post live pathway requirements with exact competency gaps. Your Recognition Profile auto-matches against them — you see your missing pieces before you apply, and operators pull verified pilots directly from the database.',
    image:
      'https://res.cloudinary.com/dridtecu6/image/upload/v1777590647/newsroom/tws5xzryqjepzxoyc94d.png',
    metrics: [
  ...
  },
  {
    ...
    description:
      'Start with 50 hours of verified mentorship, EBT CBTA-aligned competency assessment, and industry-recognized CV formatting. Build your Recognition Score from day one — the currency that gets you pulled by operators instead of begging for interviews.',
    image:
      'https://res.cloudinary.com/dridtecu6/image/upload/v1777590658/newsroom/b81ubzdpz0dmyqutiyqj.png',
    metrics: [
  ...
  },
  {
    ...
    description:
      'Airbus announces new integration with PilotRecognition platform for EBT CBTA standards verification. Airlines can now directly access verified pilot competency data aligned with Airbus HINFACT requirements.',
    image:
      'https://res.cloudinary.com/dridtecu6/image/upload/v1777590658/newsroom/b81ubzdpz0dmyqutiyqj.png',
    metrics: [
  ...
  },
  {
    ...
    description:
      'Leading airlines including Emirates, Qatar Airways, and Etihad have joined the PilotRecognition platform to directly recruit verified pilots through the pull system. No more applications — operators pull based on verified competencies.',
    image:
      'https://res.cloudinary.com/dridtecu6/image/upload/v1777590647/newsroom/tws5xzryqjepzxoyc94d.png',
    metrics: [
...
export const HomePage: React.FC<HomePageProps> = ({
  ...
  const [activeProductTab, setActiveProductTab] = useState<'programs' | 'pathways' | 'profile'>(
    'pathways'
  );
      ...
      <div className="relative font-sans bg-black overflow-x-hidden flex flex-col min-h-screen pt-16">
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="mb-8 text-center">
              <h2 className="text-2xl md:text-3xl font-bold text-slate-900 mb-2">
                Discover <span className="text-red-500">Pilot Recognition</span>
              </h2>
              <p className="text-slate-600 text-sm md:text-base">
                Your live profile that operators pull from — not a résumé you send into a black hole
              </p>
            </div>
            {/* Feature Highlights */}
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
              <div className="bg-slate-900 rounded-2xl p-6 border border-slate-700">
                ...
                >
                  Your Readiness Currency
                </h4>
                <p className="text-sm text-slate-300 leading-relaxed">
                  A single number that measures your profile against industry standards. Airlines
                  filter and sort by this score. It updates live as you gain hours, complete
                  programs, and earn endorsements. No more guessing if you qualify.
                </p>
              </div>
              <div className="bg-slate-900 rounded-2xl p-6 border border-slate-700">
                <p className="text-[10px] font-bold tracking-[0.2em] uppercase text-blue-400 mb-3">
                ...
                <h4
                  ...
                  style={{ fontFamily: 'Georgia, serif', fontWeight: 'normal' }}
                >
                  See Exactly What You Are Missing
                </h4>
                <p className="text-sm text-slate-300 leading-relaxed">
                  Compare your profile against any airline pathway card. Instantly see which
                  requirements you meet, which you are close to, and which need work. Target your
                  training spend instead of wasting money on irrelevant ratings.
                </p>
              </div>
              <div className="bg-slate-900 rounded-2xl p-6 border border-slate-700">
                <p className="text-[10px] font-bold tracking-[0.2em] uppercase text-blue-400 mb-3">
                ...
                <h4
                  ...
                  style={{ fontFamily: 'Georgia, serif', fontWeight: 'normal' }}
                >
                  Airlines Come to You
                </h4>
                <p className="text-sm text-slate-300 leading-relaxed">
                  Operators with enterprise access pull directly from the verified database. Your
                  live profile is visible to recruiters with the right permissions. No applications.
                  No cover letters. Just verified data speaking for itself.
                </p>
              </div>
            </div>
            {/* Tier Comparison */}
            <div className="bg-slate-900 rounded-2xl border border-slate-700 overflow-hidden mb-8">
              <div className="p-6 border-b border-white/10">
                ...
                <p className="text-sm text-slate-400">
                  Start free. Upgrade when you are ready to unlock full pathway matching.
                </p>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-0">
                <div className="p-6 border-b md:border-b-0 md:border-r border-white/10">
                  ...
                  <ul className="space-y-2 text-sm text-slate-300">
                    <li className="flex items-start gap-2">
                      <span className="text-blue-400 mt-1">•</span>Basic profile matching (shows 2
                      gaps)
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-blue-400 mt-1">•</span>3 pathway views per month
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-blue-400 mt-1">•</span>Public pathway browsing
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-blue-400 mt-1">•</span>Standard ATLAS CV format
                    </li>
                  </ul>
                </div>
                <div className="p-6">
                  ...
                  <ul className="space-y-2 text-sm text-slate-300">
                    <li className="flex items-start gap-2">
                      <span className="text-red-400 mt-1">•</span>Full profile comparison against
                      all pathways
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-red-400 mt-1">•</span>Unlimited pathway views and
                      matching
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-red-400 mt-1">•</span>Priority operator pull visibility
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-red-400 mt-1">•</span>Advanced analytics and
                      benchmarking
                    </li>
                  </ul>
                </div>
        ...
        <div className="relative z-10 bg-white">
          <div className="relative z-30 w-full px-3 sm:px-4 md:px-8 lg:px-12 xl:px-16 pb-6 sm:pb-8 pt-8 sm:pt-10 md:pt-12">
            <div className="max-w-7xl mx-auto">
              ...
              <div className="mb-6 text-center">
                <h2 className="text-2xl md:text-3xl font-bold text-slate-900 mb-2">
                  Discover <span className="text-red-500">Connected Platforms</span>
                </h2>
                <p className="text-slate-600 text-sm md:text-base">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-4 max-w-6xl mx-auto pb-8">
                ...
                >
                  ...
                  <div className="relative z-10 flex flex-col h-full">
                    ...
                    <div className="mt-auto bg-black/90 px-4 py-4">
                      <h4 className="text-white font-semibold text-sm uppercase tracking-wider">
                        pilot <span className="text-red-500">pathways</span>
                      </h4>
                      <p className="text-slate-400 text-xs mt-1">
          ...
          <div className="relative z-30 w-full px-3 sm:px-4 md:px-8 py-2 md:py-3">
            <div className="max-w-7xl mx-auto">
              <div
                className="relative overflow-hidden rounded-xl bg-gradient-to-r from-blue-600 via-blue-700 to-slate-800 shadow-lg"
                style={{ minHeight: 'clamp(100px, 18vw, 140px)' }}
              >
                ...
                {(() => {
                  ...
                  return (
                    <div
                      className="absolute inset-y-0 right-0 w-2/5 z-0 hidden md:block"
                      style={{ backgroundColor: isWhiteBg ? '#ffffff' : 'rgba(10,20,60,0.7)' }}
                    >
                      {!slide.prLogo ? (
                        <img
                          key={slide.src}
                      ...
                      {!isWhiteBg && (
                        <div
                          ...
                          style={{
                            background:
                              'linear-gradient(to right, #2563eb 0%, rgba(37,99,235,0.85) 20%, rgba(37,99,235,0.2) 65%, transparent 100%)',
                          }}
                        />
                      )}
                    </div>
                ...
                <div className="relative z-10">
                  <div
                    ...
                    style={{ transform: `translateX(-${(activeBillboardSlide || 0) * 100}%)` }}
                  >
                    ...
                    <div className="w-full flex-shrink-0">
                      <div className="px-4 sm:px-5 md:px-8 py-3 sm:py-4 md:py-5 w-full md:w-3/5">
                        ...
                        <p className="text-xs text-blue-100 max-w-md mb-2 sm:mb-3 hidden sm:block">
                          EASA updated minimum hours for A320 type rating entry. Pathway cards have
                          been recalculated. Check your gap score now.
                        </p>
                        <button
                          onClick={() => onNavigate?.('pathways-modern')}
                          className="px-3 py-1.5 bg-white/10 hover:bg-white/20 border border-white/30 text-white text-xs font-semibold rounded-lg transition-colors"
                        >
                    ...
                    <div className="w-full flex-shrink-0">
                      <div className="px-4 sm:px-5 md:px-8 py-3 sm:py-4 md:py-5 w-full md:w-3/5">
                        ...
                        <p className="text-xs text-blue-100 max-w-md mb-2 sm:mb-3 hidden sm:block">
                          FAA &amp; EASA revised simulator hour requirements for B737 type rating.
                          Updated pathway cards now reflect the new minimums.
                        </p>
                        <button
                          onClick={() => onNavigate?.('pathways-modern')}
                          className="px-3 py-1.5 bg-white/10 hover:bg-white/20 border border-white/30 text-white text-xs font-semibold rounded-lg transition-colors"
                    ...
                    <div className="w-full flex-shrink-0">
                      <div className="px-4 sm:px-5 md:px-8 py-3 sm:py-4 md:py-5 w-full md:w-3/5">
                        ...
                        <p className="text-xs text-blue-100 max-w-md mb-2 sm:mb-3 hidden sm:block">
                          Etihad's full expectation profile has been added — minimum hours, license
                          requirements, and EBT standards. Match your profile today.
                        </p>
                        <button
                    ...
                    <div className="w-full flex-shrink-0">
                      <div className="px-4 sm:px-5 md:px-8 py-3 sm:py-4 md:py-5 w-full md:w-3/5">
                        ...
                        <p className="text-xs text-blue-100 max-w-md mb-2 sm:mb-3 hidden sm:block">
                          50+ hours of structured mentorship. Foundational knowledge, leadership,
                          and behavioural frameworks. Limited spots available.
                        </p>
                        <button
                          onClick={() => onNavigate?.('foundation-program')}
                          className="px-3 py-1.5 bg-white text-blue-700 hover:bg-blue-50 text-xs font-semibold rounded-lg transition-colors shadow"
                        >
                          Enroll Now
                        </button>
                      </div>
                    ...
                    <div className="w-full flex-shrink-0">
                      <div className="px-4 sm:px-5 md:px-8 py-3 sm:py-4 md:py-5 w-full md:w-3/5">
                        ...
                        <p className="text-xs text-blue-100 max-w-md mb-2 sm:mb-3 hidden sm:block">
                          Cargo, charter, and cadet pathways updated with live airline data. Your
                          recognition score unlocks which pathways you can access.
                        </p>
                        <button
                          onClick={() => onNavigate?.('pathways-modern')}
                          className="px-3 py-1.5 bg-white/10 hover:bg-white/20 border border-white/30 text-white text-xs font-semibold rounded-lg transition-colors"
                    ...
                    <div className="flex gap-2">
                      {[0, 1, 2, 3, 4].map((index) => (
                        <button
                          ...
                          style={{
                            width: (activeBillboardSlide || 0) === index ? '32px' : '16px',
                            backgroundColor:
                              (activeBillboardSlide || 0) === index
                                ? 'white'
                    ...
                    <div className="space-y-3 mb-6">
                      <div className="flex items-center gap-3">
                        ...
                        <span className="text-sm text-slate-600">
                          Certificate of Completion with industry endorsement
                        </span>
                      </div>
                      <div className="flex items-center gap-3">
                        <div className="w-2 h-2 rounded-full bg-blue-500 flex-shrink-0" />
                        <span className="text-sm text-slate-600">
                          Recognition Score boost upon verified completion
                        </span>
                      </div>
                      <div className="flex items-center gap-3">
                        <div className="w-2 h-2 rounded-full bg-blue-500 flex-shrink-0" />
                        <span className="text-sm text-slate-600">
                          Direct pathway access to airline placements
                        </span>
                      </div>
                    </div>
              ...
              <div className="absolute inset-0 z-0">
                {graphicsConfig?.enableMeshGradient ? (
                  ...
                  <div
                    className="w-full h-full"
                    style={{
                      background: 'linear-gradient(160deg, #020617 0%, #0d1f3c 50%, #020617 100%)',
                    }}
                  />
                )}
              </div>
              ...
              {activeProductTab === 'pathways' && (
                <div className="relative z-10">
                  ...
                  <div className="mb-8 text-center pt-16">
                    <p className="text-xs font-bold tracking-[0.3em] uppercase text-sky-400 mb-3">
                      Discover <span className="text-red-500">Pathways</span>
                    </p>
                  ...
                  <div className="mb-4 w-full px-4 text-left">
                    <h2
                      className="text-3xl md:text-4xl font-normal text-slate-900"
                  ...
                  <div className="relative w-full mb-6">
                    ...
                    >
                      ...
                      {HOME_PATHWAYS.filter((pathway) => {
                        ...
                        const matchesCategory =
                          activeCarouselCategory === 'All' ||
                          pathway.category === activeCarouselCategory;
                        return matchesMatch && matchesCategory;
                      }).map((pathway) => (
                        <div
                          key={pathway.id}
                          ...
                          <div className="relative h-[300px] overflow-hidden rounded-xl bg-slate-800">
                            ...
                            <div className="absolute bottom-0 left-0 right-0 p-4 text-center">
                              ...
                              <p className="text-white/80 text-sm">
                                {pathway.company} · {pathway.location}
                              </p>
                            </div>
                          </div>
                        </div>
                  ...
                  {selectedCarouselPathway && (
                    <div
                      data-selected-pathway="true"
                      className="flex items-center justify-center gap-4 mt-4 mb-8"
                    >
                      <button
                        onClick={() =>
                          pathwaysCarouselRef.current?.scrollBy({ left: -616, behavior: 'smooth' })
                        }
                ...
                <div className="relative z-10 mb-16">
                  ...
                  <div className="mb-8">
                    <div className="max-w-6xl mx-auto px-4 mb-6">
                      ...
                      <p className="text-sm text-slate-400">
                        Cadet programs, career pathways, and specialized operations from the
                        ...
                        {[...HOME_PATHWAYS, ...HOME_PATHWAYS].map((pathway, idx) => (
                          ...
                          >
                            ...
                            <div className="p-3 sm:p-4">
                              <p className="text-[9px] sm:text-[10px] font-bold tracking-[0.15em] sm:tracking-[0.2em] uppercase text-blue-400 mb-1 sm:mb-2">
                                {pathway.category}
                              </p>
                              ...
                              <h4 className="text-sm sm:text-lg text-white font-medium mb-1 leading-tight">
                                {pathway.title}
                              </h4>
                              ...
                              <div className="flex flex-wrap gap-1">
                                {pathway.tags.slice(0, 2).map((tag, tidx) => (
                                  <span
                                    key={tidx}
                                    className="px-1.5 sm:px-2 py-0.5 bg-white/10 rounded text-[9px] sm:text-[10px] text-slate-300"
                                  >
                                    {tag}
                                  </span>
                                ))}
              ...
              {activeProductTab === 'profile' && (
                <div className="relative z-10 mb-16">
                  ...
                  <div className="max-w-4xl mx-auto px-4 mb-10 text-center">
                    <p className="text-[10px] font-bold tracking-[0.3em] uppercase text-blue-400 mb-3">
                    ...
                    <p className="text-sm text-slate-300 leading-relaxed max-w-2xl mx-auto">
                      Airlines don't hire from paper. They pull from live, verified profiles. Your
                      Recognition Profile updates automatically as you log hours, complete
                      assessments, and earn credentials. It is your single source of truth —
                      ATS-readable, shareable via link, and benchmarked against real airline
                      expectations. Stop sending resumes into black holes. Let operators see your
                    ...
                    <div className="bg-white/95 backdrop-blur-sm rounded-xl border border-white/30 shadow-[0_20px_40px_-12px_rgba(0,0,0,0.3)] overflow-hidden">
                      ...
                      <div className="bg-red-600 px-4 py-3 border-b border-red-700">
                        <div className="flex items-center justify-between">
                          <div>
                            <p className="text-[9px] font-bold uppercase tracking-[0.2em] text-red-200 mb-0.5">
                              Pilot Recognition Profile
                            </p>
                            <h4 className="text-sm font-bold text-white">Pete Michelle</h4>
                          </div>
                          <div className="text-right">
                            <p className="text-[9px] font-bold uppercase tracking-[0.2em] text-red-200 mb-1">
                              SHARE LINK
                            </p>
                            <button
                              onClick={() => onNavigate('pilot-recognition-profile')}
                      ...
                      <div className="p-3 sm:p-4">
                        ...
                        <div className="flex items-center gap-4 mb-4 pb-4 border-b border-slate-200">
                          ...
                          <div className="flex-1 min-w-0">
                            <p className="text-xs text-blue-600 font-semibold tracking-[0.18em] mb-1">
                              ATPL (USA) · 8 Ratings
                            </p>
                            <p className="text-[10px] text-slate-500 truncate">
                              pete.michelle@aviation.com
                            </p>
                          </div>
                          <div className="flex flex-col gap-1 items-end flex-shrink-0">
                            <div className="text-right">
                              <p className="text-[9px] tracking-[0.12em] text-slate-500 uppercase mb-0.5">
                                Flight Hours
                              </p>
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-2 mb-4">
                          {[
                            ...
                            <div
                              key={i}
                              className="bg-slate-50/80 rounded-lg p-2 border border-slate-100 text-center"
                            >
                              <p className="text-[9px] text-slate-500 tracking-[0.1em] mb-0.5">
                                {item.label}
                              </p>
          ...
          <div className="relative bg-white pt-24 pb-12 px-6">
            <div className="max-w-6xl mx-auto text-center relative z-20">
              ...
              <div className="max-w-4xl mx-auto space-y-6 mb-12 text-left">
                ...
                <p className="text-slate-700 text-sm md:text-base leading-relaxed font-sans">
                  It is not a job board but a professional networking platform—similar to LinkedIn
                  for the aviation industry. Instead of pilots sending CVs into a void, operators
                  post pathway cards showing exactly what they need: hours, ratings, nationality
                ...
                <p className="text-slate-700 text-sm md:text-base leading-relaxed font-sans">
                  The Foundation Program builds the verified competency record operators look for.
                  It covers 50 hours of logged mentorship, EBT CBTA-aligned industry education, type
          ...
          <footer className="relative z-10 mt-auto bg-slate-900 text-white py-12 px-6">
            <div className="max-w-6xl mx-auto">
              ...
              <div className="border-t border-slate-800 pt-8 text-center text-slate-400 text-sm">
                <p>
                  &copy; 2026 PilotRecognition - Benjamin Bowler (pending Aviation Pathways Ltd).
                  All rights reserved.
                </p>
              </div>
            </div>
