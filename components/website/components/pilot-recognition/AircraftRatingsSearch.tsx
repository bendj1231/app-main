    ...
    <div style={{
      ...
      <div style={{ display: 'flex', gap: '0.75rem', overflowX: 'auto', paddingBottom: '0.5rem', scrollbarWidth: 'thin', scrollbarColor: 'rgba(255,255,255,0.2) transparent' }}>
        {activeFilterTab === 'manufacturer' && filteredManufacturers.map((m) => (
          ...
          >
            <div style={{ height: '90px', background: '#f3f4f6', position: 'relative', overflow: 'hidden', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '12px' }}>
              {m.logo ? (
                <img
                  src={m.logo}
                  alt={m.name}
        ...
        >
          ...
          <div style={{ flex: '0 0 50%', position: 'relative', minHeight: '320px', background: 'rgba(0,0,0,0.15)' }}>
            {!selectedManufacturer ? (
              ...
              <div style={{ width: '100%', height: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', position: 'absolute', inset: 0, gap: '1.5rem', background: '#f3f4f6' }}>
