...
type Manufacturer = DataManufacturer;
...
const _uniqueCategories = Array.from(new Set(aircraftTypeRatings.map((a) => a.category))).sort();
...
const _manufacturersWithAircraft = manufacturers.filter((m) => idsWithAircraft.has(m.id));
...
export const AircraftRatingsSearch: React.FC = () => {
  ...
  const [activeFilterTab, setActiveFilterTab] = useState<'manufacturer' | 'model' | 'class'>(
    'manufacturer'
  );
  const [_confirmedAircrafts, setConfirmedAircrafts] = useState<AircraftTypeRating[]>([]);
  ...
  const availableClasses = useMemo(() => {
    ...
    if (selectedManufacturer)
      filtered = filtered.filter((a) => a.manufacturer_id === selectedManufacturer);
  ...
  const filteredRatings = useMemo(() => {
    return aircraftTypeRatings.filter((aircraft) => {
      const matchesManufacturer =
        !selectedManufacturer || aircraft.manufacturer_id === selectedManufacturer;
  ...
  const _filteredModelOptions = useMemo(() => {
  ...
  const selectedManufacturerData = useMemo(() => {
    return selectedManufacturer
      ? manufacturers.find((m) => m.id === selectedManufacturer) || null
      : null;
  }, [selectedManufacturer]);
    ...
    >
      ...
      {activeFilterTab !== 'model' && (
        <div
          style={{
            display: 'grid',
            gridTemplateColumns: !selectedManufacturer ? '1fr 1fr' : 'repeat(3, 1fr)',
            gap: '0.5rem',
        ...
        >
          ...
          <button
            ...
            onMouseEnter={(e) => {
              if (activeFilterTab !== 'manufacturer')
          ...
          >
            <p
              style={{
                ...
                fontSize: '0.6rem',
                fontWeight: 700,
                color: activeFilterTab === 'manufacturer' ? '#5eead4' : 'rgba(255,255,255,0.55)',
            ...
            >
              {selectedManufacturer
                ? manufacturerById(selectedManufacturer)?.name
                : 'All Manufacturers'}
            </p>
          </button>
            ...
            <div style={{ position: 'relative' }}>
              <select
                ...
                style={{
                  ...
                  height: '100%',
                  padding: '0.65rem 0.75rem',
                  background: manufacturerScopeFilter
              ...
              >
                <option
                  value=""
                  style={{ background: '#0f172a', color: '#ffffff', fontSize: '0.85rem' }}
                >
                  All Sectors
                </option>
              ...
              >
                <p
                  style={{
                    ...
                    fontWeight: 700,
                    color:
                      activeFilterTab === 'class' || selectedClass
                        ? '#5eead4'
              ...
              >
                <p
                  style={{
                    ...
                    fontSize: '0.6rem',
                    fontWeight: 700,
                    color: selectedModel ? '#5eead4' : 'rgba(255,255,255,0.55)',
                    letterSpacing: '0.05em',
                    textTransform: 'uppercase',
                  }}
                >
          ...
          filteredManufacturers.map((m) => (
            ...
            >
              ...
              <div style={{ padding: '0.75rem' }}>
                ...
                >
                  {MANUFACTURER_SCOPE[m.id] || 'Aircraft Manufacturer'}
                </p>
              </div>
          ...
          <>
            <button
              ...
              style={{
                ...
                padding: '0.75rem',
                background:
                  selectedClass === '' ? 'rgba(255,255,255,0.25)' : 'rgba(255,255,255,0.08)',
            ...
            >
              <span
                style={{
                  fontSize: '0.8rem',
                  fontWeight: 700,
                  color: selectedClass === '' ? '#ffffff' : 'rgba(255,255,255,0.85)',
                  textTransform: 'uppercase',
                  letterSpacing: '0.05em',
                }}
              >
            ...
            {filteredClassOptions.map((cls) => (
              <button
                ...
                style={{
                  ...
                  padding: '0.75rem',
                  background:
                    selectedClass === cls ? 'rgba(255,255,255,0.25)' : 'rgba(255,255,255,0.08)',
              ...
              >
                <span
                  style={{
                    fontSize: '0.8rem',
                    fontWeight: 700,
                    color: selectedClass === cls ? '#ffffff' : 'rgba(255,255,255,0.85)',
                    textTransform: 'uppercase',
                    letterSpacing: '0.05em',
                  }}
                >
  ...
  return (
    ...
    >
          ...
          >
            ...
            <div
              style={{
                ...
                inset: 0,
                background:
                  'linear-gradient(to right, transparent 55%, rgba(15, 23, 42, 0.6) 100%)',
                pointerEvents: 'none',
              }}
            />
          </div>
            ...
            >
              {!selectedManufacturer ? (
                <>
                  ...
                  >
                    Select a manufacturer to query your type rating from our database of{' '}
                    <strong style={{ color: '#ffffff' }}>40,000+ aircraft</strong>. Learn the
                    requirements, expectations, and career pathways for every rating.
                  </p>
                  <div
                    style={{
                      display: 'flex',
                  ...
                  >
                    Out-of-the-factory, airline, and professional aircraft photography alongside
                    operating manuals, specifications, and procedural checklists for every aircraft
                    in our library.
                  </p>
                  <a
                ...
                <>
                  ...
                  >
                    ...
                    >
                      {manufacturerById(selectedAircraft.manufacturer_id)?.name ||
                        selectedAircraft.manufacturer_id}
                    </p>
            ...
            >
              {!selectedManufacturer ? (
                ...
                >
                  ...
                  >
                    Select a manufacturer above to explore aircraft type ratings.
                  </p>
                </div>
              ) : showManufacturerPreview && selectedManufacturerData ? (
                <>
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        {selectedManufacturerData.founded}
                      </p>
                    </div>
                    <div
                      style={{
                    ...
                    >
                      ...
                      >
                        {selectedManufacturerData.totalAircraftCount.toLocaleString()}+
                      </p>
                    </div>
                    <div
                      style={{
                  ...
                  >
                    ...
                    >
                      {selectedManufacturerData.headquarters}
                    </p>
                  </div>
                </>
              ) : selectedAircraft ? (
                <>
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        {selectedAircraft.id === 'supernal-sa-1' || selectedAircraft.id === 'b777x'
                          ? '0'
                          : selectedAircraft.id === 'b777-300er'
                            ? '38,000 – 45,000'
                            : selectedAircraft.id === 'b787'
                              ? '48,000 – 55,000'
                              : selectedAircraft.id === 'b767-300er'
                                ? '15,000 – 18,000'
                                : selectedAircraft.id === 'b737-ng'
                                  ? '110,000 – 130,000'
                                  : selectedAircraft.id === 'b757'
                                    ? '14,000 – 17,000'
                                    : selectedAircraft.id === 'b717'
                                      ? '1,200 – 1,500'
                                      : selectedAircraft.id === 'b727'
                                        ? '300 – 500'
                                        : selectedAircraft.id === 'b747-8f'
                                          ? '3,500 – 4,500'
                                          : getPilotCount(selectedAircraft.model).toLocaleString()}
                      </p>
                    </div>
                    <div
                      style={{
                    ...
                    >
                      ...
                      >
                        {getAircraftStatus(selectedAircraft)}
                      </p>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) => {
                        ...
                        setSelectedRatingCenters((prev) => ({
                          ...prev,
                          [selectedAircraft.id]: value,
                        }));
                      }}
                      style={{
                        width: '100%',
                    ...
                    >
                      <option value="" style={{ background: '#0f172a', color: '#ffffff' }}>
                ...
                >
                  ...
                  >
                    Select an aircraft to view type rating specifications.
                  </p>
                </div>
              )}
            </div>
      ...
      <div
        ...
        style={{ position: 'relative', marginBottom: '1rem', zIndex: 40 }}
      >
        {previewedAircraft && !selectedAircraftIds.includes(previewedAircraft.id) ? (
          <button
            onClick={() => {
              setSelectedAircraftIds((prev) =>
                prev.includes(previewedAircraft.id) ? prev : [...prev, previewedAircraft.id]
              );
              setPreviewedAircraftId('');
            }}
            style={{
          ...
          <>
            ...
            <input
              ...
              onKeyDown={(e) => {
                if (e.key === 'Enter' && selectedAircraftIds.length > 0) handleConfirm();
              }}
              placeholder={
                activeFilterTab === 'manufacturer'
                  ? manufacturerScopeFilter
                    ? `${manufacturerScopeFilter} — Search manufacturers...`
              ...
              >
                ...
                <div
                  style={{
                    ...
                    inset: 0,
                    background:
                      'linear-gradient(to bottom, transparent 35%, rgba(15, 23, 42, 0.95) 100%)',
                    pointerEvents: 'none',
                  }}
                />
                <button
              ...
              <div style={{ padding: '1.5rem 2rem' }}>
                ...
                >
                  ...
                  >
                    ...
                    <p
                      style={{ margin: 0, fontSize: '0.95rem', fontWeight: 700, color: '#38bdf8' }}
                    >
                      {selectedManufacturerData.reputationScore}/10
                    </p>
                  </div>
                  <div
                    style={{
                  ...
                  >
                    ...
                    <a
                      href={selectedManufacturerData.website}
                      target="_blank"
                      rel="noopener noreferrer"
                      style={{
                        margin: 0,
                    ...
                    >
                      {selectedManufacturerData.website.replace('https://', '')}
                    </a>
                  </div>
                </div>
                ...
                {selectedManufacturerData.why_choose_rating && (
                  ...
                  >
                    ...
                    >
                      Why Choose {selectedManufacturerData.name}?
                    </h4>
                    <p
                      style={{
                        margin: 0,
            ...
            >
                ...
                >
                  ...
                  >
                    ...
                    >
                      <img
                        src={
                          manufacturerById(selectedAircraft.manufacturer_id)?.logo ||
              ...
              >
                ...
                <div>
                  ...
                  <p style={{ margin: 0, fontSize: '0.85rem', fontWeight: 700, color: '#ffffff' }}>
                    {selectedAircraft.first_flight || 'N/A'}
                  </p>
                </div>
                <div>
                  <p
                  ...
                  <p style={{ margin: 0, fontSize: '0.85rem', fontWeight: 700, color: '#ffffff' }}>
                    {getAircraftAge(selectedAircraft.first_flight) !== null
                      ? getAircraftAge(selectedAircraft.first_flight) + ' years'
                      : 'N/A'}
                  </p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '0.3rem' }}>
                    ...
                    <span style={{ fontSize: '0.85rem', fontWeight: 700, color: '#ffffff' }}>
                      {manufacturerById(selectedAircraft.manufacturer_id)?.reputationScore || 0}
                    </span>
                  </div>
                </div>
                {selectedAircraft.operator_count !== undefined && (
                  <div>
                    ...
                    <p
                      style={{ margin: 0, fontSize: '0.85rem', fontWeight: 700, color: '#ffffff' }}
                    >
                      {selectedAircraft.operator_count.toLocaleString()}+
                    </p>
                  </div>
                )}
              </div>
                  ...
                  {['Overview', 'Training', 'Hiring', 'Compensation', 'Comparison'].map((tab) => (
                    <button
                      ...
                      style={{
                        ...
                        border: 'none',
                        borderBottom:
                          '2px solid ' + (activeModalTab === tab ? '#38bdf8' : 'transparent'),
                  ...
                  <div>
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '2rem' }}>
                        ...
                        {selectedAircraft.training_requirements ? (
                          ...
                          >
                            ...
                            >
                              <CheckCircle2 size={16} style={{ color: '#10b981', flexShrink: 0 }} />
                              Licenses:{' '}
                              {selectedAircraft.training_requirements.required_licenses.join(', ')}
                            </li>
                            <li
                              style={{
                                display: 'flex',
                            ...
                            >
                              <CheckCircle2 size={16} style={{ color: '#10b981', flexShrink: 0 }} />
                              Ground School:{' '}
                              {selectedAircraft.training_requirements.ground_school_hours} hrs
                            </li>
                            <li
                              style={{
                                display: 'flex',
                            ...
                            >
                              <CheckCircle2 size={16} style={{ color: '#10b981', flexShrink: 0 }} />
                              Simulator: {
                                selectedAircraft.training_requirements.simulator_hours
                              }{' '}
                              hrs
                            </li>
                            <li
                      ...
                      <div>
                        ...
                        {selectedAircraft.training_curriculum &&
                        selectedAircraft.training_curriculum.length > 0 ? (
                          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                            {selectedAircraft.training_curriculum.map((item, i) => (
                              ...
                              >
                                <span
                                  style={{ fontSize: '0.8rem', fontWeight: 600, color: '#ffffff' }}
                                >
                                  {item.phase}
                                </span>
                                <span
                        ...
                        {selectedAircraft.simulator_details && (
                          <>
                            ...
                            >
                              ...
                              >
                                {selectedAircraft.simulator_details.features}
                              </p>
                            </div>
                          </>
                        )}
                    ...
                    {selectedAircraft.career_info ? (
                      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '2rem' }}>
                        <div>
                          ...
                          >
                            {selectedAircraft.career_info.job_market}
                          </p>
                          <h4
                            style={{
                              margin: '0 0 0.5rem',
                          ...
                          >
                            {selectedAircraft.career_info.growth_prospects}
                          </p>
                        </div>
                        <div>
                          <h4
                      ...
                      >
                        <p
                          style={{ margin: 0, fontSize: '0.9rem', color: 'rgba(255,255,255,0.65)' }}
                        >
                          Detailed hiring requirements for this aircraft are not yet available.
                          Check with major operators and training centers for current opportunities.
                        </p>
                      </div>
                    )}
                  </div>
                    ...
                    {selectedAircraft.career_info?.average_salary ? (
                        ...
                        >
                          ...
                          <p
                            style={{
                              ...
                              fontWeight: 800,
                              color:
                                selectedAircraft.demandLevel === 'high' ? '#6ee7b7' : '#fcd34d',
                            }}
                          >
                            {selectedAircraft.demandLevel === 'high'
                              ? 'High'
                      ...
                      >
                        <p
                          style={{ margin: 0, fontSize: '0.9rem', color: 'rgba(255,255,255,0.65)' }}
                        >
                          Compensation data is not yet available for this aircraft. Salaries vary by
                          region, operator, and experience level.
                        </p>
                      </div>
                    )}
                  </div>
                ...
                {activeModalTab === 'Comparison' && (
                  <div>
                    ...
                    >
                      ...
                      {selectedAircraft.operator_count !== undefined &&
                        selectedAircraft.pilot_count !== undefined && (
                          <div
                            style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}
                          >
                            <div
                            ...
                            >
                              ...
                              >
                                {selectedAircraft.id === 'supernal-sa-1' ||
                                selectedAircraft.id === 'b777x'
                                  ? '0'
                                  : selectedAircraft.id === 'b777-300er'
                                    ? '38,000 – 45,000'
                                    : selectedAircraft.id === 'b787'
                                          ...
                                          : selectedAircraft.id === 'b757'
                                            ...
                                            : selectedAircraft.id === 'b717'
                                              ...
                                              : selectedAircraft.id === 'b727'
                                                ...
                                                : selectedAircraft.id === 'b747-8f'
                                                  ? '3,500 – 4,500'
                                                  : selectedAircraft.pilot_count.toLocaleString()}
                              </p>
                            </div>
                          </div>
                        )}
              ...
              >
                ...
                <button
                  onClick={() => {
                    setSelectedAircraftIds((prev) =>
                      prev.includes(selectedAircraft.id) ? prev : [...prev, selectedAircraft.id]
                    );
