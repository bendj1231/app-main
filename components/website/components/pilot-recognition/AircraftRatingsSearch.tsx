...
const MANUFACTURER_LOGOS: Record<string, string> = {
  airbus: 'https://ih1.redbubble.net/image.3072472393.7477/bg,f8f8f8-flat,750x,075,f-pad,750x1000,f8f8f8.jpg',
  boeing: 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/4f/Boeing_full_logo.svg/960px-Boeing_full_logo.svg.png',
  atr: '/atr-logo.png',
  ...
  'dassault-falcon': 'https://brandcenter.dassault-aviation.com/assets/contents/img/dassault-brand-center_4.png',
  ...
  beechcraft: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTytkPLeDMSLb2r4ukzys6EUJcg98nCLEU5UKK2UJSZKQ&s=10',
  ...
  cirrus: 'https://www.flyingmag.com/wp-content/uploads/2024/02/cirrus-1.jpeg',
  let: '/let-logo.svg',
              ...
              <div style={{ position: 'absolute', bottom: 0, left: 0, right: 0, padding: '2rem' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', flexWrap: 'wrap' }}>
                  <span style={{ display: 'flex', alignItems: 'center', gap: '0.4rem', color: 'rgba(255,255,255,0.8)', fontSize: '0.9rem', fontWeight: 600 }}>
                    <img src={manufacturerById(selectedAircraft.manufacturer_id)?.logo || '/logo.png'} alt="" style={{ height: '18px', objectFit: 'contain' }} />
                    {manufacturerById(selectedAircraft.manufacturer_id)?.name || selectedAircraft.manufacturer_id}
                  </span>
