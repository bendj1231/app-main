        ...
        <div style={{
          ...
          {showAddForm && (
            <div style={{
              ...
              {logbookFormat === 'dgacindia' && (
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(160px, 1fr))', gap: '1rem' }}>
                  ...
                  <div>
                    ...
                    <input
                      type="text"
                      value={formData.dgacindiaDepartureIcao}
                      onChange={(e) => setFormData({ ...formData, dgacindiaDepartureIcao: e.target.value.toUpperCase() })}
                      placeholder="VABB"
                      style={{
                        width: '100%',
                        padding: '0.5rem',
                  ...
                  <div>
                    ...
                    <input
                      type="text"
                      value={formData.dgacindiaArrivalIcao}
                      onChange={(e) => setFormData({ ...formData, dgacindiaArrivalIcao: e.target.value.toUpperCase() })}
                      placeholder="VIDP"
                      style={{
                        width: '100%',
                        padding: '0.5rem',
                  ...
                  <div>
                    ...
                    <input
                      type="time"
                      value={formData.dgacindiaChocksOff}
                      onChange={(e) => setFormData({ ...formData, dgacindiaChocksOff: e.target.value })}
                      style={{
                        width: '100%',
                        padding: '0.5rem',
                        border: '1px solid #cbd5e1',
                  ...
                  <div>
                    ...
                    <input
                      type="time"
                      value={formData.dgacindiaChocksOn}
                      onChange={(e) => setFormData({ ...formData, dgacindiaChocksOn: e.target.value })}
                      style={{
                        width: '100%',
                        padding: '0.5rem',
                        border: '1px solid #cbd5e1',
                  ...
                  <div>
                    ...
                    <select
                      value={formData.dgacindiaPilotCapacity}
                      onChange={(e) => setFormData({ ...formData, dgacindiaPilotCapacity: e.target.value as any })}
                      style={{
                        width: '100%',
                        padding: '0.5rem',
                        border: '1px solid #cbd5e1',
                    ...
                    >
                      ...
                      <option value="P1">P1 (PIC)</option>
                      <option value="P2">P2 (Co-pilot)</option>
                      <option value="P1 U/S">P1 Under Supervision</option>
                  ...
                  <div>
                    ...
                    <label style={{ display: 'flex', alignItems: 'center', fontSize: '0.75rem', color: '#64748b' }}>
                      <input
                        type="checkbox"
                        checked={formData.dgacindiaDay}
                        onChange={(e) => setFormData({ ...formData, dgacindiaDay: e.target.checked })}
                        style={{ marginRight: '0.25rem' }}
                      />
                      Day flight
                    </label>
                  ...
                  <div>
                    ...
                    <label style={{ display: 'flex', alignItems: 'center', fontSize: '0.75rem', color: '#64748b' }}>
                      <input
                        type="checkbox"
                        checked={formData.dgacindiaNight}
                        onChange={(e) => setFormData({ ...formData, dgacindiaNight: e.target.checked })}
                        style={{ marginRight: '0.25rem' }}
                      />
                      Night flight
                    </label>
                  ...
                  <div>
                    ...
                    <select
                      value={formData.dgacindiaInstrumentActual ? 'actual' : formData.dgacindiaInstrumentHood ? 'hood' : formData.dgacindiaInstrumentSimulated ? 'simulated' : ''}
                      onChange={(e) => {
                        const value = e.target.value;
                        setFormData({ 
                          ...formData, 
                          dgacindiaInstrumentActual: value === 'actual',
                          dgacindiaInstrumentHood: value === 'hood',
                          dgacindiaInstrumentSimulated: value === 'simulated'
                        });
                      }}
                      style={{
                        width: '100%',
                  ...
                  <div>
                    ...
                    <input
                      type="number"
                      value={formData.dgacindiaTakeoffsDay}
                      onChange={(e) => setFormData({ ...formData, dgacindiaTakeoffsDay: e.target.value })}
                      placeholder="1"
                      style={{
                        width: '100%',
                        padding: '0.5rem',
                  ...
                  <div>
                    ...
                    <input
                      type="number"
                      value={formData.dgacindiaTakeoffsNight}
                      onChange={(e) => setFormData({ ...formData, dgacindiaTakeoffsNight: e.target.value })}
                      placeholder="0"
                      style={{
                        width: '100%',
                        padding: '0.5rem',
                  ...
                  <div>
                    ...
                    <input
                      type="number"
                      value={formData.dgacindiaLandingsDay}
                      onChange={(e) => setFormData({ ...formData, dgacindiaLandingsDay: e.target.value })}
                      placeholder="1"
                      style={{
                        width: '100%',
                        padding: '0.5rem',
                  ...
                  <div>
                    ...
                    <input
                      type="number"
                      value={formData.dgacindiaLandingsNight}
                      onChange={(e) => setFormData({ ...formData, dgacindiaLandingsNight: e.target.value })}
                      placeholder="0"
                      style={{
                        width: '100%',
                        padding: '0.5rem',
                  ...
                  <div>
                    ...
                    <select
                      value={formData.dgacindiaFlightNature}
                      onChange={(e) => setFormData({ ...formData, dgacindiaFlightNature: e.target.value as any })}
                      style={{
                        width: '100%',
                        padding: '0.5rem',
                        border: '1px solid #cbd5e1',
                  ...
                  <div>
                    ...
                    <label style={{ display: 'flex', alignItems: 'center', fontSize: '0.75rem', color: '#64748b' }}>
                      <input
                        type="checkbox"
                        checked={formData.dgacindiaSpic}
                        onChange={(e) => setFormData({ ...formData, dgacindiaSpic: e.target.checked })}
                        style={{ marginRight: '0.25rem' }}
                      />
                      Mark as SPIC
                    </label>
                  ...
                  <div>
                    ...
                    <input
                      type="text"
                      value={formData.dgacindiaInstructorName}
                      onChange={(e) => setFormData({ ...formData, dgacindiaInstructorName: e.target.value })}
                      placeholder="Required for P1 U/S"
                      style={{
                        width: '100%',
                        padding: '0.5rem',
                        border: '1px solid #cbd5e1',
                  ...
                  <div>
                    <label style={{ display: 'block', fontSize: '0.75rem', fontWeight: 600, color: '#64748b', marginBottom: '0.25rem', textTransform: 'uppercase' }}>
                      Instructor DGCA License
                    </label>
                    <input
                      type="text"
                      value={formData.dgacindiaInstructorDgcaLicense}
                      onChange={(e) => setFormData({ ...formData, dgacindiaInstructorDgcaLicense: e.target.value })}
                      placeholder="e.g., DGCA-12345"
                      style={{
                        width: '100%',
                        padding: '0.5rem',
                        border: '1px solid #cbd5e1',
                  ...
                  <div>
                    ...
                    <input
                      type="text"
                      value={formData.dgacindiaPilotUid}
                      onChange={(e) => setFormData({ ...formData, dgacindiaPilotUid: e.target.value })}
                      placeholder="For eGCA sync"
                      style={{
                        width: '100%',
                        padding: '0.5rem',
                        border: '1px solid #cbd5e1',
              ...
              {logbookFormat === 'jcab' && (
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(160px, 1fr))', gap: '1rem' }}>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      style={{
                        ...
                        fontSize: '0.875rem',
                        textTransform: 'uppercase',
                        borderColor: formData.registration && !formData.registration.startsWith('JA') ? '#ef4444' : '#cbd5e1'
                      }}
                    />
                    {formData.registration && !formData.registration.startsWith('JA') && (
                      <div style={{ fontSize: '0.65rem', color: '#ef4444', marginTop: '0.25rem' }}>
                        Must start with JA
                      </div>
                    )}
                  ...
                  <div>
                    ...
                    <select
                      value={formData.jcabAircraftClass}
                      onChange={(e) => setFormData({ ...formData, jcabAircraftClass: e.target.value as 'Single-engine' | 'Multi-engine' })}
                      style={{
                        width: '100%',
                        padding: '0.5rem',
                        border: '1px solid #cbd5e1',
                    ...
                    >
                      ...
                      <option value="Single-engine">Single-engine (単発)</option>
                      <option value="Multi-engine">Multi-engine (多発)</option>
                    </select>
                  </div>
                  <div>
                    <label style={{ display: 'block', fontSize: '0.75rem', fontWeight: 600, color: '#64748b', marginBottom: '0.25rem', textTransform: 'uppercase' }}>
                      Aircraft Category (区分)
                    </label>
                    <select
                      value={formData.jcabAircraftCategory}
                      onChange={(e) => setFormData({ ...formData, jcabAircraftCategory: e.target.value as 'Land' | 'Sea' })}
                      style={{
                        width: '100%',
                        padding: '0.5rem',
                        border: '1px solid #cbd5e1',
                  ...
                  <div>
                    ...
                    <input
                      type="text"
                      value={formData.jcabDepartureIcao}
                      onChange={(e) => {
                        const value = e.target.value.toUpperCase();
                        if (/^[A-Z0-9]{0,4}$/.test(value)) {
                          setFormData({ ...formData, jcabDepartureIcao: value });
                        }
                      }}
                      placeholder="RJTT"
                      maxLength={4}
                  ...
                  <div>
                    ...
                    <input
                      type="text"
                      value={formData.jcabArrivalIcao}
                      onChange={(e) => {
                        const value = e.target.value.toUpperCase();
                        if (/^[A-Z0-9]{0,4}$/.test(value)) {
                          setFormData({ ...formData, jcabArrivalIcao: value });
                        }
                      }}
                      placeholder="RJAA"
                      maxLength={4}
                  ...
                  <div>
                    ...
                    <input
                      type="time"
                      value={formData.jcabChocksOff}
                      onChange={(e) => setFormData({ ...formData, jcabChocksOff: e.target.value })}
                      style={{
                        width: '100%',
                        padding: '0.5rem',
                        border: '1px solid #cbd5e1',
                  ...
                  <div>
                    ...
                    <input
                      type="time"
                      value={formData.jcabChocksOn}
                      onChange={(e) => setFormData({ ...formData, jcabChocksOn: e.target.value })}
                      style={{
                        width: '100%',
                        padding: '0.5rem',
                        border: '1px solid #cbd5e1',
                  ...
                  <div>
                    ...
                    <select
                      value={formData.jcabPilotCapacity}
                      onChange={(e) => setFormData({ ...formData, jcabPilotCapacity: e.target.value as '機長' | '副操縦士' | '操縦教育' })}
                      style={{
                        width: '100%',
                        padding: '0.5rem',
                        border: '1px solid #cbd5e1',
                    ...
                    >
                      ...
                      <option value="機長">機長 (PIC)</option>
                      <option value="副操縦士">副操縦士 (Co-pilot)</option>
                      <option value="操縦教育">操縦教育 (Dual/Training)</option>
                    </select>
                  </div>
                  <div>
                    <label style={{ display: 'block', fontSize: '0.75rem', fontWeight: 600, color: '#64748b', marginBottom: '0.25rem', textTransform: 'uppercase' }}>
                    ...
                    <input
                      type="text"
                      value={formData.jcabServiceTime}
                      onChange={(e) => setFormData({ ...formData, jcabServiceTime: e.target.value })}
                      placeholder="1.5"
                      style={{
                        width: '100%',
                        padding: '0.5rem',
                  ...
                  <div>
                    ...
                    <input
                      type="text"
                      value={formData.jcabFlightTime}
                      onChange={(e) => setFormData({ ...formData, jcabFlightTime: e.target.value })}
                      placeholder="1.5"
                      style={{
                        width: '100%',
                        padding: '0.5rem',
                  ...
                  <div>
                    ...
                    <label style={{ display: 'flex', alignItems: 'center', fontSize: '0.75rem', color: '#64748b' }}>
                      <input
                        type="checkbox"
                        checked={formData.jcabDay}
                        onChange={(e) => setFormData({ ...formData, jcabDay: e.target.checked })}
                        style={{ marginRight: '0.25rem' }}
                      />
                      Day Flight
                    </label>
                  ...
                  <div>
                    ...
                    <label style={{ display: 'flex', alignItems: 'center', fontSize: '0.75rem', color: '#64748b' }}>
                      <input
                        type="checkbox"
                        checked={formData.jcabNight}
                        onChange={(e) => setFormData({ ...formData, jcabNight: e.target.checked })}
                        style={{ marginRight: '0.25rem' }}
                      />
                      Night Flight
                    </label>
                  ...
                  <div>
                    <label style={{ display: 'block', fontSize: '0.75rem', fontWeight: 600, color: '#64748b', marginBottom: '0.25rem', textTransform: 'uppercase' }}>
                      Instrument Time (計器飛行)
                    </label>
                    <label style={{ display: 'flex', alignItems: 'center', fontSize: '0.75rem', color: '#64748b' }}>
                      <input
                        type="checkbox"
                        checked={formData.jcabInstrumentTime}
                        onChange={(e) => setFormData({ ...formData, jcabInstrumentTime: e.target.checked })}
                        style={{ marginRight: '0.25rem' }}
                      />
                      IFR Flight
                    </label>
                  ...
                  <div>
                    ...
                    <input
                      type="number"
                      value={formData.jcabLandingsDay}
                      onChange={(e) => setFormData({ ...formData, jcabLandingsDay: e.target.value })}
                      placeholder="0"
                      min="0"
                      style={{
                        width: '100%',
                  ...
                  <div>
                    ...
                    <input
                      type="number"
                      value={formData.jcabLandingsNight}
                      onChange={(e) => setFormData({ ...formData, jcabLandingsNight: e.target.value })}
                      placeholder="0"
                      min="0"
                      style={{
                        width: '100%',
                  ...
                  <div>
                    <label style={{ display: 'block', fontSize: '0.75rem', fontWeight: 600, color: '#64748b', marginBottom: '0.25rem', textTransform: 'uppercase' }}>
                      Instrument Approach (進入)
                    </label>
                    <input
                      type="text"
                      value={formData.jcabInstrumentApproachType}
                      onChange={(e) => setFormData({ ...formData, jcabInstrumentApproachType: e.target.value })}
                      placeholder="ILS, VOR, NDB"
                      style={{
                        width: '100%',
                        padding: '0.5rem',
                        border: '1px solid #cbd5e1',
                  ...
                  <div>
                    ...
                    <input
                      type="text"
                      value={formData.jcabRemarks}
                      onChange={(e) => setFormData({ ...formData, jcabRemarks: e.target.value })}
                      placeholder="Flight remarks"
                      style={{
                        width: '100%',
                        padding: '0.5rem',
              ...
              {logbookFormat === 'nzcaa' && (
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(160px, 1fr))', gap: '1rem' }}>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      style={{
                        ...
                        fontSize: '0.875rem',
                        textTransform: 'uppercase',
                        borderColor: formData.registration && !formData.registration.startsWith('ZK') ? '#ef4444' : '#cbd5e1'
                      }}
                    />
                    {formData.registration && !formData.registration.startsWith('ZK') && (
                      <div style={{ fontSize: '0.65rem', color: '#ef4444', marginTop: '0.25rem' }}>
                        Must start with ZK
                      </div>
                    )}
                  ...
                  <div>
                    ...
                    <select
                      value={formData.nzcaaFlightFunction}
                      onChange={(e) => setFormData({ ...formData, nzcaaFlightFunction: e.target.value as 'PIC' | 'PIC/US' | 'Co-pilot' | 'Student' })}
                      style={{
                        width: '100%',
                        padding: '0.5rem',
                        border: '1px solid #cbd5e1',
                    ...
                    >
                      ...
                      <option value="PIC">PIC</option>
                      <option value="PIC/US">PIC/US</option>
                      <option value="Co-pilot">Co-pilot</option>
                  ...
                  <div>
                    <label style={{ display: 'block', fontSize: '0.75rem', fontWeight: 600, color: '#64748b', marginBottom: '0.25rem', textTransform: 'uppercase' }}>
                      Command Practice (Rule 61.31b)
                    </label>
                    <input
                      type="text"
                      value={formData.nzcaaCommandPractice}
                      onChange={(e) => setFormData({ ...formData, nzcaaCommandPractice: e.target.value })}
                      placeholder="0"
                      style={{
                        width: '100%',
                        padding: '0.5rem',
                  ...
                  <div>
                    <label style={{ display: 'block', fontSize: '0.75rem', fontWeight: 600, color: '#64748b', marginBottom: '0.25rem', textTransform: 'uppercase' }}>
                      Air Time (Maintenance)
                    </label>
                    <input
                      type="text"
                      value={formData.nzcaaAirTime}
                      onChange={(e) => setFormData({ ...formData, nzcaaAirTime: e.target.value })}
                      placeholder="1.5"
                      style={{
                        width: '100%',
                        padding: '0.5rem',
                  ...
                  <div>
                    ...
                    <input
                      type="text"
                      value={formData.nzcaaFlightTime}
                      onChange={(e) => setFormData({ ...formData, nzcaaFlightTime: e.target.value })}
                      placeholder="1.5"
                      style={{
                        width: '100%',
                        padding: '0.5rem',
                  ...
                  <div>
                    ...
                    <label style={{ display: 'flex', alignItems: 'center', fontSize: '0.75rem', color: '#64748b' }}>
                      <input
                        type="checkbox"
                        checked={formData.nzcaaDay}
                        onChange={(e) => setFormData({ ...formData, nzcaaDay: e.target.checked })}
                        style={{ marginRight: '0.25rem' }}
                      />
                      Day Flight
                    </label>
                  ...
                  <div>
                    ...
                    <label style={{ display: 'flex', alignItems: 'center', fontSize: '0.75rem', color: '#64748b' }}>
                      <input
                        type="checkbox"
                        checked={formData.nzcaaNight}
                        onChange={(e) => setFormData({ ...formData, nzcaaNight: e.target.checked })}
                        style={{ marginRight: '0.25rem' }}
                      />
                      Night Flight
                    </label>
                  ...
                  <div>
                    ...
                    <label style={{ display: 'flex', alignItems: 'center', fontSize: '0.75rem', color: '#64748b' }}>
                      <input
                        type="checkbox"
                        checked={formData.nzcaaInstrumentActual}
                        onChange={(e) => setFormData({ ...formData, nzcaaInstrumentActual: e.target.checked })}
                        style={{ marginRight: '0.25rem' }}
                      />
                      Actual Instrument
                    </label>
                  ...
                  <div>
                    ...
                    <label style={{ display: 'flex', alignItems: 'center', fontSize: '0.75rem', color: '#64748b' }}>
                      <input
                        type="checkbox"
                        checked={formData.nzcaaInstrumentSimulated}
                        onChange={(e) => setFormData({ ...formData, nzcaaInstrumentSimulated: e.target.checked })}
                        style={{ marginRight: '0.25rem' }}
                      />
                  ...
                  <div>
                    ...
                    <label style={{ display: 'flex', alignItems: 'center', fontSize: '0.75rem', color: '#64748b' }}>
                      <input
                        type="checkbox"
                        checked={formData.nzcaaInstrumentGround}
                        onChange={(e) => setFormData({ ...formData, nzcaaInstrumentGround: e.target.checked })}
                        style={{ marginRight: '0.25rem' }}
                      />
                      Ground Instrument
                    </label>
                  ...
                  <div>
                    ...
                    <input
                      type="text"
                      value={formData.nzcaaDeparturePoint}
                      onChange={(e) => setFormData({ ...formData, nzcaaDeparturePoint: e.target.value })}
                      placeholder="NZWN"
                      style={{
                        width: '100%',
                        padding: '0.5rem',
                  ...
                  <div>
                    ...
                    <input
                      type="text"
                      value={formData.nzcaaIntermediateLandings}
                      onChange={(e) => setFormData({ ...formData, nzcaaIntermediateLandings: e.target.value })}
                      placeholder="NZAA, NZCH"
                      style={{
                        width: '100%',
                        padding: '0.5rem',
                        border: '1px solid #cbd5e1',
                  ...
                  <div>
                    ...
                    <input
                      type="text"
                      value={formData.nzcaaArrivalPoint}
                      onChange={(e) => setFormData({ ...formData, nzcaaArrivalPoint: e.target.value })}
                      placeholder="NZCH"
                      style={{
                        width: '100%',
                        padding: '0.5rem',
                  ...
                  <div>
                    ...
                    <input
                      type="text"
                      value={formData.nzcaaTrainingExercises}
                      onChange={(e) => setFormData({ ...formData, nzcaaTrainingExercises: e.target.value })}
                      placeholder="Stalls, Steep Turns"
                      style={{
                        width: '100%',
                        padding: '0.5rem',
                        border: '1px solid #cbd5e1',
                  ...
                  <div>
                    ...
                    <input
                      type="text"
                      value={formData.nzcaaInstructorName}
                      onChange={(e) => setFormData({ ...formData, nzcaaInstructorName: e.target.value })}
                  ...
                  <div>
                    ...
                    <input
                      type="text"
                      value={formData.nzcaaSafetyPilotName}
                      onChange={(e) => setFormData({ ...formData, nzcaaSafetyPilotName: e.target.value })}
              ...
              {/* SACAA South Africa Form Fields */}
              {logbookFormat === 'sacaa' && (
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(160px, 1fr))', gap: '1rem' }}>
                  <div>
                    <label style={{ display: 'block', fontSize: '0.75rem', fontWeight: 600, color: '#64748b', marginBottom: '0.25rem', textTransform: 'uppercase' }}>
                  ...
                  <div>
                    <label style={{ display: 'block', fontSize: '0.75rem', fontWeight: 600, color: '#64748b', marginBottom: '0.25rem', textTransform: 'uppercase' }}>
                      Aircraft Registration (ZS-/ZT-/ZU-)*
                    </label>
                    <input
                      type="text"
                      value={formData.registration}
                  ...
                  <div>
                    ...
                    <select
                      value={formData.sacaaFlightFunction}
                      onChange={(e) => setFormData({ ...formData, sacaaFlightFunction: e.target.value as 'PIC' | 'Co-pilot' | 'PICUS' | 'Dual' })}
                      style={{
                        width: '100%',
                        padding: '0.5rem',
                        border: '1px solid #cbd5e1',
                  ...
                  <div>
                    ...
                    <input
                      type="text"
                      value={formData.sacaaDepartureIcao}
                      onChange={(e) => setFormData({ ...formData, sacaaDepartureIcao: e.target.value.toUpperCase() })}
                      placeholder="FAOR"
                      maxLength={4}
                      style={{
                        width: '100%',
                  ...
                  <div>
                    ...
                    <input
                      type="text"
                      value={formData.sacaaArrivalIcao}
                      onChange={(e) => setFormData({ ...formData, sacaaArrivalIcao: e.target.value.toUpperCase() })}
                      placeholder="FAGM"
                      maxLength={4}
                      style={{
                        width: '100%',
                  ...
                  <div>
                    ...
                    <input
                      type="text"
                      value={formData.sacaaChocksOff}
                      onChange={(e) => setFormData({ ...formData, sacaaChocksOff: e.target.value })}
                      placeholder="08:00"
                      style={{
                        width: '100%',
                        padding: '0.5rem',
                  ...
                  <div>
                    ...
                    <input
                      type="text"
                      value={formData.sacaaChocksOn}
                      onChange={(e) => setFormData({ ...formData, sacaaChocksOn: e.target.value })}
                      placeholder="10:30"
                      style={{
                        width: '100%',
                        padding: '0.5rem',
                  ...
                  <div>
                    ...
                    <input
                      type="checkbox"
                      checked={formData.sacaaDay}
                      onChange={(e) => setFormData({ ...formData, sacaaDay: e.target.checked })}
                      style={{
                        width: '20px',
                        height: '20px',
                        marginTop: '0.5rem'
                  ...
                  <div>
                    ...
                    <input
                      type="checkbox"
                      checked={formData.sacaaNight}
                      onChange={(e) => setFormData({ ...formData, sacaaNight: e.target.checked })}
                      style={{
                        width: '20px',
                        height: '20px',
                        marginTop: '0.5rem'
                  ...
                  <div>
                    ...
                    <input
                      type="checkbox"
                      checked={formData.sacaaInstrumentActual}
                      onChange={(e) => setFormData({ ...formData, sacaaInstrumentActual: e.target.checked })}
                      style={{
                        width: '20px',
                        height: '20px',
                        marginTop: '0.5rem'
                  ...
                  <div>
                    ...
                    <input
                      type="checkbox"
                      checked={formData.sacaaInstrumentSimulated}
                      onChange={(e) => setFormData({ ...formData, sacaaInstrumentSimulated: e.target.checked })}
                      style={{
                        width: '20px',
                        height: '20px',
                        marginTop: '0.5rem'
                  ...
                  <div>
                    ...
                    <input
                      type="checkbox"
                      checked={formData.sacaaInstrumentFstd}
                      onChange={(e) => setFormData({ ...formData, sacaaInstrumentFstd: e.target.checked })}
                      style={{
                        width: '20px',
                        height: '20px',
                        marginTop: '0.5rem'
                  ...
                  <div>
                    ...
                    <input
                      type="number"
                      value={formData.sacaaLandingsDay}
                      onChange={(e) => setFormData({ ...formData, sacaaLandingsDay: parseInt(e.target.value) || 0 })}
                      placeholder="0"
                      min="0"
                      style={{
                        width: '100%',
                  ...
                  <div>
                    ...
                    <input
                      type="number"
                      value={formData.sacaaLandingsNight}
                      onChange={(e) => setFormData({ ...formData, sacaaLandingsNight: parseInt(e.target.value) || 0 })}
                      placeholder="0"
                      min="0"
                      style={{
                        width: '100%',
                  ...
                  <div>
                    ...
                    <input
                      type="text"
                      value={formData.sacaaFlightNature}
                      onChange={(e) => setFormData({ ...formData, sacaaFlightNature: e.target.value })}
                  ...
                  <div>
                    ...
                    <input
                      type="text"
                      value={formData.sacaaInstructorName}
                      onChange={(e) => setFormData({ ...formData, sacaaInstructorName: e.target.value })}
                      placeholder="John Smith"
                      style={{
                        width: '100%',
                        padding: '0.5rem',
                  ...
                  <div>
                    ...
                    <input
                      type="text"
                      value={formData.sacaaInstructorLicenseNumber}
                      onChange={(e) => setFormData({ ...formData, sacaaInstructorLicenseNumber: e.target.value })}
                      placeholder="SACAA-123456"
                      style={{
                        width: '100%',
                        padding: '0.5rem',
                        border: '1px solid #cbd5e1',
                  ...
                  <div>
                    ...
                    <input
                      type="text"
                      value={formData.sacaaCommanderName}
                      onChange={(e) => setFormData({ ...formData, sacaaCommanderName: e.target.value })}
                      placeholder="Jane Doe"
                      style={{
                        width: '100%',
                        padding: '0.5rem',
                  ...
                  <div>
                    ...
                    <input
                      type="text"
                      value={formData.sacaaCommanderLicenseNumber}
                      onChange={(e) => setFormData({ ...formData, sacaaCommanderLicenseNumber: e.target.value })}
                      placeholder="SACAA-789012"
                      style={{
                        width: '100%',
                        padding: '0.5rem',
                        border: '1px solid #cbd5e1',
              ...
              {logbookFormat === 'gcaa' && (
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(160px, 1fr))', gap: '1rem' }}>
                  ...
                  <div>
                    ...
                    <input
                      type="text"
                      value={formData.gcaaDepartureIcao}
                      onChange={(e) => setFormData({ ...formData, gcaaDepartureIcao: e.target.value.toUpperCase() })}
                      placeholder="OMDB"
                      maxLength={4}
                      style={{
                        width: '100%',
                  ...
                  <div>
                    ...
                    <input
                      type="text"
                      value={formData.gcaaArrivalIcao}
                      onChange={(e) => setFormData({ ...formData, gcaaArrivalIcao: e.target.value.toUpperCase() })}
                      placeholder="OMAA"
                      maxLength={4}
                      style={{
                        width: '100%',
                  ...
                  <div>
                    ...
                    <input
                      type="time"
                      value={formData.gcaaOffBlock}
                      onChange={(e) => setFormData({ ...formData, gcaaOffBlock: e.target.value })}
                      step="60"
                      style={{
                        width: '100%',
                        padding: '0.5rem',
                  ...
                  <div>
                    ...
                    <input
                      type="time"
                      value={formData.gcaaOnBlock}
                      onChange={(e) => setFormData({ ...formData, gcaaOnBlock: e.target.value })}
                      step="60"
                      style={{
                        width: '100%',
                        padding: '0.5rem',
                  ...
                  <div>
                    ...
                    <select
                      value={formData.gcaaPilotFunction || ''}
                      onChange={(e) => setFormData({ ...formData, gcaaPilotFunction: e.target.value as 'P1' | 'P2' | 'P1 U/S' })}
                      style={{
                        width: '100%',
                        padding: '0.5rem',
                        border: '1px solid #cbd5e1',
                    ...
                    >
                      ...
                      <option value="P1">P1 (PIC)</option>
                      <option value="P2">P2 (Co-pilot)</option>
                      <option value="P1 U/S">P1 U/S (Under Supervision)</option>
                    </select>
                  </div>
                  <div>
                    <label style={{ display: 'block', fontSize: '0.75rem', fontWeight: 600, color: '#64748b', marginBottom: '0.25rem', textTransform: 'uppercase' }}>
                    ...
                    <input
                      type="checkbox"
                      checked={formData.gcaaDay}
                      onChange={(e) => setFormData({ ...formData, gcaaDay: e.target.checked })}
                      style={{
                        width: '1.5rem',
                        height: '1.5rem',
                        cursor: 'pointer'
                  ...
                  <div>
                    ...
                    <input
                      type="checkbox"
                      checked={formData.gcaaNight}
                      onChange={(e) => setFormData({ ...formData, gcaaNight: e.target.checked })}
                      style={{
                        width: '1.5rem',
                        height: '1.5rem',
                        cursor: 'pointer'
                  ...
                  <div>
                    ...
                    <input
                      type="checkbox"
                      checked={formData.gcaaInstrumentActual}
                      onChange={(e) => setFormData({ ...formData, gcaaInstrumentActual: e.target.checked })}
                      style={{
                        width: '1.5rem',
                        height: '1.5rem',
                        cursor: 'pointer'
                  ...
                  <div>
                    ...
                    <input
                      type="checkbox"
                      checked={formData.gcaaInstrumentSimulated}
                      onChange={(e) => setFormData({ ...formData, gcaaInstrumentSimulated: e.target.checked })}
                      style={{
                        width: '1.5rem',
                        height: '1.5rem',
                        cursor: 'pointer'
                  ...
                  <div>
                    ...
                    <input
                      type="checkbox"
                      checked={formData.gcaaInstrumentFstd}
                      onChange={(e) => setFormData({ ...formData, gcaaInstrumentFstd: e.target.checked })}
                      style={{
                        width: '1.5rem',
                        height: '1.5rem',
                        cursor: 'pointer'
                  ...
                  <div>
                    ...
                    <input
                      type="number"
                      value={formData.gcaaLandingsDay}
                      onChange={(e) => setFormData({ ...formData, gcaaLandingsDay: parseInt(e.target.value) || 0 })}
                      min="0"
                      placeholder="0"
                      style={{
                        width: '100%',
                  ...
                  <div>
                    ...
                    <input
                      type="number"
                      value={formData.gcaaLandingsNight}
                      onChange={(e) => setFormData({ ...formData, gcaaLandingsNight: parseInt(e.target.value) || 0 })}
                      min="0"
                      placeholder="0"
                      style={{
                        width: '100%',
                  ...
                  <div>
                    <label style={{ display: 'block', fontSize: '0.75rem', fontWeight: 600, color: '#64748b', marginBottom: '0.25rem', textTransform: 'uppercase' }}>
                      Autolandings (CAT II/III)
                    </label>
                    <input
                      type="number"
                      value={formData.gcaaAutolandings}
                      onChange={(e) => setFormData({ ...formData, gcaaAutolandings: parseInt(e.target.value) || 0 })}
                      min="0"
                      placeholder="0"
                      style={{
                        width: '100%',
                  ...
                  <div>
                    ...
                    <input
                      type="text"
                      value={formData.gcaaFlightNature}
                      onChange={(e) => setFormData({ ...formData, gcaaFlightNature: e.target.value })}
                      placeholder="Scheduled, Training, Skill Test"
                      style={{
                        width: '100%',
                        padding: '0.5rem',
                        border: '1px solid #cbd5e1',
                  ...
                  <div>
                    <label style={{ display: 'block', fontSize: '0.75rem', fontWeight: 600, color: '#64748b', marginBottom: '0.25rem', textTransform: 'uppercase' }}>
                      Commander Name (for P1 U/S)
                    </label>
                    <input
                      type="text"
                      value={formData.gcaaCommanderName}
                      onChange={(e) => setFormData({ ...formData, gcaaCommanderName: e.target.value })}
                  ...
                  <div>
                    <label style={{ display: 'block', fontSize: '0.75rem', fontWeight: 600, color: '#64748b', marginBottom: '0.25rem', textTransform: 'uppercase' }}>
                      GCAA License Number (for P1 U/S)
                    </label>
                    <input
                      type="text"
                      value={formData.gcaaCommanderGcaaLicense}
                      onChange={(e) => setFormData({ ...formData, gcaaCommanderGcaaLicense: e.target.value })}
                      placeholder="GCAA-123456"
                      style={{
                        width: '100%',
                        padding: '0.5rem',
                        border: '1px solid #cbd5e1',
                  ...
                  <div>
                    <label style={{ display: 'block', fontSize: '0.75rem', fontWeight: 600, color: '#64748b', marginBottom: '0.25rem', textTransform: 'uppercase' }}>
                      Commander Signature (for P1 U/S)
                    </label>
                    <input
                      type="text"
                      value={formData.gcaaCommanderSignature}
                      onChange={(e) => setFormData({ ...formData, gcaaCommanderSignature: e.target.value })}
              ...
              {/* UK CAA Part-FCL.050 & CAP 804 Form Fields */}
              {logbookFormat === 'ukcaa' && (
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(160px, 1fr))', gap: '1rem' }}>
                  <div>
                    <label style={{ display: 'block', fontSize: '0.75rem', fontWeight: 600, color: '#64748b', marginBottom: '0.25rem', textTransform: 'uppercase' }}>
                  ...
                  <div>
                    ...
                    <input
                      type="time"
                      value={formData.ukcaaOffBlock}
                      onChange={(e) => setFormData({ ...formData, ukcaaOffBlock: e.target.value })}
                      step="60"
                      style={{
                        width: '100%',
                        padding: '0.5rem',
                  ...
                  <div>
                    ...
                    <input
                      type="time"
                      value={formData.ukcaaOnBlock}
                      onChange={(e) => setFormData({ ...formData, ukcaaOnBlock: e.target.value })}
                      step="60"
                      style={{
                        width: '100%',
                        padding: '0.5rem',
                  ...
                  <div>
                    ...
                    <select
                      value={formData.ukcaaPilotFunction || ''}
                      onChange={(e) => setFormData({ ...formData, ukcaaPilotFunction: e.target.value as 'PIC' | 'Co-pilot' | 'PICUS' | 'Dual' })}
                      style={{
                        width: '100%',
                        padding: '0.5rem',
                        border: '1px solid #cbd5e1',
                    ...
                    >
                      ...
                      <option value="Co-pilot">Co-pilot</option>
                      <option value="PICUS">PICUS (PIC Under Supervision)</option>
                      <option value="Dual">Dual (Instruction Received)</option>
                    </select>
                  </div>
                  <div>
                    ...
                    <input
                      type="checkbox"
                      checked={formData.ukcaaNight}
                      onChange={(e) => setFormData({ ...formData, ukcaaNight: e.target.checked })}
                      style={{
                        width: '1.5rem',
                        height: '1.5rem',
                        cursor: 'pointer'
                  ...
                  <div>
                    ...
                    <input
                      type="checkbox"
                      checked={formData.ukcaaIfr}
                      onChange={(e) => setFormData({ ...formData, ukcaaIfr: e.target.checked })}
                      style={{
                        width: '1.5rem',
                        height: '1.5rem',
                        cursor: 'pointer'
                  ...
                  <div>
                    ...
                    <input
                      type="checkbox"
                      checked={formData.ukcaaFstd}
                      onChange={(e) => setFormData({ ...formData, ukcaaFstd: e.target.checked })}
                      style={{
                        width: '1.5rem',
                        height: '1.5rem',
                        cursor: 'pointer'
                  ...
                  <div>
                    ...
                    <input
                      type="number"
                      value={formData.ukcaaTakeoffsDay}
                      onChange={(e) => setFormData({ ...formData, ukcaaTakeoffsDay: parseInt(e.target.value) || 0 })}
                      min="0"
                      placeholder="0"
                      style={{
                        width: '100%',
                  ...
                  <div>
                    ...
                    <input
                      type="number"
                      value={formData.ukcaaTakeoffsNight}
                      onChange={(e) => setFormData({ ...formData, ukcaaTakeoffsNight: parseInt(e.target.value) || 0 })}
                      min="0"
                      placeholder="0"
                      style={{
                        width: '100%',
                  ...
                  <div>
                    ...
                    <input
                      type="number"
                      value={formData.ukcaaLandingsDay}
                      onChange={(e) => setFormData({ ...formData, ukcaaLandingsDay: parseInt(e.target.value) || 0 })}
                      min="0"
                      placeholder="0"
                      style={{
                        width: '100%',
                  ...
                  <div>
                    ...
                    <input
                      type="number"
                      value={formData.ukcaaLandingsNight}
                      onChange={(e) => setFormData({ ...formData, ukcaaLandingsNight: parseInt(e.target.value) || 0 })}
                      min="0"
                      placeholder="0"
                      style={{
                        width: '100%',
                  ...
                  <div>
                    ...
                    <input
                      type="text"
                      value={formData.ukcaaFlightNature}
                      onChange={(e) => setFormData({ ...formData, ukcaaFlightNature: e.target.value })}
                      placeholder="Commercial, Private, Skill Test"
                      style={{
                        width: '100%',
                        padding: '0.5rem',
                        border: '1px solid #cbd5e1',
                  ...
                  <div>
                    <label style={{ display: 'block', fontSize: '0.75rem', fontWeight: 600, color: '#64748b', marginBottom: '0.25rem', textTransform: 'uppercase' }}>
                      Commander Name (for PICUS/Dual)
                    </label>
                    <input
                      type="text"
                      value={formData.ukcaaCommanderName}
                      onChange={(e) => setFormData({ ...formData, ukcaaCommanderName: e.target.value })}
                      placeholder="Commander Name"
                      style={{
                        width: '100%',
                        padding: '0.5rem',
                  ...
                  <div>
                    <label style={{ display: 'block', fontSize: '0.75rem', fontWeight: 600, color: '#64748b', marginBottom: '0.25rem', textTransform: 'uppercase' }}>
                      Commander Signature (for PICUS/Dual)
                    </label>
                    <input
                      type="text"
                      value={formData.ukcaaCommanderSignature}
                      onChange={(e) => setFormData({ ...formData, ukcaaCommanderSignature: e.target.value })}
                      placeholder="Digital Signature"
                      style={{
                        width: '100%',
                        padding: '0.5rem',
