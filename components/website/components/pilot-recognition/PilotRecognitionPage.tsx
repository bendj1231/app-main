        ...
        <>
            ...
            <div className="py-12 px-6 max-w-6xl mx-auto space-y-16">
                ...
                <div className="text-center max-w-4xl mx-auto">
                    ...
                    <p className="text-lg text-slate-700 leading-relaxed mb-4">
                        The <strong>Foundation Program</strong> is your first step towards building a credible and recognized pilot profile. This recognition-based program is designed to establish a solid foundation of aviation knowledge, competency, and industry standards that global manufacturers and operators recognize as credible experience. The program aligns with Airbus EBT CBTA standards, ensuring that your recognition meets the highest international standards in evidence-based training and competency-based training and assessment.
                    </p>
                    <p className="text-lg text-slate-700 leading-relaxed mb-4">
                        Through alignment with Airbus EBT CBTA standards, the Foundation Program provides a recognition framework that aligns with the highest industry standards. Upon completion, your profile reflects this achievement, demonstrating to airlines and operators that you have undergone rigorous assessment and verification.
                    </p>
                    <p className="text-lg text-slate-700 leading-relaxed mb-4">
