...
export const RecognitionCareerMatchesPage: React.FC<RecognitionCareerMatchesPageProps> = ({
    ...
    const pathways = [
        ...
        { title: 'Joby Aviation Pilot Program', subtitle: 'Joby Aviation', match: 88, pr: 0, image: '/images/joby-aviation.png', requirements: ['1,500 hrs', 'CPL or ATPL', 'Helicopter Experience Preferred', 'FAA Medical Class 1'], type: 'eVTOL Pilot', salary: '$85,000 - $120,000/year' },
        { title: 'Archer Aviation Midnight Operations', subtitle: 'Archer Aviation', match: 87, pr: 0, image: '/images/archer-aviation.png', requirements: ['1,200 hrs', 'Fixed-Wing or Rotary', 'Part 135 Experience'], type: 'eVTOL Captain', salary: '$80,000 - $115,000/year' },
        ...
        { title: 'MLG Pilotless Drone Operations', subtitle: 'MLG Aviation', match: 80, pr: 0, image: '/images/mlg-drone.png', requirements: ['UAS Certification', 'Remote Pilot License', 'Autonomous Systems Experience'], type: 'Autonomous Drone Operations', salary: '$55,000 - $75,000/year' },
        ...
        { title: 'Remote Supply Runs Pilot', subtitle: 'Remote Logistics Operators', match: 82, pr: 0, image: '/images/recognition-career-blogger.png', requirements: ['2,000+ hrs TT', 'Mountain Flying', 'Short Field Operations', 'Supply Chain Experience'], type: 'Supply & Logistics', salary: '$60,000 - $95,000/year' },
