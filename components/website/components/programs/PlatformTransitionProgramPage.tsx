            ...
            <div className="py-12 px-6 max-w-6xl mx-auto space-y-16">
                ...
                <div className="flex flex-col md:flex-row-reverse items-center gap-10 md:gap-16">
                    <div className="md:w-1/2 text-center md:text-left">
                        ...
                        <p className="text-base text-slate-700 leading-relaxed mb-4">
                            Yes, you need 1,500 hours to be considered by most airlines. But what are they <em>really</em> evaluating when they review your profile and assess competencies? Our connections with Airbus and Etihad have revealed the truth: <strong>it's about competency, not just time logged</strong>.
                        </p>
                        <p className="text-base text-slate-700 leading-relaxed">
