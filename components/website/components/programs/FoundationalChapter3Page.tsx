...
interface FoundationalChapter3PageProps {
  onBack: () => void;
  onNavigate: (page: string) => void;
}

export const FoundationalChapter3Page: React.FC<FoundationalChapter3PageProps> = ({ 
  onBack, 
  onNavigate 
}) => {
  ...
  const sections = [
    {
      ...
      description: 'Understanding core risk management principles in aviation operations.',
      duration: '25 min',
      completed: false,
    },
    {
      title: 'Health & Decision Making',
      description: 'The impact of pilot health on decision-making processes and risk assessment.',
      duration: '20 min',
      completed: false,
    },
    {
      title: 'Crew Resource Management',
      description: 'CRM principles and their application in modern aviation environments.',
      duration: '30 min',
      completed: false,
    },
  ];
      ...
      <div style={{ padding: '0 3rem 2rem 3rem', maxWidth: '1200px', margin: '0 auto' }}>
        ...
        >
          ...
          <p style={{ color: '#475569', fontSize: '0.95rem', lineHeight: 1.6, marginBottom: '2rem', textAlign: 'center' }}>
            Comprehensive understanding of pilot risk management, health, and decision-making processes.
          </p>
