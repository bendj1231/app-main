...
export const FoundationalChapter1Page: React.FC<FoundationalChapter1PageProps> = ({ 
  onBack, 
  onNavigate 
}) => {
  ...
  const sections = [
    {
      title: 'What is a Low-Timer Pilot?',
      description: 'Understanding the challenges and opportunities for pilots with limited flight hours.',
      duration: '15 min',
      completed: false,
    },
    {
      title: 'The Pilot Shortage & Paradox',
      description: 'Exploring the global pilot shortage and its impact on career opportunities.',
      duration: '20 min',
      completed: false,
    },
    {
      title: 'Industry Landscape Overview',
      description: 'Comprehensive overview of the aviation industry structure and career pathways.',
      duration: '10 min',
      completed: false,
    },
  ];
      ...
      <div style={{ padding: '0 3rem 2rem 3rem', maxWidth: '1200px', margin: '0 auto' }}>
        ...
        >
          ...
          <div style={{ textAlign: 'center', marginBottom: '2.5rem' }}>
            <img src="/images/set-01-logos/logo.png" alt="PilotRecognition Logo" style={{ display: 'block', maxWidth: '180px', height: 'auto', objectFit: 'contain', margin: '0 auto 1rem' }} />
            ...
            <h1 style={{ fontFamily: 'Georgia, serif', fontSize: 'clamp(2rem, 3vw, 2.5rem)', fontWeight: 400, color: '#0f172a', margin: '0 0 0.75rem 0', letterSpacing: '-0.02em' }}>
              Industry Familiarization & Indoctrination
            </h1>
