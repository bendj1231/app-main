...
export const MindMap: React.FC = () => {
    const isDarkMode = false; // Forced light/default mode or you can prop this in from parent if desired
    ...
    const lineColor = '#52525b'; // Zinc-600
    ...
    const getNodeStyle = (node: NodeData, isHovered: boolean) => {
        ...
        let border = "border-2 border-zinc-300";
        let text = "text-zinc-900";
        let shadow = "hover:shadow-xl";
    ...
    return (
        <div className="w-full max-w-6xl mx-auto py-10 relative select-none">
            ...
            <div
                className={`relative w-full overflow-hidden transition-all duration-1000 ease-in-out border-b rounded-b-3xl border-zinc-300`}
                            ...
                            >
                                ...
                                {isHovered && (
                                    <div className={`absolute w-64 p-5 rounded-xl border-2 shadow-2xl z-50 animate-in fade-in zoom-in-95 duration-300 pointer-events-none
                                        ...
                                        <p className={`text-xs font-sans text-left leading-relaxed mb-4 text-zinc-600`}>
                                            {node.description}
                                        </p>
                                        {node.image && (
                                            <div className={`w-full h-24 rounded-lg overflow-hidden border mt-2 border-black/10`}>
                                        ...
                                        <button
                                            ...
                                            className={`w-6 h-6 rounded-full flex items-center justify-center border-2 shadow-lg transition-all duration-300
                                              ${isExpanded
                                                    ...
                                                    : 'bg-zinc-200/80 border-zinc-300 text-zinc-600 mt-1'}`}
                                        >
            ...
            <div className="mt-20 text-center max-w-2xl mx-auto px-4 animate-in fade-in duration-1000 delay-500">
                ...
                <h3 className={`text-2xl md:text-3xl font-bold brand-font uppercase tracking-widest mb-6 text-zinc-900`}>
                    The Competitive Advantage
                </h3>
                <p className={`text-base md:text-lg font-light leading-relaxed notam-font text-zinc-600`}>
