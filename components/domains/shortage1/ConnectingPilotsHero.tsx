...
const slides = [
  ...
  },
  {
    ...
    tagline: 'Three Platforms. One Standard.',
    headline: 'Built for Pilots.',
    headlineAccent: 'Backed by Verification.',
    description: 'pilotrecognition.com verifies your credentials. pilotcareerpathways.com shows where you fit. pilotshortage.org gives you a voice.',
    ctaPrimary: { text: 'Get Verified', href: '/pilotshortage/join' },
    ctaSecondary: { text: 'Explore Pathways', href: 'https://pilotcareerpathways.com' },
    stats: [
      { icon: Users, value: '3', label: 'Platforms' },
      { icon: Globe, value: '1', label: 'Standard' },
      { icon: Award, value: '0', label: 'Cost to Join' },
    ],
  },
  {
    id: 4,
  ...
  },
  {
    ...
    headlineAccent: 'Promised the Sky. Given a Queue.',
