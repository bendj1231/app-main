...
const slides = [
  ...
  },
  {
    ...
    tagline: 'The Cost-to-Climb Gap',
    headline: 'The Journey From CPL',
    headlineAccent: 'Is Being Mapped.',
    description: 'Flight schools contribute trained graduates. Airlines contribute hiring opportunities. What was missing is the bridge in between — the real cost, the real timeline, and the real steps from 200 hours to first hire. We are making the invisible journey visible.',
    ctaPrimary: { text: 'See the Real Path', href: '/pilotshortage/about' },
    ctaSecondary: { text: 'Map Your Journey', href: '/pilotshortage/pilotgap' },
    stats: [
      { icon: Users, value: '8,000+', label: 'Graduates Yearly' },
      { icon: Globe, value: '2-3', label: 'Years to First Hire' },
      { icon: Award, value: '$50K', label: 'Avg Investment' },
    ],
  },
  {
    id: 3,
    ...
    description: 'We are collecting pilot experience data — not as complaints, but as evidence. What ATOs do well. Where airlines need clarity. Which pathways actually work. Your voice becomes the blueprint for a more transparent, navigable aviation industry.',
    ctaPrimary: { text: 'Share Your Experience', href: '/pilotshortage/advocacy' },
    ctaSecondary: { text: 'See Pilot Insights', href: '/pilotshortage/news' },
    stats: [
      { icon: Users, value: '500+', label: 'Pilots Surveyed' },
      { icon: Globe, value: '12', label: 'Countries' },
      { icon: Award, value: '100%', label: 'Anonymous' },
    ],
  },
  {
    id: 4,
    ...
    description: 'Qualified pilots built careers in corporate aviation, cargo, UAV leadership, instruction, and aviation-adjacent roles. These are not failures — they are the alternative map the industry never published. We are making every pathway visible.',
    ctaPrimary: { text: 'Explore Pathways', href: '/pilotshortage/pilotgap' },
    ctaSecondary: { text: 'Read Success Stories', href: '/pilotshortage/news' },
    stats: [
      { icon: Users, value: '500+', label: 'Pathways Mapped' },
      { icon: Globe, value: '47', label: 'Career Types' },
      { icon: Award, value: '12', label: 'Verified Sectors' },
    ],
  },
  {
    id: 5,
    ...
    description: 'Career change is not failure — it is informed choice. When pilots can see all their options — corporate, cargo, instruction, UAV, aviation-adjacent — they make better decisions. We are building the comprehensive map they were never given.',
    ctaPrimary: { text: 'See All Pathways', href: '/pilotshortage/pilotgap' },
    ctaSecondary: { text: 'Find Where You Fit', href: '/pilotshortage/join' },
    stats: [
      { icon: Users, value: '80%', label: 'Exploring Options' },
      { icon: Globe, value: '20%', label: 'Traditional Track' },
      { icon: Award, value: '100%', label: 'Deserve Data' },
    ],
  },
  {
    id: 6,
    ...
    description: 'A commercial pilot license is an achievement. What comes next should not be a guessing game. We are building verified pathways from graduation to first hire — with real requirements, real timelines, and real mentorship from pilots who have walked the path.',
    ctaPrimary: { text: 'Find Your Pathway', href: '/pilotshortage/pilotgap' },
    ctaSecondary: { text: 'Connect With Mentors', href: '/pilotshortage/join' },
    stats: [
      { icon: Users, value: '15,000+', label: 'Graduates Yearly' },
      { icon: Globe, value: '2–4', label: 'Years to Navigate' },
      { icon: Award, value: 'Live', label: 'Mentorship' },
    ],
  },
  {
    id: 7,
    ...
    description: 'Flight academies train thousands of qualified pilots every year. Airlines need thousands of crew. The gap is not a talent shortage — it is a coordination opportunity between training, hiring, and recognition. PSA partners with ATOs, airlines, and regulators to map the real pipeline, share verified data, and build pathways that actually work.',
    ...
    stats: [
      { icon: Users, value: '2K+', label: 'Verified Pilots' },
      { icon: Globe, value: '6K+', label: 'CFIs Connected' },
      { icon: Award, value: '12', label: 'Partner ATOs' },
    ],
  },
];
