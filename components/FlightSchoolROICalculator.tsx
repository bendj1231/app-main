    ...
    <div className={`bg-white rounded-lg shadow-lg ${isEmbedded ? '' : 'p-8'}`}>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="space-y-6">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">
              Current Graduate Recognition Rate (6 months)
            </label>
            <input
              type="range"
              min="5"
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">
              Target Recognition Rate with PilotRecognition
            </label>
            <input
              type="range"
              min="20"
          ...
          <div className="space-y-4">
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-4">
              <div className="flex items-center gap-3 mb-2">
                ...
                <span className="font-medium text-gray-900">Recognition Platform Fees</span>
              </div>
              <div className="text-2xl font-bold text-gray-900">
                {formatCurrency(roi.placementRevenue)}
              </div>
              <div className="text-xs text-gray-500 mt-1">
                {roi.additionalPlacements} additional recognized graduates × ${placementSuccessFee[partnershipTier]}
              </div>
            </div>
      ...
      <div className="mt-8 pt-6 border-t border-gray-200">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="text-center p-4 bg-green-50 rounded-lg">
            ...
            <div className="text-sm text-gray-600 mt-1">Recognition Rate Improvement</div>
          </div>
          <div className="text-center p-4 bg-blue-50 rounded-lg">
            <div className="text-3xl font-bold text-blue-600">
              {roi.additionalPlacements}
            </div>
            <div className="text-sm text-gray-600 mt-1">Additional Recognized Graduates</div>
          </div>
