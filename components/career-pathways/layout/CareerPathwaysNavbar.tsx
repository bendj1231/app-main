    ...
    <>
          ...
          <div className="relative group">
            ...
            <div className="absolute top-full left-1/2 -translate-x-1/2 w-64 bg-[#1a1a1b] border border-gray-800 rounded-lg shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all z-50 mt-1">
              <div className="p-3">
                ...
                <p className="text-xs text-gray-300 leading-relaxed">
                  Turn your logbook into a verified credential meeting international standards from
                  operators and ATOs.
                </p>
              </div>
            </div>
          ...
          <div className="relative group">
            ...
            <div className="absolute top-full left-1/2 -translate-x-1/2 w-64 bg-[#1a1a1b] border border-gray-800 rounded-lg shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all z-50 mt-1">
              <div className="p-3">
                ...
                <p className="text-xs text-gray-300 leading-relaxed">
                  Real-time discussions with verified pilots worldwide. No bots, no recruiters —
                  just aviators.
                </p>
              </div>
            </div>
      ...
      <header
        className={`fixed left-0 right-0 z-50 transition-all duration-300 ${
          ...
          isScrolled ? 'bg-slate-950/40 backdrop-blur-xl border-b border-white/5' : 'bg-transparent'
        }`}
      >
        <div className="w-full">
          <div className="flex items-center justify-between h-16 px-4">
            {/* Logo - Far Left */}
            <Link to="/discover" className="flex items-center group shrink-0">
                ...
                <>
                  <div className="flex items-center gap-2">
                      ...
                      >
                        ...
                        {(notifCount > 0 || tcUpdatePending || !emailVerified) && (
                          <span
                            ...
                            style={{
                              background: '#f59e0b',
                              border: '1.5px solid rgba(15,22,35,0.9)',
                            }}
                          >
                    ...
                    >
                      ...
                      {profileDropOpen && (
                        <div
                          className="absolute right-0 top-12 w-72 z-50 shadow-2xl overflow-hidden rounded-xl"
                          style={{
          ...
          >
            ...
            <div className="relative bg-white border-b border-slate-200 px-8 py-6">
              ...
              <h2 className="text-2xl font-bold text-slate-900">
                <span className="text-slate-500 text-lg">powered by </span>
