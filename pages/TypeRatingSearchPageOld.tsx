...
const AIRCRAFT_INFO: Record<string, AircraftInfo> = {
  ...
  'airbus-a320': {
    ...
    atoCarousel: [
      ...
      { name: 'Airbus Training Centre', location: 'Toulouse, France', offers: ['A318', 'A319', 'A320', 'A321'], img: 'https://images.unsplash.com/photo-1540962351504-03099e0a754b?w=800&q=80' },
  ...
  'airbus-a350': {
    ...
    atoCarousel: [
      { name: 'Airbus Training Centre', location: 'Toulouse, France', offers: ['A350-900', 'A350-1000'], img: 'https://images.unsplash.com/photo-1540962351504-03099e0a754b?w=800&q=80' },
  ...
  'airbus-a380': {
    ...
    atoCarousel: [
      { name: 'Airbus Training Centre', location: 'Toulouse, France', offers: ['A380 Type Rating', 'A380 Recurrency'], img: 'https://images.unsplash.com/photo-1540962351504-03099e0a754b?w=800&q=80' },
