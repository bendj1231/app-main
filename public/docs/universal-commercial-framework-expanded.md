...
| Airline Value Proposition to Pilots | Never communicated — pilots choose blind | Airlines publish why a pilot should choose them: culture, growth, benefits, stability | [→ Pillar 1: Commercial Airlines](#pillar-1-commercial-airlines-detailed) |
| Differentiation from Other Airlines | Not stated — all look the same on paper | Flagship identity, unique career benefits, and competitive advantages published | [→ Pillar 1: Commercial Airlines](#pillar-1-commercial-airlines-detailed) |
| Employee Benefits & Working Conditions | Hidden until contract stage | Published: salary bands, rostering model, leave entitlements, base locations | [→ Pillar 1: Commercial Airlines](#pillar-1-commercial-airlines-detailed) |
| Pilot Alignment Path to Airline Standards | No guidance — pilots guess what is needed | Airlines publish exact competency expectations so pilots can align their profile | [→ Pillar 1: Commercial Airlines](#pillar-1-commercial-airlines-detailed) |
| Published Competency & Expectation Criteria | Vague or entirely absent | Full criteria published: hours, ratings, behavioural competencies, EBT alignment | [→ Pillar 1: Commercial Airlines](#pillar-1-commercial-airlines-detailed) |
| Acceptance of Foreign-Issued CPL Licenses | Undisclosed — discovered after rejection | Clearly stated: which foreign licenses accepted, conversion requirements if any | [→ Pillar 1: Commercial Airlines](#pillar-1-commercial-airlines-detailed) |
| Multinational Pilot Welcoming Policy | Varies, undisclosed per airline | Stated policy: multinational welcome / regional preference / local nationals only | [→ Pillar 1: Commercial Airlines](#pillar-1-commercial-airlines-detailed) |
...
| **— OPERATIONAL OUTCOMES (Benefits to Airlines from Both Pages)** | | | |
