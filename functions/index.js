...
exports.optimizeProfileWithAI = recognitionPlus.optimizeProfileWithAI;
exports.verifyCredentialsAutomated = recognitionPlus.verifyCredentialsAutomated;
exports.assignOEMBadges = recognitionPlus.assignOEMBadges;
exports.generateSmartRecommendations = recognitionPlus.generateSmartRecommendations;
exports.fullProfileVerification = recognitionPlus.fullProfileVerification;
exports.validateCredentialsAdvanced = recognitionPlus.validateCredentialsAdvanced;
exports.assignPremiumRecognitionStatus = recognitionPlus.assignPremiumRecognitionStatus;
exports.getPerformanceAnalyticsDashboard = recognitionPlus.getPerformanceAnalyticsDashboard;
exports.calculatePerformanceMetrics = recognitionPlus.calculatePerformanceMetrics;
exports.getAdvancedAnalytics = recognitionPlus.getAdvancedAnalytics;
exports.trackContinuousImprovement = recognitionPlus.trackContinuousImprovement;
exports.optimizePerformanceWithAI = recognitionPlus.optimizePerformanceWithAI;
exports.integrateFlightLogs = recognitionPlus.integrateFlightLogs;
exports.analyzeFlightPerformance = recognitionPlus.analyzeFlightPerformance;
exports.syncFlightData = recognitionPlus.syncFlightData;
exports.analyzeSkillsGap = recognitionPlus.analyzeSkillsGap;
exports.identifySkillGaps = recognitionPlus.identifySkillGaps;
exports.recommendSkillsTraining = recognitionPlus.recommendSkillsTraining;
exports.getAIEnhancedCurriculum = recognitionPlus.getAIEnhancedCurriculum;
exports.generateAdaptiveLearningPaths = recognitionPlus.generateAdaptiveLearningPaths;
exports.provideAIGuidedMentorship = recognitionPlus.provideAIGuidedMentorship;
exports.getPersonalizedLearningRecommendations = recognitionPlus.getPersonalizedLearningRecommendations;
exports.runCompleteAISuite = recognitionPlus.runCompleteAISuite;
exports.getAdvancedAIAnalytics = recognitionPlus.getAdvancedAIAnalytics;
exports.generatePredictiveInsights = recognitionPlus.generatePredictiveInsights;
exports.enableFullAIAutomation = recognitionPlus.enableFullAIAutomation;
exports.matchPathwaysWithAI = recognitionPlus.matchPathwaysWithAI;
exports.getAirlineAlignedRecommendations = recognitionPlus.getAirlineAlignedRecommendations;
exports.matchDataDrivenPathways = recognitionPlus.matchDataDrivenPathways;
exports.getAdvancedCareerInsights = recognitionPlus.getAdvancedCareerInsights;
exports.generatePredictiveCareerAnalytics = recognitionPlus.generatePredictiveCareerAnalytics;
exports.recommendSkillsBasedPathways = recognitionPlus.recommendSkillsBasedPathways;
exports.assignPremiumPathwayAccess = recognitionPlus.assignPremiumPathwayAccess;
exports.placeFeaturedProfile = recognitionPlus.placeFeaturedProfile;
exports.enableDirectOperatorVisibility = recognitionPlus.enableDirectOperatorVisibility;
exports.assignShortlistPriority = recognitionPlus.assignShortlistPriority;
exports.grantEarlyAccessToOpportunities = recognitionPlus.grantEarlyAccessToOpportunities;
exports.enableAirbusInterviewAccess = recognitionPlus.enableAirbusInterviewAccess;
exports.assignPriorityPlacement = recognitionPlus.assignPriorityPlacement;
exports.enableDirectRecruitment = recognitionPlus.enableDirectRecruitment;
exports.sendEarlyNotifications = recognitionPlus.sendEarlyNotifications;
exports.assignPriorityDuringShortages = recognitionPlus.assignPriorityDuringShortages;
exports.enableFastTrackOpportunities = recognitionPlus.enableFastTrackOpportunities;
exports.enableDirectRecruitmentAccess = recognitionPlus.enableDirectRecruitmentAccess;
exports.enableEarlyNotificationSystem = recognitionPlus.enableEarlyNotificationSystem;
exports.assignFirstInSelectionPools = recognitionPlus.assignFirstInSelectionPools;
exports.enableExclusivePriorityAccess = recognitionPlus.enableExclusivePriorityAccess;
...
// Programs functions
const programsFunctions = require('./programs-functions');
exports.getProgramAnalytics = programsFunctions.getProgramAnalytics;
exports.getProgramBenchmarking = programsFunctions.getProgramBenchmarking;
exports.getProgramPersonalizedInsights = programsFunctions.getProgramPersonalizedInsights;
exports.getProgramPredictiveScores = programsFunctions.getProgramPredictiveScores;
exports.getProgramSkillGapAnalysis = programsFunctions.getProgramSkillGapAnalysis;
exports.getProgramLearningPath = programsFunctions.getProgramLearningPath;
exports.getProgramMentorMatching = programsFunctions.getProgramMentorMatching;
exports.getProgramPeerMatching = programsFunctions.getProgramPeerMatching;
exports.getProgramCareerImpact = programsFunctions.getProgramCareerImpact;
exports.getProgramNetworking = programsFunctions.getProgramNetworking;
exports.getProgramAlumniNetwork = programsFunctions.getProgramAlumniNetwork;
exports.getProgramRecommendations = programsFunctions.getProgramRecommendations;
exports.getProgramDataExport = programsFunctions.getProgramDataExport;
exports.getProgramAdvancedMetrics = programsFunctions.getProgramAdvancedMetrics;
exports.getProgramSuccessStories = programsFunctions.getProgramSuccessStories;
exports.getProgramIndustryConnections = programsFunctions.getProgramIndustryConnections;
exports.getProgramJobPlacement = programsFunctions.getProgramJobPlacement;
exports.getProgramCertificationValue = programsFunctions.getProgramCertificationValue;
exports.getProgramSkillValidation = programsFunctions.getProgramSkillValidation;
exports.getProgramGamification = programsFunctions.getProgramGamification;
exports.getFoundationProgramCurriculum = programsFunctions.getFoundationProgramCurriculum;
exports.getFoundationProgramMentorship = programsFunctions.getFoundationProgramMentorship;
exports.getFoundationProgramAssessment = programsFunctions.getFoundationProgramAssessment;
exports.getFoundationProgramProgress = programsFunctions.getFoundationProgramProgress;
exports.getFoundationProgramCertification = programsFunctions.getFoundationProgramCertification;
exports.getFoundationProgramCareerPath = programsFunctions.getFoundationProgramCareerPath;
exports.getFoundationProgramMentors = programsFunctions.getFoundationProgramMentors;
exports.getFoundationProgramAlumni = programsFunctions.getFoundationProgramAlumni;
exports.getFoundationProgramSuccessMetrics = programsFunctions.getFoundationProgramSuccessMetrics;
exports.getFoundationProgramModules = programsFunctions.getFoundationProgramModules;
exports.getFoundationProgramSchedule = programsFunctions.getFoundationProgramSchedule;
exports.getFoundationProgramResources = programsFunctions.getFoundationProgramResources;
exports.getFoundationProgramRequirements = programsFunctions.getFoundationProgramRequirements;
exports.getFoundationProgramEligibility = programsFunctions.getFoundationProgramEligibility;
exports.getFoundationProgramTimeline = programsFunctions.getFoundationProgramTimeline;
exports.getFoundationProgramCost = programsFunctions.getFoundationProgramCost;
exports.getFoundationProgramScholarships = programsFunctions.getFoundationProgramScholarships;
exports.getFoundationProgramPaymentPlans = programsFunctions.getFoundationProgramPaymentPlans;
exports.getFoundationProgramEnrollment = programsFunctions.getFoundationProgramEnrollment;
exports.getFoundationProgramOnboarding = programsFunctions.getFoundationProgramOnboarding;
exports.getFoundationProgramSupport = programsFunctions.getFoundationProgramSupport;
exports.getFoundationProgramFAQ = programsFunctions.getFoundationProgramFAQ;
exports.getFoundationProgramTestimonials = programsFunctions.getFoundationProgramTestimonials;
exports.getFoundationProgramComparison = programsFunctions.getFoundationProgramComparison;
exports.getFoundationProgramOutcomes = programsFunctions.getFoundationProgramOutcomes;
exports.getFoundationProgramSkills = programsFunctions.getFoundationProgramSkills;
exports.getFoundationProgramNextSteps = programsFunctions.getFoundationProgramNextSteps;
exports.getFoundationProgramCommunity = programsFunctions.getFoundationProgramCommunity;
exports.getFoundationProgramNetworking = programsFunctions.getFoundationProgramNetworking;
exports.getFoundationProgramEvents = programsFunctions.getFoundationProgramEvents;
exports.getFoundationProgramAssessments = programsFunctions.getFoundationProgramAssessments;
exports.getFoundationProgramGrading = programsFunctions.getFoundationProgramGrading;
exports.getFoundationProgramFeedback = programsFunctions.getFoundationProgramFeedback;
exports.getFoundationProgramSatisfaction = programsFunctions.getFoundationProgramSatisfaction;
exports.getFoundationProgramRetention = programsFunctions.getFoundationProgramRetention;
exports.getFoundationProgramEngagement = programsFunctions.getFoundationProgramEngagement;
exports.getFoundationProgramImpact = programsFunctions.getFoundationProgramImpact;
exports.getFoundationProgramDemographics = programsFunctions.getFoundationProgramDemographics;
exports.getFoundationProgramGeographicReach = programsFunctions.getFoundationProgramGeographicReach;
exports.getFoundationProgramIndustryBreakdown = programsFunctions.getFoundationProgramIndustryBreakdown;
exports.getFoundationProgramCareerAdvancement = programsFunctions.getFoundationProgramCareerAdvancement;
exports.getFoundationProgramJobPlacement = programsFunctions.getFoundationProgramJobPlacement;
exports.getFoundationProgramPartners = programsFunctions.getFoundationProgramPartners;
exports.getFoundationProgramSponsors = programsFunctions.getFoundationProgramSponsors;
exports.getFoundationProgramAccreditations = programsFunctions.getFoundationProgramAccreditations;
exports.getFoundationProgramRecognition = programsFunctions.getFoundationProgramRecognition;
exports.getFoundationProgramMediaCoverage = programsFunctions.getFoundationProgramMediaCoverage;
exports.getFoundationProgramCaseStudies = programsFunctions.getFoundationProgramCaseStudies;
exports.getFoundationProgramResearchData = programsFunctions.getFoundationProgramResearchData;
exports.getFoundationProgramAnalytics = programsFunctions.getFoundationProgramAnalytics;
exports.getFoundationProgramReports = programsFunctions.getFoundationProgramReports;
exports.getFoundationProgramAPIAccess = programsFunctions.getFoundationProgramAPIAccess;
exports.getFoundationProgramIntegrations = programsFunctions.getFoundationProgramIntegrations;
exports.getFoundationProgramWhiteLabeling = programsFunctions.getFoundationProgramWhiteLabeling;
exports.getFoundationProgramBranding = programsFunctions.getFoundationProgramBranding;
exports.getFoundationProgramScalability = programsFunctions.getFoundationProgramScalability;
exports.getFoundationProgramSecurity = programsFunctions.getFoundationProgramSecurity;
exports.getFoundationProgramCompliance = programsFunctions.getFoundationProgramCompliance;
exports.getFoundationProgramDocumentation = programsFunctions.getFoundationProgramDocumentation;
exports.getFoundationProgramSupportPortal = programsFunctions.getFoundationProgramSupportPortal;
exports.getFoundationProgramTraining = programsFunctions.getFoundationProgramTraining;

// Manufacturer functions
const manufacturerFunctions = require('./manufacturer-functions');
exports.getManufacturerAircraftSpecs = manufacturerFunctions.getManufacturerAircraftSpecs;
exports.getManufacturerTrainingData = manufacturerFunctions.getManufacturerTrainingData;
exports.getManufacturerCertificationData = manufacturerFunctions.getManufacturerCertificationData;
exports.getManufacturerAircraftList = manufacturerFunctions.getManufacturerAircraftList;
exports.getManufacturerEngineData = manufacturerFunctions.getManufacturerEngineData;
exports.getManufacturerAvionicsData = manufacturerFunctions.getManufacturerAvionicsData;
exports.getManufacturerSystemsData = manufacturerFunctions.getManufacturerSystemsData;
exports.getManufacturerProceduresData = manufacturerFunctions.getManufacturerProceduresData;
exports.getManufacturerDocumentation = manufacturerFunctions.getManufacturerDocumentation;
exports.getManufacturerEmergencyProcedures = manufacturerFunctions.getManufacturerEmergencyProcedures;
exports.getManufacturerNormalProcedures = manufacturerFunctions.getManufacturerNormalProcedures;
exports.getManufacturerTypeRatingValue = manufacturerFunctions.getManufacturerTypeRatingValue;
exports.getManufacturerAircraftStatus = manufacturerFunctions.getManufacturerAircraftStatus;
exports.getManufacturerTargetPilots = manufacturerFunctions.getManufacturerTargetPilots;
exports.getManufacturerCareerPath = manufacturerFunctions.getManufacturerCareerPath;
exports.getManufacturerSalaryExpectations = manufacturerFunctions.getManufacturerSalaryExpectations;
exports.getManufacturerJobMarket = manufacturerFunctions.getManufacturerJobMarket;
exports.getManufacturerAirlinesUsing = manufacturerFunctions.getManufacturerAirlinesUsing;
exports.getManufacturerTrainingProviders = manufacturerFunctions.getManufacturerTrainingProviders;
exports.getManufacturerTrainingCost = manufacturerFunctions.getManufacturerTrainingCost;
exports.getManufacturerTrainingDuration = manufacturerFunctions.getManufacturerTrainingDuration;
exports.getManufacturerPrerequisites = manufacturerFunctions.getManufacturerPrerequisites;
exports.getManufacturerSuccessRate = manufacturerFunctions.getManufacturerSuccessRate;
exports.getManufacturerROI = manufacturerFunctions.getManufacturerROI;
exports.getManufacturerComparison = manufacturerFunctions.getManufacturerComparison;
exports.getManufacturerReviews = manufacturerFunctions.getManufacturerReviews;
exports.getManufacturerTestimonials = manufacturerFunctions.getManufacturerTestimonials;
exports.getManufacturerSuccessStories = manufacturerFunctions.getManufacturerSuccessStories;
exports.getManufacturerCareerOutcomes = manufacturerFunctions.getManufacturerCareerOutcomes;
exports.getManufacturerIndustryTrends = manufacturerFunctions.getManufacturerIndustryTrends;
exports.getManufacturerFutureOutlook = manufacturerFunctions.getManufacturerFutureOutlook;
exports.getManufacturerMarketShare = manufacturerFunctions.getManufacturerMarketShare;
exports.getManufacturerCompetitorAnalysis = manufacturerFunctions.getManufacturerCompetitorAnalysis;
exports.getManufacturerAdvantages = manufacturerFunctions.getManufacturerAdvantages;
exports.getManufacturerDisadvantages = manufacturerFunctions.getManufacturerDisadvantages;
exports.getManufacturerRequirements = manufacturerFunctions.getManufacturerRequirements;
exports.getManufacturerEligibility = manufacturerFunctions.getManufacturerEligibility;
exports.getManufacturerApplicationProcess = manufacturerFunctions.getManufacturerApplicationProcess;
exports.getManufacturerTimeline = manufacturerFunctions.getManufacturerTimeline;
exports.getManufacturerAssessment = manufacturerFunctions.getManufacturerAssessment;
exports.getManufacturerCertification = manufacturerFunctions.getManufacturerCertification;
exports.getManufacturerLicense = manufacturerFunctions.getManufacturerLicense;
exports.getManufacturerMedical = manufacturerFunctions.getManufacturerMedical;
exports.getManufacturerAge = manufacturerFunctions.getManufacturerAge;
exports.getManufacturerExperience = manufacturerFunctions.getManufacturerExperience;
exports.getManufacturerSkills = manufacturerFunctions.getManufacturerSkills;
exports.getManufacturerKnowledge = manufacturerFunctions.getManufacturerKnowledge;
exports.getManufacturerTraining = manufacturerFunctions.getManufacturerTraining;
exports.getManufacturerSupport = manufacturerFunctions.getManufacturerSupport;
exports.getManufacturerResources = manufacturerFunctions.getManufacturerResources;
exports.getManufacturerFAQ = manufacturerFunctions.getManufacturerFAQ;
exports.getManufacturerLocation = manufacturerFunctions.getManufacturerLocation;
exports.getManufacturerPricing = manufacturerFunctions.getManufacturerPricing;
exports.getManufacturerRecommendation = manufacturerFunctions.getManufacturerRecommendation;
exports.getManufacturerDataExport = manufacturerFunctions.getManufacturerDataExport;
exports.getManufacturerAPI = manufacturerFunctions.getManufacturerAPI;
exports.getManufacturerIntegration = manufacturerFunctions.getManufacturerIntegration;
exports.getManufacturerAnalytics = manufacturerFunctions.getManufacturerAnalytics;
exports.getManufacturerReports = manufacturerFunctions.getManufacturerReports;
exports.getManufacturerDashboard = manufacturerFunctions.getManufacturerDashboard;
exports.getManufacturerContact = manufacturerFunctions.getManufacturerContact;
exports.getManufacturerComparisonWithOthers = manufacturerFunctions.getManufacturerComparisonWithOthers;
exports.getManufacturerMatching = manufacturerFunctions.getManufacturerMatching;

// Premium features functions
const premiumFeatures = require('./premium-features');
exports.getTypeRatingComparisonTool = premiumFeatures.getTypeRatingComparisonTool;
exports.getSalaryCalculatorPro = premiumFeatures.getSalaryCalculatorPro;
exports.getJobMarketIntelligence = premiumFeatures.getJobMarketIntelligence;
exports.getTrainingProviderReviews = premiumFeatures.getTrainingProviderReviews;
exports.getTypeRatingROICalculator = premiumFeatures.getTypeRatingROICalculator;
exports.getAircraftComparisonTool = premiumFeatures.getAircraftComparisonTool;
exports.getCareerRoadmapPro = premiumFeatures.getCareerRoadmapPro;
exports.getInterviewPreparationPro = premiumFeatures.getInterviewPreparationPro;
exports.getMockInterviews = premiumFeatures.getMockInterviews;
exports.getCareerCoaching = premiumFeatures.getCareerCoaching;
exports.getCareerPathSimulator = premiumFeatures.getCareerPathSimulator;
exports.getAircraftPerformanceDatabase = premiumFeatures.getAircraftPerformanceDatabase;
exports.getIndustryEventsAccess = premiumFeatures.getIndustryEventsAccess;
exports.getResearchDatabase = premiumFeatures.getResearchDatabase;
exports.getInternshipOpportunities = premiumFeatures.getInternshipOpportunities;
exports.getAlumniNetwork = premiumFeatures.getAlumniNetwork;
exports.getIndustryConnections = premiumFeatures.getIndustryConnections;
exports.getJobReferrals = premiumFeatures.getJobReferrals;
exports.getCertificationTracking = premiumFeatures.getCertificationTracking;
exports.getTypeRatingTracking = premiumFeatures.getTypeRatingTracking;
exports.getFlightHourTracking = premiumFeatures.getFlightHourTracking;
exports.getAchievementTracking = premiumFeatures.getAchievementTracking;
exports.getBadgeSystem = premiumFeatures.getBadgeSystem;
exports.getLeaderboard = premiumFeatures.getLeaderboard;
exports.getSocialFeatures = premiumFeatures.getSocialFeatures;
exports.getEventsMeetups = premiumFeatures.getEventsMeetups;
exports.getMobileAppPro = premiumFeatures.getMobileAppPro;
exports.getOfflineAccess = premiumFeatures.getOfflineAccess;
exports.getCloudStorage = premiumFeatures.getCloudStorage;
exports.getAIAssistant = premiumFeatures.getAIAssistant;
exports.getSmartRecommendations = premiumFeatures.getSmartRecommendations;
exports.getPredictiveAnalytics = premiumFeatures.getPredictiveAnalytics;
exports.getPersonalizedDashboard = premiumFeatures.getPersonalizedDashboard;
exports.getCustomAlerts = premiumFeatures.getCustomAlerts;
exports.getAdvancedSearch = premiumFeatures.getAdvancedSearch;
exports.getDataVisualization = premiumFeatures.getDataVisualization;
exports.getWhiteLabeling = premiumFeatures.getWhiteLabeling;
exports.getCustomBranding = premiumFeatures.getCustomBranding;
exports.getSecurityFeatures = premiumFeatures.getSecurityFeatures;
exports.getFlightLogAnalytics = premiumFeatures.getFlightLogAnalytics;
exports.getLicenseTrackingPro = premiumFeatures.getLicenseTrackingPro;
exports.getMedicalTrackerPro = premiumFeatures.getMedicalTrackerPro;
exports.getPortfolioBuilderPro = premiumFeatures.getPortfolioBuilderPro;
exports.getPersonalBranding = premiumFeatures.getPersonalBranding;
exports.getLinkedInProfileOptimization = premiumFeatures.getLinkedInProfileOptimization;
exports.getResumeBuilderPro = premiumFeatures.getResumeBuilderPro;
exports.getSkillAssessmentPro = premiumFeatures.getSkillAssessmentPro;
exports.getIndustryInsights = premiumFeatures.getIndustryInsights;
exports.getNetworkingPlatform = premiumFeatures.getNetworkingPlatform;
exports.getMentorshipAccess = premiumFeatures.getMentorshipAccess;
exports.getCurrencyConverterPro = premiumFeatures.getCurrencyConverterPro;
exports.getRegulationDatabase = premiumFeatures.getRegulationDatabase;
exports.getMentorshipMatching = premiumFeatures.getMentorshipMatching;
exports.getAPIAccess = premiumFeatures.getAPIAccess;
exports.getPeerNetwork = premiumFeatures.getPeerNetwork;
...
exports.getPathwayRecommendations = onRequest(async (req, res) => {
  ...
  try {
    ...
    // Calculate probability for each pathway
    const scoredPathways = pathways.map(pathway => {
      const pilotHours = profile.total_flight_hours || 0;
      const pathwayMinHours = pathway.min_hours || 0;
      ...
      const probability = (hoursScore * 0.3) + (ratingScore * 0.3) + (icaoScore * 0.2) + (behavioralScore * 0.15) + (licenseScore * 0.05);
      
      // Generate gap analysis
      const gaps = [];
      if (pilotHours < pathwayMinHours) {
        gaps.push(`Need ${pathwayMinHours - pilotHours} more flight hours (currently ${pilotHours})`);
      }
      ...
      if (pilotIcao < requiredIcao) {
        gaps.push(`Need ICAO Level ${requiredIcao} (currently Level ${pilotIcao})`);
      }
      if (pilotBehavioral < requiredBehavioral) {
        gaps.push(`Need behavioral score ${requiredBehavioral} (currently ${pilotBehavioral})`);
      }
      
      // Generate reason
      const reasons = [];
      if (pilotHours >= pathwayMinHours) reasons.push(`${pilotHours.toLocaleString()} flight hours`);
      if (matchingRatings.length > 0) reasons.push(`Has ${matchingRatings.length}/${requiredRatings.length} ratings: ${matchingRatings.join(', ')}`);
      if (pilotIcao >= requiredIcao) reasons.push(`ICAO Level ${pilotIcao}`);
      if (pilotBehavioral >= requiredBehavioral) reasons.push(`Behavioral score ${pilotBehavioral}`);
      ...
      return {
        ...
        gaps: gaps.length > 0 ? gaps : ['No gaps - fully qualified'],
        pathwayDetails: {
          minHours: pathway.min_hours,
          requiredRatings: pathway.required_type_ratings,
          requiredIcao: pathway.required_icao_level,
          requiredBehavioral: pathway.required_behavioral_score,
          requiredLicense: pathway.required_license
        }
      };
    });

    // Sort by probability descending
    scoredPathways.sort((a, b) => b.probability - a.probability);

    // Return top 10 pathways with highest probabilities
    const topRecommendations = scoredPathways.slice(0, 10);

    // Check if all pathways have low probability (< 0.5)
    const allLowProbability = scoredPathways.every(p => p.probability < 0.5);
    if (allLowProbability) {
      return res.json({ 
        recommendations: topRecommendations, 
        profile,
        warning: 'All pathways have low probability. Consider building more qualifications.' 
      });
    }

    return res.json({ recommendations: topRecommendations, profile });
  } catch (error) {
    return res.status(500).json({ error: error.message });
  }
});
