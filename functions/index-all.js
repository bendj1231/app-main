...
// All 81 functions were simple SELECT queries that can be done from frontend
...
// Pathway system functions removed - using direct Supabase client instead
// All 4 functions were simple SELECT queries that can be done from frontend
