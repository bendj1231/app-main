...
const progressModules = [
  {
    ...
    description: 'Introduction to PilotRecognition and the aviation mentorship framework.',
    status: 'completed',
    progress: 100,
  },
];
      ...
      <div style={{ position: 'relative', minHeight: '100vh', background: 'linear-gradient(135deg, #f0f4f8 0%, #e8eef5 100%)' }}>
        ...
        >
          ...
          >
            ...
            <button
              onClick={() => window.open('https://pilotrecognition.com', '_blank', 'noopener,noreferrer')}
              style={{
                background: '#2563eb',
                color: '#fff',
                border: 'none',
