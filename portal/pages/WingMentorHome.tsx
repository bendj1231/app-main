              ...
              <div style={{ marginTop: '3rem', marginBottom: '2rem' }}>
                <div style={{
                  ...
                  <div style={{ textAlign: 'center', marginBottom: '1.5rem' }}>
                    <button
                      onClick={() => safeRedirect('mailto:contact@pilotrecognition.com?subject=Personalized Pathway & Internship Inquiry&body=I am interested in learning more about personalized aviation pathways for my pilot career and internship opportunities with PilotRecognition.')}
                      style={{
