/**
 * RecognitionDashboardPage Component
 * 
 * Dedicated page for the Pilot Recognition Score Dashboard
 */
...
interface RecognitionDashboardPageProps {
  onBack: () => void;
  userProfile?: {
    firstName?: string;
    lastName?: string;
...
export const RecognitionDashboardPage: React.FC<RecognitionDashboardPageProps> = ({ onBack, userProfile }) => {
  return (
      ...
      >
        ...
        <section style={{ padding: '2rem clamp(1.5rem, 4vw, 3.5rem) 3rem' }}>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '3rem' }}>
            <CategorySection title="Your Recognition Score" description="Track your progress and compare with peers">
