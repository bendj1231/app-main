          ...
          <div className="animate-fade-in">
            ...
            <div style={{ textAlign: 'center', marginTop: '3rem' }}>
              <div className="horizontal-card" style={{ 
                ...
                <button
                  onClick={() => safeRedirect('mailto:contact@pilotrecognition.com?subject=Private Sector Pathway Inquiry&body=I am interested in learning more about the Private Sector pathway through PilotRecognition.')}
                  style={{
                    padding: '1rem 2.5rem',
                    background: '#2563eb',
                    color: 'white',
